...
{
	public partial class PlotOptionsHollowcandlestickLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsHollowcandlestickLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsHollowcandlestickLastPriceLabelAlign Align { get; set; }
		private PlotOptionsHollowcandlestickLastPriceLabelAlign Align_DefaultValue { get; set; }
