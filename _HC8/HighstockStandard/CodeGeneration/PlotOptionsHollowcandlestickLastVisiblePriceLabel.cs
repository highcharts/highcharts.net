...
{
	public partial class PlotOptionsHollowcandlestickLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsHollowcandlestickLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsHollowcandlestickLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsHollowcandlestickLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
