...
{
	public partial class PlotOptionsHollowcandlestickOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsHollowcandlestickOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
		...
		/// </summary>
		public PlotOptionsHollowcandlestickOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsHollowcandlestickOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
