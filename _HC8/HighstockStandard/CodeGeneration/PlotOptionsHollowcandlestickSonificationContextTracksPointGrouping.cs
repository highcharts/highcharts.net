...
{
	public partial class PlotOptionsHollowcandlestickSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsHollowcandlestickSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsHollowcandlestickSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
