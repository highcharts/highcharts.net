...
{
	public partial class PlotOptionsHollowcandlestickStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHollowcandlestickStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesHoverMarkerStates States { get; set; }
		private PlotOptionsHollowcandlestickStatesHoverMarkerStates States_DefaultValue { get; set; }
