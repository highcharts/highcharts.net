...
{
	public partial class PlotOptionsHollowcandlestickStatesHoverMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesHoverMarkerStatesHover()
		{
