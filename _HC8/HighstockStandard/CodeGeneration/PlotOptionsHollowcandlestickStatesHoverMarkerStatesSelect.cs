...
{
	public partial class PlotOptionsHollowcandlestickStatesHoverMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesHoverMarkerStatesSelect()
		{
