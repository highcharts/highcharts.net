...
{
	public partial class PlotOptionsHollowcandlestickStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsHollowcandlestickStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsHollowcandlestickStatesSelectMarkerStates States { get; set; }
		private PlotOptionsHollowcandlestickStatesSelectMarkerStates States_DefaultValue { get; set; }
