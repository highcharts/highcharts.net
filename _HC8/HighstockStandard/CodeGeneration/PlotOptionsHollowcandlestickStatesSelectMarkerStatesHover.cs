...
{
	public partial class PlotOptionsHollowcandlestickStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesSelectMarkerStatesHover()
		{
