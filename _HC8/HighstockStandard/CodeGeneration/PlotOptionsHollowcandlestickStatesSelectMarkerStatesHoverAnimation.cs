...
{
	public partial class PlotOptionsHollowcandlestickStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesSelectMarkerStatesHoverAnimation()
		{
