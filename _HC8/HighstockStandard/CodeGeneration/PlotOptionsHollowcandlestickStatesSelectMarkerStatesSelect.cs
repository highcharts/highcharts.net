...
{
	public partial class PlotOptionsHollowcandlestickStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickStatesSelectMarkerStatesSelect()
		{
