...
{
	public partial class PlotOptionsHollowcandlestickTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsHollowcandlestickTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsHollowcandlestickTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsHollowcandlestickTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsHollowcandlestickTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
