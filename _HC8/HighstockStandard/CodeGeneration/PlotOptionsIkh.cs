...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsIkh  : BaseObject
	{
		...
		public PlotOptionsIkh()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsIkhDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsIkhPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
