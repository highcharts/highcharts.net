...
{
	public partial class PlotOptionsIkhDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsIkhDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsIkhDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsIkhDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsIkhDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsIkhDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsIkhDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsAlign Align { get; set; }
		private PlotOptionsIkhDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsFilter Filter { get; set; }
		private PlotOptionsIkhDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsIkhDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsPosition Position { get; set; }
		private PlotOptionsIkhDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsIkhDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsIkhDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
