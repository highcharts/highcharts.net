...
{
	public partial class PlotOptionsIkhLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsIkhLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsIkhLastPriceLabelAlign Align { get; set; }
		private PlotOptionsIkhLastPriceLabelAlign Align_DefaultValue { get; set; }
