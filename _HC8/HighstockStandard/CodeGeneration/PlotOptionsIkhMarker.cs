...
{
	public partial class PlotOptionsIkhMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsIkhMarkerStates();
		...
		/// </summary>
		public PlotOptionsIkhMarkerStates States { get; set; }
		private PlotOptionsIkhMarkerStates States_DefaultValue { get; set; }
