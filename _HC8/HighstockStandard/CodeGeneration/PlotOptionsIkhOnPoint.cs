...
{
	public partial class PlotOptionsIkhOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsIkhOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsIkhOnPointPosition();
		...
		/// </summary>
		public PlotOptionsIkhOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsIkhOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhOnPointPosition Position { get; set; }
		private PlotOptionsIkhOnPointPosition Position_DefaultValue { get; set; }
