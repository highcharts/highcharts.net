...
{
	public partial class PlotOptionsIkhSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsIkhSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsIkhSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsIkhSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsIkhSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsIkhSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsIkhSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsIkhSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhSonificationTracksType Type { get; set; }
		private PlotOptionsIkhSonificationTracksType Type_DefaultValue { get; set; }
