...
{
	public partial class PlotOptionsIkhStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PlotOptionsIkhStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PlotOptionsIkhStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsIkhStatesHoverHalo Halo { get; set; }
		private PlotOptionsIkhStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhStatesHoverMarker Marker { get; set; }
		private PlotOptionsIkhStatesHoverMarker Marker_DefaultValue { get; set; }
