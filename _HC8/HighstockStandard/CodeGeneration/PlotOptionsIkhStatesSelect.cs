...
{
	public partial class PlotOptionsIkhStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PlotOptionsIkhStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PlotOptionsIkhStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsIkhStatesSelectHalo Halo { get; set; }
		private PlotOptionsIkhStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsIkhStatesSelectMarker Marker { get; set; }
		private PlotOptionsIkhStatesSelectMarker Marker_DefaultValue { get; set; }
