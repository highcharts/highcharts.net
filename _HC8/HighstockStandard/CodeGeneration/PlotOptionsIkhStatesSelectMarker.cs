...
{
	public partial class PlotOptionsIkhStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsIkhStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsIkhStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsIkhStatesSelectMarkerStates States { get; set; }
		private PlotOptionsIkhStatesSelectMarkerStates States_DefaultValue { get; set; }
