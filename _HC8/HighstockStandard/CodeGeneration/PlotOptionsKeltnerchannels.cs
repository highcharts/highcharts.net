...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsKeltnerchannels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (BottomLine.IsDirty(ref highstock)) h.Add("bottomLine",BottomLine.ToHashtable(ref highstock));
			...
			if (TopLine.IsDirty(ref highstock)) h.Add("topLine",TopLine.ToHashtable(ref highstock));
