...
{
	public partial class PlotOptionsKeltnerchannelsDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsKeltnerchannelsDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsKeltnerchannelsDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsKeltnerchannelsDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsKeltnerchannelsDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsKeltnerchannelsDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsKeltnerchannelsDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsAlign Align { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsFilter Filter { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsPosition Position { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsKeltnerchannelsDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
