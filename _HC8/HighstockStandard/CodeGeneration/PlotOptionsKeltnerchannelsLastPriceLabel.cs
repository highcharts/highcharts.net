...
{
	public partial class PlotOptionsKeltnerchannelsLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsKeltnerchannelsLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsKeltnerchannelsLastPriceLabelAlign Align { get; set; }
		private PlotOptionsKeltnerchannelsLastPriceLabelAlign Align_DefaultValue { get; set; }
