...
{
	public partial class PlotOptionsKeltnerchannelsMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKeltnerchannelsMarkerStates();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsMarkerStates States { get; set; }
		private PlotOptionsKeltnerchannelsMarkerStates States_DefaultValue { get; set; }
