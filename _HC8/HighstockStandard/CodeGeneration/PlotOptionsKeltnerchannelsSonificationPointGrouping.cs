...
{
	public partial class PlotOptionsKeltnerchannelsSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKeltnerchannelsSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKeltnerchannelsSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
