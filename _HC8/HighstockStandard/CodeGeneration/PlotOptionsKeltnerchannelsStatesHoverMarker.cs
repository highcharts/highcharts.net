...
{
	public partial class PlotOptionsKeltnerchannelsStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKeltnerchannelsStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesHoverMarkerStates States { get; set; }
		private PlotOptionsKeltnerchannelsStatesHoverMarkerStates States_DefaultValue { get; set; }
