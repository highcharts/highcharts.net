...
{
	public partial class PlotOptionsKeltnerchannelsStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKeltnerchannelsStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsKeltnerchannelsStatesSelectMarkerStates States { get; set; }
		private PlotOptionsKeltnerchannelsStatesSelectMarkerStates States_DefaultValue { get; set; }
