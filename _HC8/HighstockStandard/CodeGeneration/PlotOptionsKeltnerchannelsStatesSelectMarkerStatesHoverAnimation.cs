...
{
	public partial class PlotOptionsKeltnerchannelsStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsStatesSelectMarkerStatesHoverAnimation()
		{
