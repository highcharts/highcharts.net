...
{
	public partial class PlotOptionsKeltnerchannelsStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKeltnerchannelsStatesSelectMarkerStatesSelect()
		{
