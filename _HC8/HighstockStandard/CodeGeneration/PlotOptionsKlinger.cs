...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsKlinger  : BaseObject
	{
		...
		public PlotOptionsKlinger()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsKlingerDragDrop();
		...
		/// </summary>
		public PlotOptionsKlingerDragDrop DragDrop { get; set; }
		private PlotOptionsKlingerDragDrop DragDrop_DefaultValue { get; set; }
