...
{
	public partial class PlotOptionsKlingerAccessibility  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerAccessibility()
		{
		...
		/// </summary>
		public PlotOptionsKlingerAccessibilityKeyboardNavigation KeyboardNavigation { get; set; }
		private PlotOptionsKlingerAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
