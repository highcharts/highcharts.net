...
{
	public partial class PlotOptionsKlingerDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsKlingerDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsKlingerDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsKlingerDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsKlingerDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsKlingerDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsKlingerDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsAlign Align { get; set; }
		private PlotOptionsKlingerDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsFilter Filter { get; set; }
		private PlotOptionsKlingerDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsKlingerDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsPosition Position { get; set; }
		private PlotOptionsKlingerDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsKlingerDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsKlingerDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
