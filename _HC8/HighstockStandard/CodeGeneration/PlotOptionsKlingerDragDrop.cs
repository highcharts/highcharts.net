...
{
	public partial class PlotOptionsKlingerDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsKlingerDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsKlingerDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsKlingerDragDropGuideBox GuideBox_DefaultValue { get; set; }
