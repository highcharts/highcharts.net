...
{
	public partial class PlotOptionsKlingerLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsKlingerLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsKlingerLastPriceLabelAlign Align { get; set; }
		private PlotOptionsKlingerLastPriceLabelAlign Align_DefaultValue { get; set; }
