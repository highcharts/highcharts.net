...
{
	public partial class PlotOptionsKlingerLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsKlingerLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsKlingerLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsKlingerLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
