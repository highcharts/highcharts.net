...
{
	public partial class PlotOptionsKlingerMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKlingerMarkerStates();
		...
		/// </summary>
		public PlotOptionsKlingerMarkerStates States { get; set; }
		private PlotOptionsKlingerMarkerStates States_DefaultValue { get; set; }
