...
{
	public partial class PlotOptionsKlingerOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsKlingerOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsKlingerOnPointPosition();
		...
		/// </summary>
		public PlotOptionsKlingerOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsKlingerOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerOnPointPosition Position { get; set; }
		private PlotOptionsKlingerOnPointPosition Position_DefaultValue { get; set; }
