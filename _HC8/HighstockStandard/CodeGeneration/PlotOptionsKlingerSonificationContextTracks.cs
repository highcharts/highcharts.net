...
{
	public partial class PlotOptionsKlingerSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsKlingerSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsKlingerSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsKlingerSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsKlingerSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsKlingerSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsKlingerSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsKlingerSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsKlingerSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksType Type { get; set; }
		private PlotOptionsKlingerSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsKlingerSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
