...
{
	public partial class PlotOptionsKlingerSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKlingerSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKlingerSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
