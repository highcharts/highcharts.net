...
{
	public partial class PlotOptionsKlingerSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsKlingerSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsKlingerSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsKlingerSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
