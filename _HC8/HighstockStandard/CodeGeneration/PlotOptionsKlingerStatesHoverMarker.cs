...
{
	public partial class PlotOptionsKlingerStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKlingerStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsKlingerStatesHoverMarkerStates States { get; set; }
		private PlotOptionsKlingerStatesHoverMarkerStates States_DefaultValue { get; set; }
