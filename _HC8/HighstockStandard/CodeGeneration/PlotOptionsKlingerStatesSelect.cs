...
{
	public partial class PlotOptionsKlingerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsKlingerStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsKlingerStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsKlingerStatesSelectHalo Halo { get; set; }
		private PlotOptionsKlingerStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsKlingerStatesSelectMarker Marker { get; set; }
		private PlotOptionsKlingerStatesSelectMarker Marker_DefaultValue { get; set; }
