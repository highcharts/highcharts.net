...
{
	public partial class PlotOptionsKlingerStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsKlingerStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsKlingerStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsKlingerStatesSelectMarkerStates States { get; set; }
		private PlotOptionsKlingerStatesSelectMarkerStates States_DefaultValue { get; set; }
