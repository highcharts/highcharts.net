...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLineDataLabels  : BaseObject
	{
		...
		public PlotOptionsLineDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLineDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLineDataLabelsPosition.Center;
		...
		/// </summary>
		public PlotOptionsLineDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLineDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineDataLabelsPosition Position { get; set; }
		private PlotOptionsLineDataLabelsPosition Position_DefaultValue { get; set; }
