...
{
	public partial class PlotOptionsLineLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLineLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLineLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLineLastPriceLabelAlign Align_DefaultValue { get; set; }
