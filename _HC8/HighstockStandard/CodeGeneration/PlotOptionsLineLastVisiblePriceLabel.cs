...
{
	public partial class PlotOptionsLineLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLineLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLineLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLineLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
