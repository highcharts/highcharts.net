...
{
	public partial class PlotOptionsLineOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsLineOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsLineOnPointPosition();
		...
		/// </summary>
		public PlotOptionsLineOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsLineOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineOnPointPosition Position { get; set; }
		private PlotOptionsLineOnPointPosition Position_DefaultValue { get; set; }
