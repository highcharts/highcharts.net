...
{
	public partial class PlotOptionsLineSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLineSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLineSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLineSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLineSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsLineSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLineSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsLineSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLineSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLineSonificationTracksType Type { get; set; }
		private PlotOptionsLineSonificationTracksType Type_DefaultValue { get; set; }
