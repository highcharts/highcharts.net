...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregression  : BaseObject
	{
		...
		public PlotOptionsLinearregression()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsLinearregressionPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
