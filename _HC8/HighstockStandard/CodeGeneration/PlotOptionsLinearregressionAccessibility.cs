...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionAccessibility  : BaseObject
	{
		...
		public PlotOptionsLinearregressionAccessibility()
		{
			...
			Point = Point_DefaultValue = new PlotOptionsLinearregressionAccessibilityPoint();
		...
		/// </summary>
		public PlotOptionsLinearregressionAccessibilityPoint Point { get; set; }
		private PlotOptionsLinearregressionAccessibilityPoint Point_DefaultValue { get; set; }
