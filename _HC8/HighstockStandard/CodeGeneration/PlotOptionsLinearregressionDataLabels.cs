...
{
	public partial class PlotOptionsLinearregressionDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLinearregressionDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLinearregressionDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLinearregressionDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsLinearregressionDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLinearregressionDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsAlign Align { get; set; }
		private PlotOptionsLinearregressionDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsFilter Filter { get; set; }
		private PlotOptionsLinearregressionDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLinearregressionDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsPosition Position { get; set; }
		private PlotOptionsLinearregressionDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLinearregressionDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLinearregressionDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
