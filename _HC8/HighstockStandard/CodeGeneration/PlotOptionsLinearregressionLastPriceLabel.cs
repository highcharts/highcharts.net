...
{
	public partial class PlotOptionsLinearregressionLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionLastPriceLabelAlign Align_DefaultValue { get; set; }
