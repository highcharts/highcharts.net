...
{
	public partial class PlotOptionsLinearregressionLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
