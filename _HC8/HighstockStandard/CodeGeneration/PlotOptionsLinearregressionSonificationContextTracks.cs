...
{
	public partial class PlotOptionsLinearregressionSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLinearregressionSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLinearregressionSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLinearregressionSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsLinearregressionSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsLinearregressionSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksType Type { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsLinearregressionSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
