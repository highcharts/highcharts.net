...
{
	public partial class PlotOptionsLinearregressionSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
