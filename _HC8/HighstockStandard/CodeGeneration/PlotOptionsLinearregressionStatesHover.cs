...
{
	public partial class PlotOptionsLinearregressionStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressionStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesHoverHalo Halo { get; set; }
		private PlotOptionsLinearregressionStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesHoverMarker Marker { get; set; }
		private PlotOptionsLinearregressionStatesHoverMarker Marker_DefaultValue { get; set; }
