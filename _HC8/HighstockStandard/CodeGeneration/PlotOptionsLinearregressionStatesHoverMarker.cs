...
{
	public partial class PlotOptionsLinearregressionStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLinearregressionStatesHoverMarkerStates States_DefaultValue { get; set; }
