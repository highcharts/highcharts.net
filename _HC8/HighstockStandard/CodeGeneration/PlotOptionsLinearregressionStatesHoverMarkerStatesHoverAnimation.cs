...
{
	public partial class PlotOptionsLinearregressionStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesHoverMarkerStatesHoverAnimation()
		{
