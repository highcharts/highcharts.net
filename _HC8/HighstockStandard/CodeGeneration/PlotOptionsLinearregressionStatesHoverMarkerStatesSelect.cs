...
{
	public partial class PlotOptionsLinearregressionStatesHoverMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesHoverMarkerStatesSelect()
		{
