...
{
	public partial class PlotOptionsLinearregressionStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressionStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesSelectHalo Halo { get; set; }
		private PlotOptionsLinearregressionStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesSelectMarker Marker { get; set; }
		private PlotOptionsLinearregressionStatesSelectMarker Marker_DefaultValue { get; set; }
