...
{
	public partial class PlotOptionsLinearregressionStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLinearregressionStatesSelectMarkerStates States_DefaultValue { get; set; }
