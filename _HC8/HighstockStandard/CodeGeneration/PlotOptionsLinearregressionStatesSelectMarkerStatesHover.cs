...
{
	public partial class PlotOptionsLinearregressionStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesSelectMarkerStatesHover()
		{
