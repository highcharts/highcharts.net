...
{
	public partial class PlotOptionsLinearregressionStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionStatesSelectMarkerStatesSelect()
		{
