...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionangle  : BaseObject
	{
		...
		public PlotOptionsLinearregressionangle()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionangleDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsLinearregressionanglePointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
