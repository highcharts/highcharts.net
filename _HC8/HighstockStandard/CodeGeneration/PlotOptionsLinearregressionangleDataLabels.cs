...
{
	public partial class PlotOptionsLinearregressionangleDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionangleDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLinearregressionangleDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLinearregressionangleDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLinearregressionangleDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsLinearregressionangleDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLinearregressionangleDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsAlign Align { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsFilter Filter { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsPosition Position { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLinearregressionangleDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
