...
{
	public partial class PlotOptionsLinearregressionangleLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionangleLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionangleLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionangleLastPriceLabelAlign Align_DefaultValue { get; set; }
