...
{
	public partial class PlotOptionsLinearregressionangleLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionangleLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionangleLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionangleLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
