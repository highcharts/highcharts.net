...
{
	public partial class PlotOptionsLinearregressionangleMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionangleMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleMarkerStates States { get; set; }
		private PlotOptionsLinearregressionangleMarkerStates States_DefaultValue { get; set; }
