...
{
	public partial class PlotOptionsLinearregressionangleMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleMarkerStatesHoverAnimation()
		{
