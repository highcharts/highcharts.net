...
{
	public partial class PlotOptionsLinearregressionangleSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsLinearregressionangleSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsLinearregressionangleSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsLinearregressionangleSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
