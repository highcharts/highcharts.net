...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionangleSonificationTracksMappingHighpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingHighpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsLinearregressionangleSonificationTracksMappingHighpassResonance();
		...
		private PlotOptionsLinearregressionangleSonificationTracksMappingHighpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsLinearregressionangleSonificationTracksMappingHighpassResonance Resonance_DefaultValue { get; set; }
