...
{
	public partial class PlotOptionsLinearregressionangleStatesHover  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesHoverHalo Halo { get; set; }
		private PlotOptionsLinearregressionangleStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesHoverMarker Marker { get; set; }
		private PlotOptionsLinearregressionangleStatesHoverMarker Marker_DefaultValue { get; set; }
