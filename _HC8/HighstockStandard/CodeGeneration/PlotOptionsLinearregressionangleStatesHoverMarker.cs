...
{
	public partial class PlotOptionsLinearregressionangleStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionangleStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLinearregressionangleStatesHoverMarkerStates States_DefaultValue { get; set; }
