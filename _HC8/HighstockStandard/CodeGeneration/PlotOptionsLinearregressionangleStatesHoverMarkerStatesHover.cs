...
{
	public partial class PlotOptionsLinearregressionangleStatesHoverMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesHoverMarkerStatesHover()
		{
