...
{
	public partial class PlotOptionsLinearregressionangleStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesHoverMarkerStatesHoverAnimation()
		{
