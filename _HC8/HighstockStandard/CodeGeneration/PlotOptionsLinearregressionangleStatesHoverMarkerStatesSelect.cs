...
{
	public partial class PlotOptionsLinearregressionangleStatesHoverMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesHoverMarkerStatesSelect()
		{
