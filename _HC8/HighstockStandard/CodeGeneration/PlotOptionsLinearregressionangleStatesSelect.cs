...
{
	public partial class PlotOptionsLinearregressionangleStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressionangleStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionangleStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesSelectHalo Halo { get; set; }
		private PlotOptionsLinearregressionangleStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesSelectMarker Marker { get; set; }
		private PlotOptionsLinearregressionangleStatesSelectMarker Marker_DefaultValue { get; set; }
