...
{
	public partial class PlotOptionsLinearregressionangleStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionangleStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionangleStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLinearregressionangleStatesSelectMarkerStates States_DefaultValue { get; set; }
