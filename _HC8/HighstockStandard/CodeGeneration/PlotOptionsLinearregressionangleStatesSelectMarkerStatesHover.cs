...
{
	public partial class PlotOptionsLinearregressionangleStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesSelectMarkerStatesHover()
		{
