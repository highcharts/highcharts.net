...
{
	public partial class PlotOptionsLinearregressionangleStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionangleStatesSelectMarkerStatesSelect()
		{
