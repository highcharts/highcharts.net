...
{
	public partial class PlotOptionsLinearregressioninterceptDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressioninterceptDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLinearregressioninterceptDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLinearregressioninterceptDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLinearregressioninterceptDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsLinearregressioninterceptDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLinearregressioninterceptDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsAlign Align { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsFilter Filter { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsPosition Position { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLinearregressioninterceptDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (Filter.IsDirty(ref highstock)) h.Add("filter",Filter.ToHashtable(ref highstock));
			...
			if (TextPath.IsDirty(ref highstock)) h.Add("textPath",TextPath.ToHashtable(ref highstock));
