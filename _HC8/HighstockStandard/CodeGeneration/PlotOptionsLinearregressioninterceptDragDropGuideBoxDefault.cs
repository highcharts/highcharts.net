...
{
	public partial class PlotOptionsLinearregressioninterceptDragDropGuideBoxDefault  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptDragDropGuideBoxDefault()
		{
