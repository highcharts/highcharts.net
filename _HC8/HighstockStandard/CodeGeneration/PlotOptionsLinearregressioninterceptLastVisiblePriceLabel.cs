...
{
	public partial class PlotOptionsLinearregressioninterceptLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressioninterceptLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressioninterceptLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressioninterceptLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
