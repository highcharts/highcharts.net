...
{
	public partial class PlotOptionsLinearregressioninterceptOnPointConnectorOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptOnPointConnectorOptions()
		{
