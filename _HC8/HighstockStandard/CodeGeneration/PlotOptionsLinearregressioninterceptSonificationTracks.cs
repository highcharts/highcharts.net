...
{
	public partial class PlotOptionsLinearregressioninterceptSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLinearregressioninterceptSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsLinearregressioninterceptSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptSonificationTracksType Type { get; set; }
		private PlotOptionsLinearregressioninterceptSonificationTracksType Type_DefaultValue { get; set; }
