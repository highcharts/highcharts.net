...
{
	public partial class PlotOptionsLinearregressioninterceptStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressioninterceptStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressioninterceptStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesHoverHalo Halo { get; set; }
		private PlotOptionsLinearregressioninterceptStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesHoverMarker Marker { get; set; }
		private PlotOptionsLinearregressioninterceptStatesHoverMarker Marker_DefaultValue { get; set; }
