...
{
	public partial class PlotOptionsLinearregressioninterceptStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesHoverAnimation()
		{
