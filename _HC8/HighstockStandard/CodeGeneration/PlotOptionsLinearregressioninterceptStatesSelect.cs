...
{
	public partial class PlotOptionsLinearregressioninterceptStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressioninterceptStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressioninterceptStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesSelectHalo Halo { get; set; }
		private PlotOptionsLinearregressioninterceptStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesSelectMarker Marker { get; set; }
		private PlotOptionsLinearregressioninterceptStatesSelectMarker Marker_DefaultValue { get; set; }
