...
{
	public partial class PlotOptionsLinearregressioninterceptStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressioninterceptStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressioninterceptStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLinearregressioninterceptStatesSelectMarkerStates States_DefaultValue { get; set; }
