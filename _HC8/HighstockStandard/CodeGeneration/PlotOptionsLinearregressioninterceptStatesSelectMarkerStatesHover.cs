...
{
	public partial class PlotOptionsLinearregressioninterceptStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesSelectMarkerStatesHover()
		{
