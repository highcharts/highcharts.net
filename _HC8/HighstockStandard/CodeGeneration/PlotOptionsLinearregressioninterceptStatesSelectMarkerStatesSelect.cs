...
{
	public partial class PlotOptionsLinearregressioninterceptStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressioninterceptStatesSelectMarkerStatesSelect()
		{
