...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLinearregressionslope  : BaseObject
	{
		...
		public PlotOptionsLinearregressionslope()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsLinearregressionslopeDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsLinearregressionslopePointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
