...
{
	public partial class PlotOptionsLinearregressionslopeDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionslopeDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLinearregressionslopeDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLinearregressionslopeDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLinearregressionslopeDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsLinearregressionslopeDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLinearregressionslopeDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsFilter Filter { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsPosition Position { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLinearregressionslopeDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
