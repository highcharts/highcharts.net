...
{
	public partial class PlotOptionsLinearregressionslopeLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionslopeLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionslopeLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionslopeLastPriceLabelAlign Align_DefaultValue { get; set; }
