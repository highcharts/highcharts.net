...
{
	public partial class PlotOptionsLinearregressionslopeLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLinearregressionslopeLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLinearregressionslopeLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLinearregressionslopeLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
