...
{
	public partial class PlotOptionsLinearregressionslopeMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionslopeMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeMarkerStates States { get; set; }
		private PlotOptionsLinearregressionslopeMarkerStates States_DefaultValue { get; set; }
