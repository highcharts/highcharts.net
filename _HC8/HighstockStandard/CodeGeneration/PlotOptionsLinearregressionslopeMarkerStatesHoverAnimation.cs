...
{
	public partial class PlotOptionsLinearregressionslopeMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeMarkerStatesHoverAnimation()
		{
