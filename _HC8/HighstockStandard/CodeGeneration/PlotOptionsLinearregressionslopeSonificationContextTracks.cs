...
{
	public partial class PlotOptionsLinearregressionslopeSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsLinearregressionslopeSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsLinearregressionslopeSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsLinearregressionslopeSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsLinearregressionslopeSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsLinearregressionslopeSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksType Type { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsLinearregressionslopeSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
