...
{
	public partial class PlotOptionsLinearregressionslopeStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionslopeStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesHoverMarkerStates States { get; set; }
		private PlotOptionsLinearregressionslopeStatesHoverMarkerStates States_DefaultValue { get; set; }
