...
{
	public partial class PlotOptionsLinearregressionslopeStatesHoverMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesHoverMarkerStatesHover()
		{
