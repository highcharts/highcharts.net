...
{
	public partial class PlotOptionsLinearregressionslopeStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesHoverMarkerStatesHoverAnimation()
		{
