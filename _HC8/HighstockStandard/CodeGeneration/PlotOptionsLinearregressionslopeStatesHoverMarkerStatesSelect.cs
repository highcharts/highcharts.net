...
{
	public partial class PlotOptionsLinearregressionslopeStatesHoverMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesHoverMarkerStatesSelect()
		{
