...
{
	public partial class PlotOptionsLinearregressionslopeStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsLinearregressionslopeStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsLinearregressionslopeStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesSelectHalo Halo { get; set; }
		private PlotOptionsLinearregressionslopeStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesSelectMarker Marker { get; set; }
		private PlotOptionsLinearregressionslopeStatesSelectMarker Marker_DefaultValue { get; set; }
