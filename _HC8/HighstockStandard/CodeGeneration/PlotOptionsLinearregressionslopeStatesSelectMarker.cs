...
{
	public partial class PlotOptionsLinearregressionslopeStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsLinearregressionslopeStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsLinearregressionslopeStatesSelectMarkerStates States { get; set; }
		private PlotOptionsLinearregressionslopeStatesSelectMarkerStates States_DefaultValue { get; set; }
