...
{
	public partial class PlotOptionsLinearregressionslopeStatesSelectMarkerStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesSelectMarkerStatesHover()
		{
