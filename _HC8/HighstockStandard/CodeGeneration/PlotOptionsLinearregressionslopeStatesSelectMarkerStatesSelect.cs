...
{
	public partial class PlotOptionsLinearregressionslopeStatesSelectMarkerStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLinearregressionslopeStatesSelectMarkerStatesSelect()
		{
