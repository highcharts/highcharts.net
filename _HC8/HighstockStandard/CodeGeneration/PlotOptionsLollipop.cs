...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLollipop  : BaseObject
	{
		...
		public PlotOptionsLollipop()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsLollipopDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsLollipopPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
