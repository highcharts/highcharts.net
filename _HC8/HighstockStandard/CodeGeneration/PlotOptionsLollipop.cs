...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsLollipop  : BaseObject
	{
		...
		public PlotOptionsLollipop()
		{
			...
			Stacking = Stacking_DefaultValue = PlotOptionsLollipopStacking.Null;
		...
		/// </summary>
		public PlotOptionsLollipopBoostBlending BoostBlending { get; set; }
		private PlotOptionsLollipopBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopStacking Stacking { get; set; }
		private PlotOptionsLollipopStacking Stacking_DefaultValue { get; set; }
