...
{
	public partial class PlotOptionsLollipopDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsLollipopDataGroupingApproximation.approximation", Approximation); }  
