...
{
	public partial class PlotOptionsLollipopDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsLollipopDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsLollipopDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsLollipopDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsLollipopDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsLollipopDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsLollipopDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsAlign Align { get; set; }
		private PlotOptionsLollipopDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsFilter Filter { get; set; }
		private PlotOptionsLollipopDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsLollipopDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsPosition Position { get; set; }
		private PlotOptionsLollipopDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsLollipopDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsLollipopDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
