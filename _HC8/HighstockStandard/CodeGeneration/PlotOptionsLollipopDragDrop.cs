...
{
	public partial class PlotOptionsLollipopDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new PlotOptionsLollipopDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsLollipopDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsLollipopDragDropDragHandle DragHandle { get; set; }
		private PlotOptionsLollipopDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsLollipopDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsLollipopDragDropGuideBox GuideBox_DefaultValue { get; set; }
