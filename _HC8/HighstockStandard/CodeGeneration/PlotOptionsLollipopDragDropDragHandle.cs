...
{
	public partial class PlotOptionsLollipopDragDropDragHandle  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopDragDropDragHandle()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PathFormatter != PathFormatter_DefaultValue) { h.Add("pathFormatter",PathFormatter); Highstock.AddFunction("PlotOptionsLollipopDragDropDragHandlePathFormatter.pathFormatter", PathFormatter); }  
