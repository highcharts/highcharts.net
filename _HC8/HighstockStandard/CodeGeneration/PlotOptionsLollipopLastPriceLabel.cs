...
{
	public partial class PlotOptionsLollipopLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLollipopLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLollipopLastPriceLabelAlign Align { get; set; }
		private PlotOptionsLollipopLastPriceLabelAlign Align_DefaultValue { get; set; }
