...
{
	public partial class PlotOptionsLollipopLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsLollipopLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsLollipopLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsLollipopLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsLollipopLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
