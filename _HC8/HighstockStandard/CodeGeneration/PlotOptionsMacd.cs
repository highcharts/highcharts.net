...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMacd  : BaseObject
	{
		...
		public PlotOptionsMacd()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsMacdDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsMacdPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
