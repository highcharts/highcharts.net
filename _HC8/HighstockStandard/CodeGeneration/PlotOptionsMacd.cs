...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMacd  : BaseObject
	{
		...
		public PlotOptionsMacd()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsMacdDragDrop();
		...
		/// </summary>
		public PlotOptionsMacdDragDrop DragDrop { get; set; }
		private PlotOptionsMacdDragDrop DragDrop_DefaultValue { get; set; }
