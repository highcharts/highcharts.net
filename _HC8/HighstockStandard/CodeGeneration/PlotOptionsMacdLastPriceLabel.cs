...
{
	public partial class PlotOptionsMacdLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsMacdLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsMacdLastPriceLabelAlign Align { get; set; }
		private PlotOptionsMacdLastPriceLabelAlign Align_DefaultValue { get; set; }
