...
{
	public partial class PlotOptionsMacdSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationDefaultInstrumentOptionsActiveWhen()
		{
