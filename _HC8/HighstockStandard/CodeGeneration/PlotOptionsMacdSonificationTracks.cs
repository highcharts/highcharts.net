...
{
	public partial class PlotOptionsMacdSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsMacdSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsMacdSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsMacdSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsMacdSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsMacdSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsMacdSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsMacdSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksType Type { get; set; }
		private PlotOptionsMacdSonificationTracksType Type_DefaultValue { get; set; }
