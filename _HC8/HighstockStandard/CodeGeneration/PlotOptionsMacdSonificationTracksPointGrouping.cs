...
{
	public partial class PlotOptionsMacdSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMacdSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMacdSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMacdSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMacdSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
