...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfi  : BaseObject
	{
		...
		public PlotOptionsMfi()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsMfiDragDrop();
		...
		/// </summary>
		public PlotOptionsMfiDragDrop DragDrop { get; set; }
		private PlotOptionsMfiDragDrop DragDrop_DefaultValue { get; set; }
