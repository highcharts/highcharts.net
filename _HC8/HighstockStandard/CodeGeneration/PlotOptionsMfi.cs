...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfi  : BaseObject
	{
		...
		public PlotOptionsMfi()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsMfiDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsMfiPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
