...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfiDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsMfiDataGroupingApproximation.approximation", Approximation); }  
