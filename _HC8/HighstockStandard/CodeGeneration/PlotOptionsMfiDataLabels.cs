...
{
	public partial class PlotOptionsMfiDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsMfiDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsMfiDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsMfiDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsMfiDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsMfiDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMfiDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsAlign Align { get; set; }
		private PlotOptionsMfiDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsFilter Filter { get; set; }
		private PlotOptionsMfiDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsMfiDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsPosition Position { get; set; }
		private PlotOptionsMfiDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsMfiDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsMfiDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
