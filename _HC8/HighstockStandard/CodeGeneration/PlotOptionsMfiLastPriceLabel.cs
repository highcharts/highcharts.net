...
{
	public partial class PlotOptionsMfiLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsMfiLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsMfiLastPriceLabelAlign Align { get; set; }
		private PlotOptionsMfiLastPriceLabelAlign Align_DefaultValue { get; set; }
