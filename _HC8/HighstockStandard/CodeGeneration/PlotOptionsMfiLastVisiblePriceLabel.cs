...
{
	public partial class PlotOptionsMfiLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsMfiLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsMfiLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsMfiLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
