...
{
	public partial class PlotOptionsMfiSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMfiSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMfiSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMfiSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
