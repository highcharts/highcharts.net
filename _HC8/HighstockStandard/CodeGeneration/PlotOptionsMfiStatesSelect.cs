...
{
	public partial class PlotOptionsMfiStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsMfiStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsMfiStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsMfiStatesSelectHalo Halo { get; set; }
		private PlotOptionsMfiStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMfiStatesSelectMarker Marker { get; set; }
		private PlotOptionsMfiStatesSelectMarker Marker_DefaultValue { get; set; }
