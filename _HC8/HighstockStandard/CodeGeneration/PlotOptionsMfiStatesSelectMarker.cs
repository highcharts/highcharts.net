...
{
	public partial class PlotOptionsMfiStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMfiStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsMfiStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsMfiStatesSelectMarkerStates States { get; set; }
		private PlotOptionsMfiStatesSelectMarkerStates States_DefaultValue { get; set; }
