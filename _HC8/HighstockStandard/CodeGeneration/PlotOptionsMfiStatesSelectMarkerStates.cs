...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMfiStatesSelectMarkerStates  : BaseObject
	{
		...
		public PlotOptionsMfiStatesSelectMarkerStates()
		{
			...
			Normal = Normal_DefaultValue = new PlotOptionsMfiStatesSelectMarkerStatesNormal();
		...
		/// </summary>
		public PlotOptionsMfiStatesSelectMarkerStatesNormal Normal { get; set; }
		private PlotOptionsMfiStatesSelectMarkerStatesNormal Normal_DefaultValue { get; set; }
