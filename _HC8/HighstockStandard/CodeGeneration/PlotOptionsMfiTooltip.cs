...
{
	public partial class PlotOptionsMfiTooltip  : BaseObject
	{
		...
		public PlotOptionsMfiTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsMfiTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsMfiTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsMfiTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsMfiTooltipNullFormatter.nullFormatter", NullFormatter); }  
