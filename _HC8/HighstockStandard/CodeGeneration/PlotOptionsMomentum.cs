...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentum  : BaseObject
	{
		...
		public PlotOptionsMomentum()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsMomentumDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsMomentumPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
