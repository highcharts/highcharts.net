...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentum  : BaseObject
	{
		...
		public PlotOptionsMomentum()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsMomentumDragDrop();
		...
		/// </summary>
		public PlotOptionsMomentumDragDrop DragDrop { get; set; }
		private PlotOptionsMomentumDragDrop DragDrop_DefaultValue { get; set; }
