...
{
	public partial class PlotOptionsMomentumDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsMomentumDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsMomentumDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsMomentumDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsMomentumDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsMomentumDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsMomentumDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsAlign Align { get; set; }
		private PlotOptionsMomentumDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsFilter Filter { get; set; }
		private PlotOptionsMomentumDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsMomentumDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsPosition Position { get; set; }
		private PlotOptionsMomentumDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsMomentumDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsMomentumDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
