...
{
	public partial class PlotOptionsMomentumLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsMomentumLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsMomentumLastPriceLabelAlign Align { get; set; }
		private PlotOptionsMomentumLastPriceLabelAlign Align_DefaultValue { get; set; }
