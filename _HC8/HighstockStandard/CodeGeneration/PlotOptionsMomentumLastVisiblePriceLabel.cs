...
{
	public partial class PlotOptionsMomentumLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsMomentumLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsMomentumLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsMomentumLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
