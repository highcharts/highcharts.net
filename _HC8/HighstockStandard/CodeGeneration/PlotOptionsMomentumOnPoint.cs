...
{
	public partial class PlotOptionsMomentumOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsMomentumOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsMomentumOnPointPosition();
		...
		/// </summary>
		public PlotOptionsMomentumOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsMomentumOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumOnPointPosition Position { get; set; }
		private PlotOptionsMomentumOnPointPosition Position_DefaultValue { get; set; }
