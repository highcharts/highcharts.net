...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumSonificationDefaultSpeechOptionsMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new PlotOptionsMomentumSonificationDefaultSpeechOptionsMappingTremoloDepth();
			Speed = Speed_DefaultValue = new PlotOptionsMomentumSonificationDefaultSpeechOptionsMappingTremoloSpeed();
		...
		private PlotOptionsMomentumSonificationDefaultSpeechOptionsMappingTremoloDepth Depth_DefaultValue { get; set; }
		...
		private PlotOptionsMomentumSonificationDefaultSpeechOptionsMappingTremoloSpeed Speed_DefaultValue { get; set; }
