...
{
	public partial class PlotOptionsMomentumSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsMomentumSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsMomentumSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsMomentumSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsMomentumSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsMomentumSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsMomentumSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsMomentumSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksType Type { get; set; }
		private PlotOptionsMomentumSonificationTracksType Type_DefaultValue { get; set; }
