...
{
	public partial class PlotOptionsMomentumSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsMomentumSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsMomentumSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsMomentumSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
