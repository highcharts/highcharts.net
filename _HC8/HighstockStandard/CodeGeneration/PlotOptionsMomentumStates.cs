...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsMomentumStates  : BaseObject
	{
		...
		public PlotOptionsMomentumStates()
		{
			...
			Select = Select_DefaultValue = new PlotOptionsMomentumStatesSelect();
		...
		/// </summary>
		public PlotOptionsMomentumStatesSelect Select { get; set; }
		private PlotOptionsMomentumStatesSelect Select_DefaultValue { get; set; }
