...
{
	public partial class PlotOptionsMomentumStatesHover  : BaseObject
	{
		...
		/// </summary>
		public PlotOptionsMomentumStatesHoverMarker Marker { get; set; }
		private PlotOptionsMomentumStatesHoverMarker Marker_DefaultValue { get; set; }
