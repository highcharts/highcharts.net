...
{
	public partial class PlotOptionsMomentumStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PlotOptionsMomentumStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PlotOptionsMomentumStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsMomentumStatesSelectHalo Halo { get; set; }
		private PlotOptionsMomentumStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsMomentumStatesSelectMarker Marker { get; set; }
		private PlotOptionsMomentumStatesSelectMarker Marker_DefaultValue { get; set; }
