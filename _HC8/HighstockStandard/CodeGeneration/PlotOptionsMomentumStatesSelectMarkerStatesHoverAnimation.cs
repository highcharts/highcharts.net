...
{
	public partial class PlotOptionsMomentumStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsMomentumStatesSelectMarkerStatesHoverAnimation()
		{
