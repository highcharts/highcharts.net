...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsNatr  : BaseObject
	{
		...
		public PlotOptionsNatr()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsNatrDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsNatrPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
