...
{
	public partial class PlotOptionsNatrDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsNatrDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsNatrDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsNatrDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsNatrDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsNatrDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsNatrDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsAlign Align { get; set; }
		private PlotOptionsNatrDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsFilter Filter { get; set; }
		private PlotOptionsNatrDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsNatrDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsPosition Position { get; set; }
		private PlotOptionsNatrDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsNatrDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsNatrDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
