...
{
	public partial class PlotOptionsNatrLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsNatrLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsNatrLastPriceLabelAlign Align { get; set; }
		private PlotOptionsNatrLastPriceLabelAlign Align_DefaultValue { get; set; }
