...
{
	public partial class PlotOptionsNatrOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsNatrOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsNatrOnPointPosition();
		...
		/// </summary>
		public PlotOptionsNatrOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsNatrOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrOnPointPosition Position { get; set; }
		private PlotOptionsNatrOnPointPosition Position_DefaultValue { get; set; }
