...
{
	public partial class PlotOptionsNatrSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsNatrSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsNatrSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsNatrSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsNatrSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsNatrSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsNatrSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsNatrSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsNatrSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksType Type { get; set; }
		private PlotOptionsNatrSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsNatrSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
