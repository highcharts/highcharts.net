...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsNatrSonificationDefaultSpeechOptionsMappingLowpass  : BaseObject
	{
		...
		{
			Frequency = Frequency_DefaultValue = new PlotOptionsNatrSonificationDefaultSpeechOptionsMappingLowpassFrequency();
			Resonance = Resonance_DefaultValue = new PlotOptionsNatrSonificationDefaultSpeechOptionsMappingLowpassResonance();
		...
		private PlotOptionsNatrSonificationDefaultSpeechOptionsMappingLowpassFrequency Frequency_DefaultValue { get; set; }
		...
		private PlotOptionsNatrSonificationDefaultSpeechOptionsMappingLowpassResonance Resonance_DefaultValue { get; set; }
