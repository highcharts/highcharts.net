...
{
	public partial class PlotOptionsNatrSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsNatrSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsNatrSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsNatrSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
