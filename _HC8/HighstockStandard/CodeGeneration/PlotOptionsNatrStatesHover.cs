...
{
	public partial class PlotOptionsNatrStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsNatrStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsNatrStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsNatrStatesHoverHalo Halo { get; set; }
		private PlotOptionsNatrStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrStatesHoverMarker Marker { get; set; }
		private PlotOptionsNatrStatesHoverMarker Marker_DefaultValue { get; set; }
