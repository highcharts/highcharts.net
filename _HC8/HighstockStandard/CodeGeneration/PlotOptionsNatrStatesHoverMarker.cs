...
{
	public partial class PlotOptionsNatrStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNatrStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsNatrStatesHoverMarkerStates States { get; set; }
		private PlotOptionsNatrStatesHoverMarkerStates States_DefaultValue { get; set; }
