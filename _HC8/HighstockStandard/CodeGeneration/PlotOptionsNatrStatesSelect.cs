...
{
	public partial class PlotOptionsNatrStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsNatrStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsNatrStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsNatrStatesSelectHalo Halo { get; set; }
		private PlotOptionsNatrStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsNatrStatesSelectMarker Marker { get; set; }
		private PlotOptionsNatrStatesSelectMarker Marker_DefaultValue { get; set; }
