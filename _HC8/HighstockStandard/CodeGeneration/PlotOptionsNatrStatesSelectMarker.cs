...
{
	public partial class PlotOptionsNatrStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsNatrStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsNatrStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsNatrStatesSelectMarkerStates States { get; set; }
		private PlotOptionsNatrStatesSelectMarkerStates States_DefaultValue { get; set; }
