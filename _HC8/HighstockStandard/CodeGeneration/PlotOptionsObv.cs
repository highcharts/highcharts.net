...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsObv  : BaseObject
	{
		...
		public PlotOptionsObv()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsObvDragDrop();
		...
		/// </summary>
		public PlotOptionsObvDragDrop DragDrop { get; set; }
		private PlotOptionsObvDragDrop DragDrop_DefaultValue { get; set; }
