...
{
	public partial class PlotOptionsObvDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsObvDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsObvDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsObvDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsObvDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsObvDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsObvDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsObvDataLabelsAlign Align { get; set; }
		private PlotOptionsObvDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabelsFilter Filter { get; set; }
		private PlotOptionsObvDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsObvDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabelsPosition Position { get; set; }
		private PlotOptionsObvDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsObvDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsObvDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
