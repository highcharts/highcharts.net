...
{
	public partial class PlotOptionsObvDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsObvDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsObvDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsObvDragDropGuideBox GuideBox_DefaultValue { get; set; }
