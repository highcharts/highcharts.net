...
{
	public partial class PlotOptionsObvLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsObvLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsObvLastPriceLabelAlign Align { get; set; }
		private PlotOptionsObvLastPriceLabelAlign Align_DefaultValue { get; set; }
