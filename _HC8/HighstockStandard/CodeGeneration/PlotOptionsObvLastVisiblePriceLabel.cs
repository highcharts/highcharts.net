...
{
	public partial class PlotOptionsObvLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsObvLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsObvLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsObvLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
