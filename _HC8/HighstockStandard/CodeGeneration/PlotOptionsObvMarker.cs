...
{
	public partial class PlotOptionsObvMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsObvMarkerStates();
		...
		/// </summary>
		public PlotOptionsObvMarkerStates States { get; set; }
		private PlotOptionsObvMarkerStates States_DefaultValue { get; set; }
