...
{
	public partial class PlotOptionsObvOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsObvOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsObvOnPointPosition();
		...
		/// </summary>
		public PlotOptionsObvOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsObvOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvOnPointPosition Position { get; set; }
		private PlotOptionsObvOnPointPosition Position_DefaultValue { get; set; }
