...
{
	public partial class PlotOptionsObvStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsObvStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsObvStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsObvStatesHoverHalo Halo { get; set; }
		private PlotOptionsObvStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvStatesHoverMarker Marker { get; set; }
		private PlotOptionsObvStatesHoverMarker Marker_DefaultValue { get; set; }
