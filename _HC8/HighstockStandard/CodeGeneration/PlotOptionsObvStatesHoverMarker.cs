...
{
	public partial class PlotOptionsObvStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsObvStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsObvStatesHoverMarkerStates States { get; set; }
		private PlotOptionsObvStatesHoverMarkerStates States_DefaultValue { get; set; }
