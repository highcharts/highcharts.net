...
{
	public partial class PlotOptionsObvStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsObvStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsObvStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsObvStatesSelectHalo Halo { get; set; }
		private PlotOptionsObvStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsObvStatesSelectMarker Marker { get; set; }
		private PlotOptionsObvStatesSelectMarker Marker_DefaultValue { get; set; }
