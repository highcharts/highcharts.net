...
{
	public partial class PlotOptionsObvStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsObvStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsObvStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsObvStatesSelectMarkerStates States { get; set; }
		private PlotOptionsObvStatesSelectMarkerStates States_DefaultValue { get; set; }
