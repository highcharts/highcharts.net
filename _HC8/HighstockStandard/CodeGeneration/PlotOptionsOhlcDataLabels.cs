...
{
	public partial class PlotOptionsOhlcDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsOhlcDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsOhlcDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsOhlcDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsOhlcDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsOhlcDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsOhlcDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsAlign Align { get; set; }
		private PlotOptionsOhlcDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsFilter Filter { get; set; }
		private PlotOptionsOhlcDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsOhlcDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsPosition Position { get; set; }
		private PlotOptionsOhlcDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsOhlcDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsOhlcDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
