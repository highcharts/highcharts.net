...
{
	public partial class PlotOptionsOhlcLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsOhlcLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsOhlcLastPriceLabelAlign Align { get; set; }
		private PlotOptionsOhlcLastPriceLabelAlign Align_DefaultValue { get; set; }
