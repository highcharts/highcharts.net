...
{
	public partial class PlotOptionsOhlcOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsOhlcOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsOhlcOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsOhlcOnPointPosition();
		...
		/// </summary>
		public PlotOptionsOhlcOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsOhlcOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsOhlcOnPointPosition Position { get; set; }
		private PlotOptionsOhlcOnPointPosition Position_DefaultValue { get; set; }
