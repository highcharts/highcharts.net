...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsOhlcTooltip  : BaseObject
	{
		...
		public PlotOptionsOhlcTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsOhlcTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsOhlcTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsOhlcTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
