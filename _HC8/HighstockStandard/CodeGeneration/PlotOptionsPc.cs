...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPc  : BaseObject
	{
		...
		public PlotOptionsPc()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPcDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsPcPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
