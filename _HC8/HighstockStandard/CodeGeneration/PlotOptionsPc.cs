...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPc  : BaseObject
	{
		...
		public PlotOptionsPc()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPcDragDrop();
		...
		/// </summary>
		public PlotOptionsPcDragDrop DragDrop { get; set; }
		private PlotOptionsPcDragDrop DragDrop_DefaultValue { get; set; }
