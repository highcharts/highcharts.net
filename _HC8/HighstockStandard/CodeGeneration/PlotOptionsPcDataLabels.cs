...
{
	public partial class PlotOptionsPcDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsPcDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPcDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPcDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPcDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPcDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPcDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPcDataLabelsAlign Align { get; set; }
		private PlotOptionsPcDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabelsFilter Filter { get; set; }
		private PlotOptionsPcDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPcDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabelsPosition Position { get; set; }
		private PlotOptionsPcDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPcDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPcDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
