...
{
	public partial class PlotOptionsPcLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPcLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPcLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPcLastPriceLabelAlign Align_DefaultValue { get; set; }
