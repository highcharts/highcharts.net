...
{
	public partial class PlotOptionsPcLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPcLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPcLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPcLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
