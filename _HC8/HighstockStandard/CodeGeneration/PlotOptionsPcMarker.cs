...
{
	public partial class PlotOptionsPcMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPcMarkerStates();
		...
		/// </summary>
		public PlotOptionsPcMarkerStates States { get; set; }
		private PlotOptionsPcMarkerStates States_DefaultValue { get; set; }
