...
{
	public partial class PlotOptionsPcOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPcOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPcOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPcOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPcOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcOnPointPosition Position { get; set; }
		private PlotOptionsPcOnPointPosition Position_DefaultValue { get; set; }
