...
{
	public partial class PlotOptionsPcSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPcSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPcSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPcSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsPcSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsPcSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPcSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsPcSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPcSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksType Type { get; set; }
		private PlotOptionsPcSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsPcSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
