...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPcSonificationDefaultInstrumentOptions  : BaseObject
	{
		...
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPcSonificationDefaultInstrumentOptionsActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPcSonificationDefaultInstrumentOptionsMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPcSonificationDefaultInstrumentOptionsPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPcSonificationDefaultInstrumentOptionsType.Instrument;
		...
		private PlotOptionsPcSonificationDefaultInstrumentOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		private PlotOptionsPcSonificationDefaultInstrumentOptionsMapping Mapping_DefaultValue { get; set; }
		...
		private PlotOptionsPcSonificationDefaultInstrumentOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		private PlotOptionsPcSonificationDefaultInstrumentOptionsType Type_DefaultValue { get; set; }
