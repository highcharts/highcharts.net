...
{
	public partial class PlotOptionsPcSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPcSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPcSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPcSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPcSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPcSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPcSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPcSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcSonificationTracksType Type { get; set; }
		private PlotOptionsPcSonificationTracksType Type_DefaultValue { get; set; }
