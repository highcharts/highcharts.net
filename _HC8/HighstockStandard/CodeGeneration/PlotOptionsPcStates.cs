...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPcStates  : BaseObject
	{
		...
		public PlotOptionsPcStates()
		{
			...
			Select = Select_DefaultValue = new PlotOptionsPcStatesSelect();
		...
		/// </summary>
		public PlotOptionsPcStatesSelect Select { get; set; }
		private PlotOptionsPcStatesSelect Select_DefaultValue { get; set; }
