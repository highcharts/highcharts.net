...
{
	public partial class PlotOptionsPcStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPcStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPcStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPcStatesHoverHalo Halo { get; set; }
		private PlotOptionsPcStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPcStatesHoverMarker Marker { get; set; }
		private PlotOptionsPcStatesHoverMarker Marker_DefaultValue { get; set; }
