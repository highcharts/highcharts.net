...
{
	public partial class PlotOptionsPcStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPcStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPcStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPcStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPcStatesSelectMarkerStates States_DefaultValue { get; set; }
