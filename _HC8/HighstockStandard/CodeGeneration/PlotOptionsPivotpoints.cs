...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPivotpoints  : BaseObject
	{
		...
		public PlotOptionsPivotpoints()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPivotpointsDragDrop();
		...
		/// </summary>
		public PlotOptionsPivotpointsDragDrop DragDrop { get; set; }
		private PlotOptionsPivotpointsDragDrop DragDrop_DefaultValue { get; set; }
