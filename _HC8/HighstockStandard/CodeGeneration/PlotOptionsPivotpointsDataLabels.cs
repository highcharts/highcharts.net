...
{
	public partial class PlotOptionsPivotpointsDataLabels  : BaseObject
	{
		...
		public PlotOptionsPivotpointsDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPivotpointsDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPivotpointsDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPivotpointsDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPivotpointsDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsAlign Align { get; set; }
		private PlotOptionsPivotpointsDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsFilter Filter { get; set; }
		private PlotOptionsPivotpointsDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPivotpointsDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsPosition Position { get; set; }
		private PlotOptionsPivotpointsDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPivotpointsDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPivotpointsDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
