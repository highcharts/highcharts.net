...
{
	public partial class PlotOptionsPivotpointsLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPivotpointsLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPivotpointsLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPivotpointsLastPriceLabelAlign Align_DefaultValue { get; set; }
