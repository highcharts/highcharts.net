...
{
	public partial class PlotOptionsPivotpointsMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPivotpointsMarkerStates();
		...
		/// </summary>
		public PlotOptionsPivotpointsMarkerStates States { get; set; }
		private PlotOptionsPivotpointsMarkerStates States_DefaultValue { get; set; }
