...
{
	public partial class PlotOptionsPivotpointsSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsPivotpointsSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsPivotpointsSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsPivotpointsSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
