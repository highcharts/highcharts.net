...
{
	public partial class PlotOptionsPivotpointsSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsSonificationDefaultInstrumentOptionsActiveWhen()
		{
