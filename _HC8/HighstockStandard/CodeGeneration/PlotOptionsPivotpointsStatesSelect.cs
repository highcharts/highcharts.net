...
{
	public partial class PlotOptionsPivotpointsStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPivotpointsStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPivotpointsStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPivotpointsStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPivotpointsStatesSelectHalo Halo { get; set; }
		private PlotOptionsPivotpointsStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPivotpointsStatesSelectMarker Marker { get; set; }
		private PlotOptionsPivotpointsStatesSelectMarker Marker_DefaultValue { get; set; }
