...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygon  : BaseObject
	{
		...
		public PlotOptionsPolygon()
		{
			...
			Cluster = Cluster_DefaultValue = new PlotOptionsPolygonCluster();
			...
			Compare = Compare_DefaultValue = PlotOptionsPolygonCompare.Null;
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPolygonDashStyle.Null;
			...
			DataSorting = DataSorting_DefaultValue = new PlotOptionsPolygonDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPolygonDragDrop();
			EnableMouseTracking = EnableMouseTracking_DefaultValue = true;
			Events = Events_DefaultValue = new PlotOptionsPolygonEvents();
			FindNearestPointBy = FindNearestPointBy_DefaultValue = PlotOptionsPolygonFindNearestPointBy.X;
			GapSize = GapSize_DefaultValue = 0;
			GapUnit = GapUnit_DefaultValue = PlotOptionsPolygonGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Jitter = Jitter_DefaultValue = new PlotOptionsPolygonJitter();
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new PlotOptionsPolygonLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsPolygonLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsPolygonLastVisiblePrice();
			Linecap = Linecap_DefaultValue = PlotOptionsPolygonLinecap.Round;
			LineWidth = LineWidth_DefaultValue = 2;
			LinkedTo = LinkedTo_DefaultValue = "";
			Marker = Marker_DefaultValue = new PlotOptionsPolygonMarker();
			NegativeColor = NegativeColor_DefaultValue = "";
			OnPoint = OnPoint_DefaultValue = new PlotOptionsPolygonOnPoint();
		...
		/// </summary>
		public PlotOptionsPolygonAccessibility Accessibility { get; set; }
		private PlotOptionsPolygonAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonBoostBlending BoostBlending { get; set; }
		private PlotOptionsPolygonBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonCluster Cluster { get; set; }
		private PlotOptionsPolygonCluster Cluster_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonCompare Compare { get; set; }
		private PlotOptionsPolygonCompare Compare_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDataSorting DataSorting { get; set; }
		private PlotOptionsPolygonDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDragDrop DragDrop { get; set; }
		private PlotOptionsPolygonDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonGapUnit GapUnit { get; set; }
		private PlotOptionsPolygonGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonJitter Jitter { get; set; }
		private PlotOptionsPolygonJitter Jitter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonLastPrice LastPrice { get; set; }
		private PlotOptionsPolygonLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsPolygonLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsPolygonLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsPolygonLinecap Linecap { get; set; }
		private PlotOptionsPolygonLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonOnPoint OnPoint { get; set; }
		private PlotOptionsPolygonOnPoint OnPoint_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonStep Step { get; set; }
		private PlotOptionsPolygonStep Step_DefaultValue { get; set; }
