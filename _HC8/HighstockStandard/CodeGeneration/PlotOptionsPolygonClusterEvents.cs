...
{
	public partial class PlotOptionsPolygonClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("PlotOptionsPolygonClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
