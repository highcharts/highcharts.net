...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygonClusterMarker  : BaseObject
	{
		...
		public PlotOptionsPolygonClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPolygonClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsPolygonClusterMarkerStates States { get; set; }
		private PlotOptionsPolygonClusterMarkerStates States_DefaultValue { get; set; }
