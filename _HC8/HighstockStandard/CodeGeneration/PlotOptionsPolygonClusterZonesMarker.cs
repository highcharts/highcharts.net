...
{
	public partial class PlotOptionsPolygonClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPolygonClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsPolygonClusterZonesMarkerStates States { get; set; }
		private PlotOptionsPolygonClusterZonesMarkerStates States_DefaultValue { get; set; }
