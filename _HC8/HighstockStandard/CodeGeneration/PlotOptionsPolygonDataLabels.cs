...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygonDataLabels  : BaseObject
	{
		...
		public PlotOptionsPolygonDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPolygonDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPolygonDataLabelsPosition.Center;
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPolygonDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonDataLabelsPosition Position { get; set; }
		private PlotOptionsPolygonDataLabelsPosition Position_DefaultValue { get; set; }
