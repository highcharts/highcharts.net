...
{
	public partial class PlotOptionsPolygonLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPolygonLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPolygonLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPolygonLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
