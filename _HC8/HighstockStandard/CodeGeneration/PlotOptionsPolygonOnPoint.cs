...
{
	public partial class PlotOptionsPolygonOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPolygonOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPolygonOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPolygonOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPolygonOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPolygonOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPolygonOnPointPosition Position { get; set; }
		private PlotOptionsPolygonOnPointPosition Position_DefaultValue { get; set; }
