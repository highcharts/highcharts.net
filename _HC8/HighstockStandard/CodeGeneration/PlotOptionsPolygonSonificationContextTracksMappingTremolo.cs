...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPolygonSonificationContextTracksMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingTremoloDepth();
			Speed = Speed_DefaultValue = new PlotOptionsPolygonSonificationContextTracksMappingTremoloSpeed();
		...
		private PlotOptionsPolygonSonificationContextTracksMappingTremoloDepth Depth_DefaultValue { get; set; }
		...
		private PlotOptionsPolygonSonificationContextTracksMappingTremoloSpeed Speed_DefaultValue { get; set; }
