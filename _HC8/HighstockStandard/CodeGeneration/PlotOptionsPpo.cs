...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPpo  : BaseObject
	{
		...
		public PlotOptionsPpo()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPpoDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsPpoPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
