...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPpoDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsPpoDataGroupingApproximation.approximation", Approximation); }  
