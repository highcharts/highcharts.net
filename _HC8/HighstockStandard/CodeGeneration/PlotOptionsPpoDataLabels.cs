...
{
	public partial class PlotOptionsPpoDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsPpoDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPpoDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPpoDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPpoDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPpoDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPpoDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsAlign Align { get; set; }
		private PlotOptionsPpoDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsFilter Filter { get; set; }
		private PlotOptionsPpoDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPpoDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsPosition Position { get; set; }
		private PlotOptionsPpoDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPpoDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPpoDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
