...
{
	public partial class PlotOptionsPpoLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPpoLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPpoLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPpoLastPriceLabelAlign Align_DefaultValue { get; set; }
