...
{
	public partial class PlotOptionsPpoLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPpoLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPpoLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPpoLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
