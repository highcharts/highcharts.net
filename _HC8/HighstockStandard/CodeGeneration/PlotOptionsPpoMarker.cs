...
{
	public partial class PlotOptionsPpoMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPpoMarkerStates();
		...
		/// </summary>
		public PlotOptionsPpoMarkerStates States { get; set; }
		private PlotOptionsPpoMarkerStates States_DefaultValue { get; set; }
