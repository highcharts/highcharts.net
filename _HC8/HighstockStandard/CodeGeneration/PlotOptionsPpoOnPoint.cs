...
{
	public partial class PlotOptionsPpoOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsPpoOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsPpoOnPointPosition();
		...
		/// </summary>
		public PlotOptionsPpoOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsPpoOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoOnPointPosition Position { get; set; }
		private PlotOptionsPpoOnPointPosition Position_DefaultValue { get; set; }
