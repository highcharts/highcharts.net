...
{
	public partial class PlotOptionsPpoStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPpoStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPpoStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsPpoStatesHoverHalo Halo { get; set; }
		private PlotOptionsPpoStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoStatesHoverMarker Marker { get; set; }
		private PlotOptionsPpoStatesHoverMarker Marker_DefaultValue { get; set; }
