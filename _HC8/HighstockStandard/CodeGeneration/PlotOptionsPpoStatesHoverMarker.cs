...
{
	public partial class PlotOptionsPpoStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPpoStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPpoStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPpoStatesHoverMarkerStates States_DefaultValue { get; set; }
