...
{
	public partial class PlotOptionsPpoStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPpoStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPpoStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPpoStatesSelectHalo Halo { get; set; }
		private PlotOptionsPpoStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPpoStatesSelectMarker Marker { get; set; }
		private PlotOptionsPpoStatesSelectMarker Marker_DefaultValue { get; set; }
