...
{
	public partial class PlotOptionsPpoStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPpoStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPpoStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPpoStatesSelectMarkerStates States_DefaultValue { get; set; }
