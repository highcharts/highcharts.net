...
{
	public partial class PlotOptionsPpoTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPpoTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsPpoTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsPpoTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsPpoTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsPpoTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsPpoTooltipPointFormatter.pointFormatter", PointFormatter); }  
