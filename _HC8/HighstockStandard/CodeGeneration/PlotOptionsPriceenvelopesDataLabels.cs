...
{
	public partial class PlotOptionsPriceenvelopesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsPriceenvelopesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPriceenvelopesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPriceenvelopesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPriceenvelopesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPriceenvelopesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPriceenvelopesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsAlign Align { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsFilter Filter { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsPosition Position { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPriceenvelopesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
