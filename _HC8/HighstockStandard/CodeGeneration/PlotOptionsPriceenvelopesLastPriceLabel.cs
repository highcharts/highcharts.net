...
{
	public partial class PlotOptionsPriceenvelopesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPriceenvelopesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPriceenvelopesLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPriceenvelopesLastPriceLabelAlign Align_DefaultValue { get; set; }
