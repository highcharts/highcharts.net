...
{
	public partial class PlotOptionsPriceenvelopesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPriceenvelopesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPriceenvelopesLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPriceenvelopesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
