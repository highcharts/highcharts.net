...
{
	public partial class PlotOptionsPriceenvelopesSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPriceenvelopesSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPriceenvelopesSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPriceenvelopesSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPriceenvelopesSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPriceenvelopesSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPriceenvelopesSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPriceenvelopesSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesSonificationTracksType Type { get; set; }
		private PlotOptionsPriceenvelopesSonificationTracksType Type_DefaultValue { get; set; }
