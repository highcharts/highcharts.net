...
{
	public partial class PlotOptionsPriceenvelopesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPriceenvelopesStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesHoverMarkerStates States { get; set; }
		private PlotOptionsPriceenvelopesStatesHoverMarkerStates States_DefaultValue { get; set; }
