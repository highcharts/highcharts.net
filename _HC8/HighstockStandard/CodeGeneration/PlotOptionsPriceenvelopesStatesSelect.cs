...
{
	public partial class PlotOptionsPriceenvelopesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPriceenvelopesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPriceenvelopesStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesSelectHalo Halo { get; set; }
		private PlotOptionsPriceenvelopesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesSelectMarker Marker { get; set; }
		private PlotOptionsPriceenvelopesStatesSelectMarker Marker_DefaultValue { get; set; }
