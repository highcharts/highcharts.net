...
{
	public partial class PlotOptionsPriceenvelopesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPriceenvelopesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPriceenvelopesStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPriceenvelopesStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPriceenvelopesStatesSelectMarkerStates States_DefaultValue { get; set; }
