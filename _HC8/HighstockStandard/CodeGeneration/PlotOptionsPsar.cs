...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsar  : BaseObject
	{
		...
		public PlotOptionsPsar()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsPsarDragDrop();
		...
		/// </summary>
		public PlotOptionsPsarDragDrop DragDrop { get; set; }
		private PlotOptionsPsarDragDrop DragDrop_DefaultValue { get; set; }
