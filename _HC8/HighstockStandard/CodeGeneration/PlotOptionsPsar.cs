...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsar  : BaseObject
	{
		...
		public PlotOptionsPsar()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsPsarDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsPsarPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
