...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsarDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsPsarDataGroupingApproximation.approximation", Approximation); }  
