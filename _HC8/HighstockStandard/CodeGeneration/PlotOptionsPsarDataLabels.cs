...
{
	public partial class PlotOptionsPsarDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsPsarDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsPsarDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsPsarDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsPsarDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsPsarDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsPsarDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsAlign Align { get; set; }
		private PlotOptionsPsarDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsFilter Filter { get; set; }
		private PlotOptionsPsarDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsPsarDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsPosition Position { get; set; }
		private PlotOptionsPsarDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsPsarDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsPsarDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
