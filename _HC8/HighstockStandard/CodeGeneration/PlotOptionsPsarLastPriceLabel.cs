...
{
	public partial class PlotOptionsPsarLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPsarLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPsarLastPriceLabelAlign Align { get; set; }
		private PlotOptionsPsarLastPriceLabelAlign Align_DefaultValue { get; set; }
