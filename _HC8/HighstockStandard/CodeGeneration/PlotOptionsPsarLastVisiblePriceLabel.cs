...
{
	public partial class PlotOptionsPsarLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsPsarLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsPsarLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsPsarLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
