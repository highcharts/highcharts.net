...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsPsarSonificationContextTracksMappingTremolo  : BaseObject
	{
		...
		{
			Depth = Depth_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingTremoloDepth();
			Speed = Speed_DefaultValue = new PlotOptionsPsarSonificationContextTracksMappingTremoloSpeed();
		...
		private PlotOptionsPsarSonificationContextTracksMappingTremoloDepth Depth_DefaultValue { get; set; }
		...
		private PlotOptionsPsarSonificationContextTracksMappingTremoloSpeed Speed_DefaultValue { get; set; }
