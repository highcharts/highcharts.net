...
{
	public partial class PlotOptionsPsarSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsPsarSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsPsarSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsPsarSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsPsarSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsPsarSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsPsarSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsPsarSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarSonificationTracksType Type { get; set; }
		private PlotOptionsPsarSonificationTracksType Type_DefaultValue { get; set; }
