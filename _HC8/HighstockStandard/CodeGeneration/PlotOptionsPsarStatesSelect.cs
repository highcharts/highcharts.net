...
{
	public partial class PlotOptionsPsarStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsPsarStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsPsarStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsPsarStatesSelectHalo Halo { get; set; }
		private PlotOptionsPsarStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsPsarStatesSelectMarker Marker { get; set; }
		private PlotOptionsPsarStatesSelectMarker Marker_DefaultValue { get; set; }
