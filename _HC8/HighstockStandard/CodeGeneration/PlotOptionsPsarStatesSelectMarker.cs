...
{
	public partial class PlotOptionsPsarStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsPsarStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsPsarStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsPsarStatesSelectMarkerStates States { get; set; }
		private PlotOptionsPsarStatesSelectMarkerStates States_DefaultValue { get; set; }
