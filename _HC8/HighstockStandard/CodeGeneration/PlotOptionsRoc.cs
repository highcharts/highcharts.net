...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRoc  : BaseObject
	{
		...
		public PlotOptionsRoc()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsRocDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsRocPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
