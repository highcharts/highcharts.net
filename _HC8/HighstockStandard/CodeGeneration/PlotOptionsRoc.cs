...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRoc  : BaseObject
	{
		...
		public PlotOptionsRoc()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsRocDragDrop();
		...
		/// </summary>
		public PlotOptionsRocDragDrop DragDrop { get; set; }
		private PlotOptionsRocDragDrop DragDrop_DefaultValue { get; set; }
