...
{
	public partial class PlotOptionsRocDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsRocDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsRocDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsRocDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsRocDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsRocDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsRocDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsRocDataLabelsAlign Align { get; set; }
		private PlotOptionsRocDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabelsFilter Filter { get; set; }
		private PlotOptionsRocDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsRocDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabelsPosition Position { get; set; }
		private PlotOptionsRocDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsRocDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsRocDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
