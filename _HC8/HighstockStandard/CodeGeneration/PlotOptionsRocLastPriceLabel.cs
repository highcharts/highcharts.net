...
{
	public partial class PlotOptionsRocLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsRocLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsRocLastPriceLabelAlign Align { get; set; }
		private PlotOptionsRocLastPriceLabelAlign Align_DefaultValue { get; set; }
