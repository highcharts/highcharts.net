...
{
	public partial class PlotOptionsRocMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsRocMarkerStates();
		...
		/// </summary>
		public PlotOptionsRocMarkerStates States { get; set; }
		private PlotOptionsRocMarkerStates States_DefaultValue { get; set; }
