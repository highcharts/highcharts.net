...
{
	public partial class PlotOptionsRocOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsRocOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsRocOnPointPosition();
		...
		/// </summary>
		public PlotOptionsRocOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsRocOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocOnPointPosition Position { get; set; }
		private PlotOptionsRocOnPointPosition Position_DefaultValue { get; set; }
