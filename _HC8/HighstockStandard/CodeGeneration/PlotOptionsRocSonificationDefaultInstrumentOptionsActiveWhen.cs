...
{
	public partial class PlotOptionsRocSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationDefaultInstrumentOptionsActiveWhen()
		{
