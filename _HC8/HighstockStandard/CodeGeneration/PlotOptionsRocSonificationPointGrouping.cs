...
{
	public partial class PlotOptionsRocSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsRocSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsRocSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsRocSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
