...
{
	public partial class PlotOptionsRocSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsRocSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsRocSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsRocSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsRocSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsRocSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsRocSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsRocSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocSonificationTracksType Type { get; set; }
		private PlotOptionsRocSonificationTracksType Type_DefaultValue { get; set; }
