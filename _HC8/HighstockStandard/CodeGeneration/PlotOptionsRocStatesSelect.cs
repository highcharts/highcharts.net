...
{
	public partial class PlotOptionsRocStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsRocStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsRocStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsRocStatesSelectHalo Halo { get; set; }
		private PlotOptionsRocStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRocStatesSelectMarker Marker { get; set; }
		private PlotOptionsRocStatesSelectMarker Marker_DefaultValue { get; set; }
