...
{
	public partial class PlotOptionsRocStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRocStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsRocStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsRocStatesSelectMarkerStates States { get; set; }
		private PlotOptionsRocStatesSelectMarkerStates States_DefaultValue { get; set; }
