...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRsi  : BaseObject
	{
		...
		public PlotOptionsRsi()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsRsiDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsRsiPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
