...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRsi  : BaseObject
	{
		...
		public PlotOptionsRsi()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsRsiDragDrop();
		...
		/// </summary>
		public PlotOptionsRsiDragDrop DragDrop { get; set; }
		private PlotOptionsRsiDragDrop DragDrop_DefaultValue { get; set; }
