...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsRsiDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsRsiDataGroupingApproximation.approximation", Approximation); }  
