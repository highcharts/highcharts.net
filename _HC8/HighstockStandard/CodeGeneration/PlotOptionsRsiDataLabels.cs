...
{
	public partial class PlotOptionsRsiDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsRsiDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsRsiDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsRsiDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsRsiDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsRsiDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsRsiDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsAlign Align { get; set; }
		private PlotOptionsRsiDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsFilter Filter { get; set; }
		private PlotOptionsRsiDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsRsiDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsPosition Position { get; set; }
		private PlotOptionsRsiDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsRsiDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsRsiDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
