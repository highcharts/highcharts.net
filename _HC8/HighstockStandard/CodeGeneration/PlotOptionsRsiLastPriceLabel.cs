...
{
	public partial class PlotOptionsRsiLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsRsiLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsRsiLastPriceLabelAlign Align { get; set; }
		private PlotOptionsRsiLastPriceLabelAlign Align_DefaultValue { get; set; }
