...
{
	public partial class PlotOptionsRsiLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsRsiLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsRsiLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsRsiLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
