...
{
	public partial class PlotOptionsRsiMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsRsiMarkerStates();
		...
		/// </summary>
		public PlotOptionsRsiMarkerStates States { get; set; }
		private PlotOptionsRsiMarkerStates States_DefaultValue { get; set; }
