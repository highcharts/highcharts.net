...
{
	public partial class PlotOptionsRsiOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsRsiOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsRsiOnPointPosition();
		...
		/// </summary>
		public PlotOptionsRsiOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsRsiOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiOnPointPosition Position { get; set; }
		private PlotOptionsRsiOnPointPosition Position_DefaultValue { get; set; }
