...
{
	public partial class PlotOptionsRsiSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsRsiSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsRsiSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsRsiSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
