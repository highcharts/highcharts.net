...
{
	public partial class PlotOptionsRsiSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsRsiSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsRsiSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsRsiSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsRsiSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsRsiSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsRsiSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsRsiSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiSonificationTracksType Type { get; set; }
		private PlotOptionsRsiSonificationTracksType Type_DefaultValue { get; set; }
