...
{
	public partial class PlotOptionsRsiStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsRsiStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsRsiStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsRsiStatesHoverHalo Halo { get; set; }
		private PlotOptionsRsiStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsRsiStatesHoverMarker Marker { get; set; }
		private PlotOptionsRsiStatesHoverMarker Marker_DefaultValue { get; set; }
