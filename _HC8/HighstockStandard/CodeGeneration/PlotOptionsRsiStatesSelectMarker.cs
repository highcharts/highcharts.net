...
{
	public partial class PlotOptionsRsiStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsRsiStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsRsiStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsRsiStatesSelectMarkerStates States { get; set; }
		private PlotOptionsRsiStatesSelectMarkerStates States_DefaultValue { get; set; }
