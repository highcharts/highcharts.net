...
{
	public partial class PlotOptionsScatterClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterClusterMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatterClusterMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatterClusterMarkerStates States { get; set; }
		private PlotOptionsScatterClusterMarkerStates States_DefaultValue { get; set; }
