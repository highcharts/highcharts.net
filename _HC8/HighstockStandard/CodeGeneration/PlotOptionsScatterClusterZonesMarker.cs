...
{
	public partial class PlotOptionsScatterClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsScatterClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsScatterClusterZonesMarkerStates States { get; set; }
		private PlotOptionsScatterClusterZonesMarkerStates States_DefaultValue { get; set; }
