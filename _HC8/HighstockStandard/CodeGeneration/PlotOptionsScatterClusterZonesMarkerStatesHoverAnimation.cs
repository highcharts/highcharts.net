...
{
	public partial class PlotOptionsScatterClusterZonesMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterClusterZonesMarkerStatesHoverAnimation()
		{
