...
{
	public partial class PlotOptionsScatterLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsScatterLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsScatterLastPriceLabelAlign Align { get; set; }
		private PlotOptionsScatterLastPriceLabelAlign Align_DefaultValue { get; set; }
