...
{
	public partial class PlotOptionsScatterLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsScatterLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsScatterLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsScatterLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
