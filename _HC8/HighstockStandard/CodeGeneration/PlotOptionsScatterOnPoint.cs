...
{
	public partial class PlotOptionsScatterOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsScatterOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsScatterOnPointPosition();
		...
		/// </summary>
		public PlotOptionsScatterOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsScatterOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterOnPointPosition Position { get; set; }
		private PlotOptionsScatterOnPointPosition Position_DefaultValue { get; set; }
