...
{
	public partial class PlotOptionsScatterSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsScatterSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsScatterSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsScatterSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsScatterSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsScatterSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsScatterSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsScatterSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsScatterSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksType Type { get; set; }
		private PlotOptionsScatterSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsScatterSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
