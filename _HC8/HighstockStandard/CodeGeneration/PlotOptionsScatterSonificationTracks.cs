...
{
	public partial class PlotOptionsScatterSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsScatterSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsScatterSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsScatterSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsScatterSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsScatterSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsScatterSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsScatterSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsScatterSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsScatterSonificationTracksType Type { get; set; }
		private PlotOptionsScatterSonificationTracksType Type_DefaultValue { get; set; }
