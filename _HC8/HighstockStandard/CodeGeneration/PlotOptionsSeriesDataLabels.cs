...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSeriesDataLabels  : BaseObject
	{
		...
		public PlotOptionsSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesDataLabelsPosition Position { get; set; }
		private PlotOptionsSeriesDataLabelsPosition Position_DefaultValue { get; set; }
