...
{
	public partial class PlotOptionsSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSeriesLastPriceLabelAlign Align { get; set; }
		private PlotOptionsSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
