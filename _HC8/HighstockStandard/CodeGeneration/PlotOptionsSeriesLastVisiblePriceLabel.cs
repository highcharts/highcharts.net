...
{
	public partial class PlotOptionsSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
