...
{
	public partial class PlotOptionsSeriesSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSeriesSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSeriesSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSeriesSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSeriesSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSeriesSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSeriesSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSeriesSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSeriesSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSeriesSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksType Type { get; set; }
		private PlotOptionsSeriesSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSeriesSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSeriesSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
