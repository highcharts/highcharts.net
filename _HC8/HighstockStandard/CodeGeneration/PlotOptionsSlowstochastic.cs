...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSlowstochastic  : BaseObject
	{
		...
		public PlotOptionsSlowstochastic()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsSlowstochasticDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsSlowstochasticPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
