...
{
	public partial class PlotOptionsSlowstochasticDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsSlowstochasticDataGroupingApproximation.approximation", Approximation); }  
