...
{
	public partial class PlotOptionsSlowstochasticDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsSlowstochasticDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsSlowstochasticDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsSlowstochasticDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsSlowstochasticDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsSlowstochasticDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSlowstochasticDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsAlign Align { get; set; }
		private PlotOptionsSlowstochasticDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsFilter Filter { get; set; }
		private PlotOptionsSlowstochasticDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSlowstochasticDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsPosition Position { get; set; }
		private PlotOptionsSlowstochasticDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSlowstochasticDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSlowstochasticDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSlowstochasticDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
