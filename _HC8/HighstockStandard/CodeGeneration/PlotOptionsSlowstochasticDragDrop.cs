...
{
	public partial class PlotOptionsSlowstochasticDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsSlowstochasticDragDropGuideBox();
		...
		/// </summary>
		public PlotOptionsSlowstochasticDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsSlowstochasticDragDropGuideBox GuideBox_DefaultValue { get; set; }
