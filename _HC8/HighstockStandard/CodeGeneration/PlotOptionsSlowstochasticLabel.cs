...
{
	public partial class PlotOptionsSlowstochasticLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PlotOptionsSlowstochasticLabelFormatter.formatter", Formatter); }  
