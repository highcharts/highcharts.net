...
{
	public partial class PlotOptionsSlowstochasticLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSlowstochasticLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSlowstochasticLastPriceLabelAlign Align { get; set; }
		private PlotOptionsSlowstochasticLastPriceLabelAlign Align_DefaultValue { get; set; }
