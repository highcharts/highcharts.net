...
{
	public partial class PlotOptionsSlowstochasticLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSlowstochasticLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSlowstochasticLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsSlowstochasticLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
