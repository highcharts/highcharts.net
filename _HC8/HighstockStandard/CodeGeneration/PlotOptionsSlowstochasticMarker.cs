...
{
	public partial class PlotOptionsSlowstochasticMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSlowstochasticMarkerStates();
		...
		/// </summary>
		public PlotOptionsSlowstochasticMarkerStates States { get; set; }
		private PlotOptionsSlowstochasticMarkerStates States_DefaultValue { get; set; }
