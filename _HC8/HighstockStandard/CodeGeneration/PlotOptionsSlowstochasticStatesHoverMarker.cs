...
{
	public partial class PlotOptionsSlowstochasticStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSlowstochasticStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSlowstochasticStatesHoverMarkerStates States_DefaultValue { get; set; }
