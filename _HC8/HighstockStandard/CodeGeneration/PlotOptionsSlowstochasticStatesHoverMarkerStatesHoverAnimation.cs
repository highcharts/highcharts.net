...
{
	public partial class PlotOptionsSlowstochasticStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesHoverMarkerStatesHoverAnimation()
		{
