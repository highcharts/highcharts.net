...
{
	public partial class PlotOptionsSlowstochasticStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSlowstochasticStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSlowstochasticStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSlowstochasticStatesSelectMarkerStates States_DefaultValue { get; set; }
