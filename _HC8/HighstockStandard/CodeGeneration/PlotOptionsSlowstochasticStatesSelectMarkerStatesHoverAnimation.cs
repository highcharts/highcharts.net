...
{
	public partial class PlotOptionsSlowstochasticStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticStatesSelectMarkerStatesHoverAnimation()
		{
