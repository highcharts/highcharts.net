...
{
	public partial class PlotOptionsSlowstochasticTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSlowstochasticTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsSlowstochasticTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsSlowstochasticTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsSlowstochasticTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("PlotOptionsSlowstochasticTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("PlotOptionsSlowstochasticTooltipPointFormatter.pointFormatter", PointFormatter); }  
