...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSma  : BaseObject
	{
		...
		public PlotOptionsSma()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsSmaDragDrop();
		...
		/// </summary>
		public PlotOptionsSmaDragDrop DragDrop { get; set; }
		private PlotOptionsSmaDragDrop DragDrop_DefaultValue { get; set; }
