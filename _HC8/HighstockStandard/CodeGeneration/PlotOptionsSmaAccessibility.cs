...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSmaAccessibility  : BaseObject
	{
		...
		public PlotOptionsSmaAccessibility()
		{
			...
			KeyboardNavigation = KeyboardNavigation_DefaultValue = new PlotOptionsSmaAccessibilityKeyboardNavigation();
		...
		private PlotOptionsSmaAccessibilityKeyboardNavigation KeyboardNavigation_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsSmaAccessibilityPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
