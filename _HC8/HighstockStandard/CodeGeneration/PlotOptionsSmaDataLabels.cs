...
{
	public partial class PlotOptionsSmaDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsSmaDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsSmaDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsSmaDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsSmaDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsSmaDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSmaDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsAlign Align { get; set; }
		private PlotOptionsSmaDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsFilter Filter { get; set; }
		private PlotOptionsSmaDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSmaDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsPosition Position { get; set; }
		private PlotOptionsSmaDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSmaDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSmaDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
