...
{
	public partial class PlotOptionsSmaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSmaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSmaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsSmaLastPriceLabelAlign Align_DefaultValue { get; set; }
