...
{
	public partial class PlotOptionsSmaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSmaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSmaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsSmaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
