...
{
	public partial class PlotOptionsSmaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsSmaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsSmaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsSmaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsSmaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsSmaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsSmaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsSmaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsSmaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksType Type { get; set; }
		private PlotOptionsSmaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsSmaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
