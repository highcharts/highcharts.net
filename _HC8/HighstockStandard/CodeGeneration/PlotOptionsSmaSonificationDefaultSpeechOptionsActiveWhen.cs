...
{
	public partial class PlotOptionsSmaSonificationDefaultSpeechOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaSonificationDefaultSpeechOptionsActiveWhen()
		{
