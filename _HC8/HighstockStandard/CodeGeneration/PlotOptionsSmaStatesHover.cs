...
{
	public partial class PlotOptionsSmaStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSmaStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSmaStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsSmaStatesHoverHalo Halo { get; set; }
		private PlotOptionsSmaStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaStatesHoverMarker Marker { get; set; }
		private PlotOptionsSmaStatesHoverMarker Marker_DefaultValue { get; set; }
