...
{
	public partial class PlotOptionsSmaStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSmaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSmaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSmaStatesHoverMarkerStates States_DefaultValue { get; set; }
