...
{
	public partial class PlotOptionsSmaStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsSmaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsSmaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSmaStatesSelectHalo Halo { get; set; }
		private PlotOptionsSmaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSmaStatesSelectMarker Marker { get; set; }
		private PlotOptionsSmaStatesSelectMarker Marker_DefaultValue { get; set; }
