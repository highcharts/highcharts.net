...
{
	public partial class PlotOptionsSmaStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSmaStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSmaStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSmaStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSmaStatesSelectMarkerStates States_DefaultValue { get; set; }
