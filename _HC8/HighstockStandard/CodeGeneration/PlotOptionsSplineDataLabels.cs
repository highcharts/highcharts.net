...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSplineDataLabels  : BaseObject
	{
		...
		public PlotOptionsSplineDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = PlotOptionsSplineDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsSplineDataLabelsPosition.Center;
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSplineDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSplineDataLabelsPosition Position { get; set; }
		private PlotOptionsSplineDataLabelsPosition Position_DefaultValue { get; set; }
