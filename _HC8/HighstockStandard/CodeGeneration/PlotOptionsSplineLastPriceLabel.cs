...
{
	public partial class PlotOptionsSplineLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSplineLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSplineLastPriceLabelAlign Align { get; set; }
		private PlotOptionsSplineLastPriceLabelAlign Align_DefaultValue { get; set; }
