...
{
	public partial class PlotOptionsSplineLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSplineLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSplineLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSplineLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsSplineLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
