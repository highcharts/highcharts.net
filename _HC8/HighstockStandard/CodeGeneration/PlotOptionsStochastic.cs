...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStochastic  : BaseObject
	{
		...
		public PlotOptionsStochastic()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsStochasticDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsStochasticPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
