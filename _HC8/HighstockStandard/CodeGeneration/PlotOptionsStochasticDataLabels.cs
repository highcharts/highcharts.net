...
{
	public partial class PlotOptionsStochasticDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsStochasticDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsStochasticDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsStochasticDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsStochasticDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsStochasticDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsStochasticDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsAlign Align { get; set; }
		private PlotOptionsStochasticDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsFilter Filter { get; set; }
		private PlotOptionsStochasticDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsStochasticDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsPosition Position { get; set; }
		private PlotOptionsStochasticDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsStochasticDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsStochasticDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
