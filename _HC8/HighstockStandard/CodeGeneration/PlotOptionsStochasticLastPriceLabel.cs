...
{
	public partial class PlotOptionsStochasticLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsStochasticLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsStochasticLastPriceLabelAlign Align { get; set; }
		private PlotOptionsStochasticLastPriceLabelAlign Align_DefaultValue { get; set; }
