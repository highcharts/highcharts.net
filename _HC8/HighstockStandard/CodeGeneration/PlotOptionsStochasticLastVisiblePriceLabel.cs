...
{
	public partial class PlotOptionsStochasticLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsStochasticLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsStochasticLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsStochasticLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
