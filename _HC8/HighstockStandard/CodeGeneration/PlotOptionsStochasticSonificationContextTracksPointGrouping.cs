...
{
	public partial class PlotOptionsStochasticSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsStochasticSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsStochasticSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
