...
{
	public partial class PlotOptionsStochasticSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsStochasticSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsStochasticSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsStochasticSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
