...
{
	public partial class PlotOptionsStochasticStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsStochasticStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsStochasticStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsStochasticStatesHoverHalo Halo { get; set; }
		private PlotOptionsStochasticStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticStatesHoverMarker Marker { get; set; }
		private PlotOptionsStochasticStatesHoverMarker Marker_DefaultValue { get; set; }
