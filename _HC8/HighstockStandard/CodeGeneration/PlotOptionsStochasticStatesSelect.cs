...
{
	public partial class PlotOptionsStochasticStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PlotOptionsStochasticStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PlotOptionsStochasticStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsStochasticStatesSelectHalo Halo { get; set; }
		private PlotOptionsStochasticStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStochasticStatesSelectMarker Marker { get; set; }
		private PlotOptionsStochasticStatesSelectMarker Marker_DefaultValue { get; set; }
