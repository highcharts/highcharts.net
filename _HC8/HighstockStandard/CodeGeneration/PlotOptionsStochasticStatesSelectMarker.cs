...
{
	public partial class PlotOptionsStochasticStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStochasticStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsStochasticStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsStochasticStatesSelectMarkerStates States { get; set; }
		private PlotOptionsStochasticStatesSelectMarkerStates States_DefaultValue { get; set; }
