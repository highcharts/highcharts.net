...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStreamgraph  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PlotOptionsStreamgraphAccessibility();
			AllowPointSelect = AllowPointSelect_DefaultValue = false;
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationLimit = AnimationLimit_DefaultValue = null;
			BoostBlending = BoostBlending_DefaultValue = PlotOptionsStreamgraphBoostBlending.Undefined;
			...
			CompareBase = CompareBase_DefaultValue = PlotOptionsStreamgraphCompareBase.Min;
			CompareStart = CompareStart_DefaultValue = false;
			ConnectNulls = ConnectNulls_DefaultValue = false;
			Crisp = Crisp_DefaultValue = true;
			CropThreshold = CropThreshold_DefaultValue = 300;
			Cursor = Cursor_DefaultValue = PlotOptionsStreamgraphCursor.Null;
			Custom = Custom_DefaultValue = new Hashtable();
			DashStyle = DashStyle_DefaultValue = PlotOptionsStreamgraphDashStyle.Null;
			DataGrouping = DataGrouping_DefaultValue = new PlotOptionsStreamgraphDataGrouping();
			DataLabels = DataLabels_DefaultValue = new PlotOptionsStreamgraphDataLabels();
			DataSorting = DataSorting_DefaultValue = new PlotOptionsStreamgraphDataSorting();
			Description = Description_DefaultValue = "";
			DragDrop = DragDrop_DefaultValue = new PlotOptionsStreamgraphDragDrop();
			...
			GapUnit = GapUnit_DefaultValue = PlotOptionsStreamgraphGapUnit.Relative;
			GetExtremesFromAll = GetExtremesFromAll_DefaultValue = false;
			IncludeInDataExport = IncludeInDataExport_DefaultValue = null;
			Keys = Keys_DefaultValue = new List<string>();
			Label = Label_DefaultValue = new PlotOptionsStreamgraphLabel();
			LastPrice = LastPrice_DefaultValue = new PlotOptionsStreamgraphLastPrice();
			LastVisiblePrice = LastVisiblePrice_DefaultValue = new PlotOptionsStreamgraphLastVisiblePrice();
			Linecap = Linecap_DefaultValue = PlotOptionsStreamgraphLinecap.Round;
			...
			PointIntervalUnit = PointIntervalUnit_DefaultValue = PlotOptionsStreamgraphPointIntervalUnit.Null;
			...
			States = States_DefaultValue = new PlotOptionsStreamgraphStates();
			Step = Step_DefaultValue = PlotOptionsStreamgraphStep.Null;
			StickyTracking = StickyTracking_DefaultValue = true;
			Threshold = Threshold_DefaultValue = 0;
			Tooltip = Tooltip_DefaultValue = new PlotOptionsStreamgraphTooltip();
			TrackByArea = TrackByArea_DefaultValue = false;
			TurboThreshold = TurboThreshold_DefaultValue = 1000;
			Visible = Visible_DefaultValue = true;
			ZoneAxis = ZoneAxis_DefaultValue = "y";
			Zones = Zones_DefaultValue = new List<PlotOptionsStreamgraphZone>();
		...
		/// </summary>
		public PlotOptionsStreamgraphAccessibility Accessibility { get; set; }
		private PlotOptionsStreamgraphAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphBoostBlending BoostBlending { get; set; }
		private PlotOptionsStreamgraphBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphCompareBase CompareBase { get; set; }
		private PlotOptionsStreamgraphCompareBase CompareBase_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphCursor Cursor { get; set; }
		private PlotOptionsStreamgraphCursor Cursor_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDashStyle DashStyle { get; set; }
		private PlotOptionsStreamgraphDashStyle DashStyle_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataGrouping DataGrouping { get; set; }
		private PlotOptionsStreamgraphDataGrouping DataGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataSorting DataSorting { get; set; }
		private PlotOptionsStreamgraphDataSorting DataSorting_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDragDrop DragDrop { get; set; }
		private PlotOptionsStreamgraphDragDrop DragDrop_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphFindNearestPointBy FindNearestPointBy { get; set; }
		private PlotOptionsStreamgraphFindNearestPointBy FindNearestPointBy_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphGapUnit GapUnit { get; set; }
		private PlotOptionsStreamgraphGapUnit GapUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphLastPrice LastPrice { get; set; }
		private PlotOptionsStreamgraphLastPrice LastPrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line marks the last price from visible range of points.
		/// </summary>
		public PlotOptionsStreamgraphLastVisiblePrice LastVisiblePrice { get; set; }
		private PlotOptionsStreamgraphLastVisiblePrice LastVisiblePrice_DefaultValue { get; set; }
		 

		/// <summary>
		/// The line cap used for line ends and line joins on the graph.
		/// </summary>
		public PlotOptionsStreamgraphLinecap Linecap { get; set; }
		private PlotOptionsStreamgraphLinecap Linecap_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphPointIntervalUnit PointIntervalUnit { get; set; }
		private PlotOptionsStreamgraphPointIntervalUnit PointIntervalUnit_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphStep Step { get; set; }
		private PlotOptionsStreamgraphStep Step_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsStreamgraphPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
