...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsStreamgraphDataLabels  : BaseObject
	{
		...
		public PlotOptionsStreamgraphDataLabels()
		{
			...
			Position = Position_DefaultValue = PlotOptionsStreamgraphDataLabelsPosition.Center;
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsStreamgraphDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphDataLabelsPosition Position { get; set; }
		private PlotOptionsStreamgraphDataLabelsPosition Position_DefaultValue { get; set; }
