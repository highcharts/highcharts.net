...
{
	public partial class PlotOptionsStreamgraphLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsStreamgraphLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsStreamgraphLastPriceLabelAlign Align { get; set; }
		private PlotOptionsStreamgraphLastPriceLabelAlign Align_DefaultValue { get; set; }
