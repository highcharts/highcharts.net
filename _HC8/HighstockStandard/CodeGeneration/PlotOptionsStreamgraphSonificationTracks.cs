...
{
	public partial class PlotOptionsStreamgraphSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsStreamgraphSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsStreamgraphSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsStreamgraphSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsStreamgraphSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsStreamgraphSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsStreamgraphSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsStreamgraphSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsStreamgraphSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsStreamgraphSonificationTracksType Type { get; set; }
		private PlotOptionsStreamgraphSonificationTracksType Type_DefaultValue { get; set; }
