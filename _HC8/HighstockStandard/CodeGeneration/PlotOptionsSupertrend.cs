...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrend  : BaseObject
	{
		...
		public PlotOptionsSupertrend()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsSupertrendDragDrop();
		...
		/// </summary>
		public PlotOptionsSupertrendDragDrop DragDrop { get; set; }
		private PlotOptionsSupertrendDragDrop DragDrop_DefaultValue { get; set; }
