...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsSupertrend  : BaseObject
	{
		...
		public PlotOptionsSupertrend()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsSupertrendDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (ChangeTrendLine.IsDirty()) h.Add("changeTrendLine",ChangeTrendLine.ToHashtable());
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsSupertrendPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
