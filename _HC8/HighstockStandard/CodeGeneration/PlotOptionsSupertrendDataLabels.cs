...
{
	public partial class PlotOptionsSupertrendDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsSupertrendDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsSupertrendDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsSupertrendDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsSupertrendDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsSupertrendDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsSupertrendDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsAlign Align { get; set; }
		private PlotOptionsSupertrendDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsFilter Filter { get; set; }
		private PlotOptionsSupertrendDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsSupertrendDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsPosition Position { get; set; }
		private PlotOptionsSupertrendDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsSupertrendDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsSupertrendDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
