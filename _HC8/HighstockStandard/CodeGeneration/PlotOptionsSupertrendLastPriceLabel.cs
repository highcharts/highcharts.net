...
{
	public partial class PlotOptionsSupertrendLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsSupertrendLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsSupertrendLastPriceLabelAlign Align { get; set; }
		private PlotOptionsSupertrendLastPriceLabelAlign Align_DefaultValue { get; set; }
