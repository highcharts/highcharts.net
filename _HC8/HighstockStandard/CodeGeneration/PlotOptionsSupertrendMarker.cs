...
{
	public partial class PlotOptionsSupertrendMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSupertrendMarkerStates();
		...
		/// </summary>
		public PlotOptionsSupertrendMarkerStates States { get; set; }
		private PlotOptionsSupertrendMarkerStates States_DefaultValue { get; set; }
