...
{
	public partial class PlotOptionsSupertrendOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsSupertrendOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsSupertrendOnPointPosition();
		...
		/// </summary>
		public PlotOptionsSupertrendOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsSupertrendOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendOnPointPosition Position { get; set; }
		private PlotOptionsSupertrendOnPointPosition Position_DefaultValue { get; set; }
