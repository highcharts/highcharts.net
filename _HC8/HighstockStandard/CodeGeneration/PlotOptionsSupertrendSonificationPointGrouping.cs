...
{
	public partial class PlotOptionsSupertrendSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsSupertrendSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsSupertrendSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsSupertrendSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
