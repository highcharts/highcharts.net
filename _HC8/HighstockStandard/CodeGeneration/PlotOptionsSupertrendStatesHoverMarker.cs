...
{
	public partial class PlotOptionsSupertrendStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSupertrendStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsSupertrendStatesHoverMarkerStates States { get; set; }
		private PlotOptionsSupertrendStatesHoverMarkerStates States_DefaultValue { get; set; }
