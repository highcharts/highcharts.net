...
{
	public partial class PlotOptionsSupertrendStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendStatesHoverMarkerStatesHoverAnimation()
		{
