...
{
	public partial class PlotOptionsSupertrendStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsSupertrendStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsSupertrendStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsSupertrendStatesSelectHalo Halo { get; set; }
		private PlotOptionsSupertrendStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsSupertrendStatesSelectMarker Marker { get; set; }
		private PlotOptionsSupertrendStatesSelectMarker Marker_DefaultValue { get; set; }
