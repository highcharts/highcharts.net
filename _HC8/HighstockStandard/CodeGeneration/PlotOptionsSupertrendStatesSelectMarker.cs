...
{
	public partial class PlotOptionsSupertrendStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSupertrendStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsSupertrendStatesSelectMarkerStates States { get; set; }
		private PlotOptionsSupertrendStatesSelectMarkerStates States_DefaultValue { get; set; }
