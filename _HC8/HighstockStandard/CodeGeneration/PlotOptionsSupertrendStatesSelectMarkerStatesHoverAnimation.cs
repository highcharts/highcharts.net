...
{
	public partial class PlotOptionsSupertrendStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsSupertrendStatesSelectMarkerStatesHoverAnimation()
		{
