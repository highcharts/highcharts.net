...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTema  : BaseObject
	{
		...
		public PlotOptionsTema()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsTemaDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsTemaPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
