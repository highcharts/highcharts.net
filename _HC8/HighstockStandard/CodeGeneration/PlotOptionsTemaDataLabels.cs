...
{
	public partial class PlotOptionsTemaDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsTemaDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsTemaDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsTemaDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsTemaDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsTemaDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTemaDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsAlign Align { get; set; }
		private PlotOptionsTemaDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsFilter Filter { get; set; }
		private PlotOptionsTemaDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsTemaDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsPosition Position { get; set; }
		private PlotOptionsTemaDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsTemaDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsTemaDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
