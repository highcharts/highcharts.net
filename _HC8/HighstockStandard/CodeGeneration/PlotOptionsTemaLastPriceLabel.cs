...
{
	public partial class PlotOptionsTemaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTemaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTemaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsTemaLastPriceLabelAlign Align_DefaultValue { get; set; }
