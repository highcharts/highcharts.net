...
{
	public partial class PlotOptionsTemaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTemaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTemaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsTemaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
