...
{
	public partial class PlotOptionsTemaMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTemaMarkerStates();
		...
		/// </summary>
		public PlotOptionsTemaMarkerStates States { get; set; }
		private PlotOptionsTemaMarkerStates States_DefaultValue { get; set; }
