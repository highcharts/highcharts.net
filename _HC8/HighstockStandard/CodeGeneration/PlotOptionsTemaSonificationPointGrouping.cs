...
{
	public partial class PlotOptionsTemaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTemaSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTemaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTemaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
