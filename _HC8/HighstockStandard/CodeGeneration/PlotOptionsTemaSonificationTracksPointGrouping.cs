...
{
	public partial class PlotOptionsTemaSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTemaSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTemaSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTemaSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
