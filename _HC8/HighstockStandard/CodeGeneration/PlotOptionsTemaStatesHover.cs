...
{
	public partial class PlotOptionsTemaStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTemaStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTemaStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsTemaStatesHoverHalo Halo { get; set; }
		private PlotOptionsTemaStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaStatesHoverMarker Marker { get; set; }
		private PlotOptionsTemaStatesHoverMarker Marker_DefaultValue { get; set; }
