...
{
	public partial class PlotOptionsTemaStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTemaStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTemaStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTemaStatesHoverMarkerStates States_DefaultValue { get; set; }
