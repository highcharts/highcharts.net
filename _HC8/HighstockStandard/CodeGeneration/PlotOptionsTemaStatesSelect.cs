...
{
	public partial class PlotOptionsTemaStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTemaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTemaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTemaStatesSelectHalo Halo { get; set; }
		private PlotOptionsTemaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTemaStatesSelectMarker Marker { get; set; }
		private PlotOptionsTemaStatesSelectMarker Marker_DefaultValue { get; set; }
