...
{
	public partial class PlotOptionsTemaStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTemaStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTemaStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTemaStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTemaStatesSelectMarkerStates States_DefaultValue { get; set; }
