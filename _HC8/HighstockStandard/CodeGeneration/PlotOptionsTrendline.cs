...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrendline  : BaseObject
	{
		...
		public PlotOptionsTrendline()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsTrendlineDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsTrendlinePointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
