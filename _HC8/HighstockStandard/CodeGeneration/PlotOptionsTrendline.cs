...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrendline  : BaseObject
	{
		...
		public PlotOptionsTrendline()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsTrendlineDragDrop();
		...
		/// </summary>
		public PlotOptionsTrendlineDragDrop DragDrop { get; set; }
		private PlotOptionsTrendlineDragDrop DragDrop_DefaultValue { get; set; }
