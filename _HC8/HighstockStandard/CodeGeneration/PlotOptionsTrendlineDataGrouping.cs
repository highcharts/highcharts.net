...
{
	public partial class PlotOptionsTrendlineDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsTrendlineDataGroupingApproximation.approximation", Approximation); }  
