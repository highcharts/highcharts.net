...
{
	public partial class PlotOptionsTrendlineDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsTrendlineDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsTrendlineDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsTrendlineDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsTrendlineDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsTrendlineDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTrendlineDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsAlign Align { get; set; }
		private PlotOptionsTrendlineDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsFilter Filter { get; set; }
		private PlotOptionsTrendlineDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsTrendlineDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsPosition Position { get; set; }
		private PlotOptionsTrendlineDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsTrendlineDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsTrendlineDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
