...
{
	public partial class PlotOptionsTrendlineLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("PlotOptionsTrendlineLabelFormatter.formatter", Formatter); }  
