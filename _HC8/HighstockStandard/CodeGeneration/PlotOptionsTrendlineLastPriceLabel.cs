...
{
	public partial class PlotOptionsTrendlineLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTrendlineLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTrendlineLastPriceLabelAlign Align { get; set; }
		private PlotOptionsTrendlineLastPriceLabelAlign Align_DefaultValue { get; set; }
