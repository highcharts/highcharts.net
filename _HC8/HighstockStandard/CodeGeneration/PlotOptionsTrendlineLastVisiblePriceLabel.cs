...
{
	public partial class PlotOptionsTrendlineLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTrendlineLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTrendlineLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsTrendlineLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
