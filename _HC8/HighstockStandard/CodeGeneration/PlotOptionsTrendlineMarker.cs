...
{
	public partial class PlotOptionsTrendlineMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrendlineMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrendlineMarkerStates States { get; set; }
		private PlotOptionsTrendlineMarkerStates States_DefaultValue { get; set; }
