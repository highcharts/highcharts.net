...
{
	public partial class PlotOptionsTrendlineSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTrendlineSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTrendlineSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTrendlineSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksType Type { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTrendlineSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
