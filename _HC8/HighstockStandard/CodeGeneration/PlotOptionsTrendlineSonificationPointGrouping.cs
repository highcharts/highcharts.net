...
{
	public partial class PlotOptionsTrendlineSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrendlineSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrendlineSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
