...
{
	public partial class PlotOptionsTrendlineSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTrendlineSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTrendlineSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTrendlineSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTrendlineSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTrendlineSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsTrendlineSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTrendlineSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksType Type { get; set; }
		private PlotOptionsTrendlineSonificationTracksType Type_DefaultValue { get; set; }
