...
{
	public partial class PlotOptionsTrendlineSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrendlineSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrendlineSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrendlineSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
