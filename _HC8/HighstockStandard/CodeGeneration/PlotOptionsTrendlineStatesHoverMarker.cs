...
{
	public partial class PlotOptionsTrendlineStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrendlineStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrendlineStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTrendlineStatesHoverMarkerStates States_DefaultValue { get; set; }
