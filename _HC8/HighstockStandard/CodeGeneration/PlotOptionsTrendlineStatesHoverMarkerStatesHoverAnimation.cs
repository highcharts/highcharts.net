...
{
	public partial class PlotOptionsTrendlineStatesHoverMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineStatesHoverMarkerStatesHoverAnimation()
		{
