...
{
	public partial class PlotOptionsTrendlineStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrendlineStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrendlineStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTrendlineStatesSelectMarkerStates States_DefaultValue { get; set; }
