...
{
	public partial class PlotOptionsTrendlineStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrendlineStatesSelectMarkerStatesHoverAnimation()
		{
