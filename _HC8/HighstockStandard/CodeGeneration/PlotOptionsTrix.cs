...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrix  : BaseObject
	{
		...
		public PlotOptionsTrix()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsTrixDragDrop();
		...
		/// </summary>
		public PlotOptionsTrixDragDrop DragDrop { get; set; }
		private PlotOptionsTrixDragDrop DragDrop_DefaultValue { get; set; }
