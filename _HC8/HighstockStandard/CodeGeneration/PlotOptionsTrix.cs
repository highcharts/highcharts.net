...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrix  : BaseObject
	{
		...
		public PlotOptionsTrix()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsTrixDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsTrixPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
