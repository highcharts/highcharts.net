...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsTrixDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsTrixDataGroupingApproximation.approximation", Approximation); }  
