...
{
	public partial class PlotOptionsTrixDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsTrixDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsTrixDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsTrixDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsTrixDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsTrixDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsTrixDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsAlign Align { get; set; }
		private PlotOptionsTrixDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsFilter Filter { get; set; }
		private PlotOptionsTrixDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsTrixDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsPosition Position { get; set; }
		private PlotOptionsTrixDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsTrixDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsTrixDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
