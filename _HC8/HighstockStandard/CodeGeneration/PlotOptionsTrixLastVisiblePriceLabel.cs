...
{
	public partial class PlotOptionsTrixLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsTrixLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsTrixLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsTrixLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
