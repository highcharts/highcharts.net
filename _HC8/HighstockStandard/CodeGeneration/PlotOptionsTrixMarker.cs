...
{
	public partial class PlotOptionsTrixMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrixMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrixMarkerStates States { get; set; }
		private PlotOptionsTrixMarkerStates States_DefaultValue { get; set; }
