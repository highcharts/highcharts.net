...
{
	public partial class PlotOptionsTrixOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsTrixOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsTrixOnPointPosition();
		...
		/// </summary>
		public PlotOptionsTrixOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsTrixOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixOnPointPosition Position { get; set; }
		private PlotOptionsTrixOnPointPosition Position_DefaultValue { get; set; }
