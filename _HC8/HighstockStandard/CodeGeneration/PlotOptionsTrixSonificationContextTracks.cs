...
{
	public partial class PlotOptionsTrixSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTrixSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsTrixSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTrixSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsTrixSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsTrixSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTrixSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsTrixSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsTrixSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksType Type { get; set; }
		private PlotOptionsTrixSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsTrixSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
