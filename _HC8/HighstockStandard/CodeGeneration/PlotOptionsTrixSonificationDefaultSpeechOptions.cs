...
{
	public partial class PlotOptionsTrixSonificationDefaultSpeechOptions  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationDefaultSpeechOptions()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsTrixSonificationDefaultSpeechOptionsActiveWhen();
			Language = Language_DefaultValue = "en-US";
			Mapping = Mapping_DefaultValue = new PlotOptionsTrixSonificationDefaultSpeechOptionsMapping();
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsTrixSonificationDefaultSpeechOptionsPointGrouping();
			PreferredVoice = PreferredVoice_DefaultValue = "";
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsTrixSonificationDefaultSpeechOptionsType.Instrument;
		...
		/// </summary>
		public PlotOptionsTrixSonificationDefaultSpeechOptionsActiveWhen ActiveWhen { get; set; }
		private PlotOptionsTrixSonificationDefaultSpeechOptionsActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationDefaultSpeechOptionsMapping Mapping { get; set; }
		private PlotOptionsTrixSonificationDefaultSpeechOptionsMapping Mapping_DefaultValue { get; set; }
		 

		/// <summary>
		/// Options for point grouping, specifically for instrument tracks.
		/// </summary>
		public PlotOptionsTrixSonificationDefaultSpeechOptionsPointGrouping PointGrouping { get; set; }
		private PlotOptionsTrixSonificationDefaultSpeechOptionsPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixSonificationDefaultSpeechOptionsType Type { get; set; }
		private PlotOptionsTrixSonificationDefaultSpeechOptionsType Type_DefaultValue { get; set; }
