...
{
	public partial class PlotOptionsTrixSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrixSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrixSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrixSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
