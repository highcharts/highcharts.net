...
{
	public partial class PlotOptionsTrixSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrixSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrixSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrixSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
