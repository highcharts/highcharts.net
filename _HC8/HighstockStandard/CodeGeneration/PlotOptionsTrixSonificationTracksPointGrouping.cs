...
{
	public partial class PlotOptionsTrixSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsTrixSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsTrixSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsTrixSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
