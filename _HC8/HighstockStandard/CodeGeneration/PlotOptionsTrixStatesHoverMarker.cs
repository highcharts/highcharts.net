...
{
	public partial class PlotOptionsTrixStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrixStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrixStatesHoverMarkerStates States { get; set; }
		private PlotOptionsTrixStatesHoverMarkerStates States_DefaultValue { get; set; }
