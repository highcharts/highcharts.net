...
{
	public partial class PlotOptionsTrixStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsTrixStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsTrixStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsTrixStatesSelectHalo Halo { get; set; }
		private PlotOptionsTrixStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsTrixStatesSelectMarker Marker { get; set; }
		private PlotOptionsTrixStatesSelectMarker Marker_DefaultValue { get; set; }
