...
{
	public partial class PlotOptionsTrixStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsTrixStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsTrixStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsTrixStatesSelectMarkerStates States { get; set; }
		private PlotOptionsTrixStatesSelectMarkerStates States_DefaultValue { get; set; }
