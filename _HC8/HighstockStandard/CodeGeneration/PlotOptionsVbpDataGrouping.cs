...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVbpDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsVbpDataGroupingApproximation.approximation", Approximation); }  
