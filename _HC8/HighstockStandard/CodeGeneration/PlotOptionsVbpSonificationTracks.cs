...
{
	public partial class PlotOptionsVbpSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVbpSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVbpSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVbpSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsVbpSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVbpSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsVbpSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVbpSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpSonificationTracksType Type { get; set; }
		private PlotOptionsVbpSonificationTracksType Type_DefaultValue { get; set; }
