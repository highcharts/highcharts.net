...
{
	public partial class PlotOptionsVbpStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsVbpStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsVbpStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsVbpStatesHoverHalo Halo { get; set; }
		private PlotOptionsVbpStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpStatesHoverMarker Marker { get; set; }
		private PlotOptionsVbpStatesHoverMarker Marker_DefaultValue { get; set; }
