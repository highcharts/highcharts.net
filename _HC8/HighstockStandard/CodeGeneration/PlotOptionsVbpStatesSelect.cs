...
{
	public partial class PlotOptionsVbpStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsVbpStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsVbpStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsVbpStatesSelectHalo Halo { get; set; }
		private PlotOptionsVbpStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVbpStatesSelectMarker Marker { get; set; }
		private PlotOptionsVbpStatesSelectMarker Marker_DefaultValue { get; set; }
