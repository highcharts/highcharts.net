...
{
	public partial class PlotOptionsVbpStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVbpStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVbpStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsVbpStatesSelectMarkerStates States { get; set; }
		private PlotOptionsVbpStatesSelectMarkerStates States_DefaultValue { get; set; }
