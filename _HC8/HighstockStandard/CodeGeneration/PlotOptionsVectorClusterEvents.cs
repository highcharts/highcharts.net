...
{
	public partial class PlotOptionsVectorClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("PlotOptionsVectorClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
