...
{
	public partial class PlotOptionsVectorClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVectorClusterZonesMarkerStates();
		...
		/// </summary>
		public PlotOptionsVectorClusterZonesMarkerStates States { get; set; }
		private PlotOptionsVectorClusterZonesMarkerStates States_DefaultValue { get; set; }
