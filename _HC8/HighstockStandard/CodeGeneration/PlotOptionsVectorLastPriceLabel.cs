...
{
	public partial class PlotOptionsVectorLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsVectorLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsVectorLastPriceLabelAlign Align { get; set; }
		private PlotOptionsVectorLastPriceLabelAlign Align_DefaultValue { get; set; }
