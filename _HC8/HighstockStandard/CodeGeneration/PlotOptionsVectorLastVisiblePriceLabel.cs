...
{
	public partial class PlotOptionsVectorLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsVectorLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsVectorLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsVectorLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
