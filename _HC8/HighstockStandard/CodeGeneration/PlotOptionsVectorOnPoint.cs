...
{
	public partial class PlotOptionsVectorOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsVectorOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsVectorOnPointPosition();
		...
		/// </summary>
		public PlotOptionsVectorOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsVectorOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorOnPointPosition Position { get; set; }
		private PlotOptionsVectorOnPointPosition Position_DefaultValue { get; set; }
