...
{
	public partial class PlotOptionsVectorSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVectorSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsVectorSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsVectorSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsVectorSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsVectorSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsVectorSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsVectorSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsVectorSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsVectorSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksType Type { get; set; }
		private PlotOptionsVectorSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVectorSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsVectorSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
