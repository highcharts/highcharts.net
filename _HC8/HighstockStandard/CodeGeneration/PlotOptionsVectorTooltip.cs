...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVectorTooltip  : BaseObject
	{
		...
		public PlotOptionsVectorTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = PlotOptionsVectorTooltipHeaderShape.Callout;
		...
		/// </summary>
		public PlotOptionsVectorTooltipHeaderShape HeaderShape { get; set; }
		private PlotOptionsVectorTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
