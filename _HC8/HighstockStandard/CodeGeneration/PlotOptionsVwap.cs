...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwap  : BaseObject
	{
		...
		public PlotOptionsVwap()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsVwapDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsVwapPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
