...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsVwap  : BaseObject
	{
		...
		public PlotOptionsVwap()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsVwapDragDrop();
		...
		/// </summary>
		public PlotOptionsVwapDragDrop DragDrop { get; set; }
		private PlotOptionsVwapDragDrop DragDrop_DefaultValue { get; set; }
