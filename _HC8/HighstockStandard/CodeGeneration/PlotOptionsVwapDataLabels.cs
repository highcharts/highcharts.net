...
{
	public partial class PlotOptionsVwapDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsVwapDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsVwapDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsVwapDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsVwapDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsVwapDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsVwapDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsAlign Align { get; set; }
		private PlotOptionsVwapDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsFilter Filter { get; set; }
		private PlotOptionsVwapDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsVwapDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsPosition Position { get; set; }
		private PlotOptionsVwapDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsVwapDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsVwapDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
