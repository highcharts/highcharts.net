...
{
	public partial class PlotOptionsVwapLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsVwapLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsVwapLastPriceLabelAlign Align { get; set; }
		private PlotOptionsVwapLastPriceLabelAlign Align_DefaultValue { get; set; }
