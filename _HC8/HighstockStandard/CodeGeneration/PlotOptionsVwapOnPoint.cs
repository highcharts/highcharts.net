...
{
	public partial class PlotOptionsVwapOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsVwapOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsVwapOnPointPosition();
		...
		/// </summary>
		public PlotOptionsVwapOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsVwapOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapOnPointPosition Position { get; set; }
		private PlotOptionsVwapOnPointPosition Position_DefaultValue { get; set; }
