...
{
	public partial class PlotOptionsVwapStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVwapStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsVwapStatesHoverMarkerStates States { get; set; }
		private PlotOptionsVwapStatesHoverMarkerStates States_DefaultValue { get; set; }
