...
{
	public partial class PlotOptionsVwapStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PlotOptionsVwapStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PlotOptionsVwapStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsVwapStatesSelectHalo Halo { get; set; }
		private PlotOptionsVwapStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsVwapStatesSelectMarker Marker { get; set; }
		private PlotOptionsVwapStatesSelectMarker Marker_DefaultValue { get; set; }
