...
{
	public partial class PlotOptionsVwapStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsVwapStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsVwapStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsVwapStatesSelectMarkerStates States { get; set; }
		private PlotOptionsVwapStatesSelectMarkerStates States_DefaultValue { get; set; }
