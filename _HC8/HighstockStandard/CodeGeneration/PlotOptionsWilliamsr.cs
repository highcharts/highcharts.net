...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWilliamsr  : BaseObject
	{
		...
		public PlotOptionsWilliamsr()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsWilliamsrDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsWilliamsrPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
