...
{
	public partial class PlotOptionsWilliamsrLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsWilliamsrLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsWilliamsrLastPriceLabelAlign Align { get; set; }
		private PlotOptionsWilliamsrLastPriceLabelAlign Align_DefaultValue { get; set; }
