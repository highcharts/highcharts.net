...
{
	public partial class PlotOptionsWilliamsrMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWilliamsrMarkerStates();
		...
		/// </summary>
		public PlotOptionsWilliamsrMarkerStates States { get; set; }
		private PlotOptionsWilliamsrMarkerStates States_DefaultValue { get; set; }
