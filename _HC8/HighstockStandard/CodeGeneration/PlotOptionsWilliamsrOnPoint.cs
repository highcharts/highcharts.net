...
{
	public partial class PlotOptionsWilliamsrOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsWilliamsrOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsWilliamsrOnPointPosition();
		...
		/// </summary>
		public PlotOptionsWilliamsrOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsWilliamsrOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrOnPointPosition Position { get; set; }
		private PlotOptionsWilliamsrOnPointPosition Position_DefaultValue { get; set; }
