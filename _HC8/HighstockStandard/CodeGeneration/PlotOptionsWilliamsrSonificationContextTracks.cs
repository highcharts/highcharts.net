...
{
	public partial class PlotOptionsWilliamsrSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWilliamsrSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsWilliamsrSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsWilliamsrSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksType Type { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsWilliamsrSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
