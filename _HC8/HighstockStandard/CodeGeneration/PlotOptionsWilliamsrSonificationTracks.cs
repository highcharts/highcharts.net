...
{
	public partial class PlotOptionsWilliamsrSonificationTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrSonificationTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWilliamsrSonificationTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWilliamsrSonificationTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWilliamsrSonificationTracksPointGrouping();
			RoundToMusicalNotes = RoundToMusicalNotes_DefaultValue = true;
			ShowPlayMarker = ShowPlayMarker_DefaultValue = true;
			Type = Type_DefaultValue = PlotOptionsWilliamsrSonificationTracksType.Instrument;
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWilliamsrSonificationTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksMapping Mapping { get; set; }
		private PlotOptionsWilliamsrSonificationTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWilliamsrSonificationTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrSonificationTracksType Type { get; set; }
		private PlotOptionsWilliamsrSonificationTracksType Type_DefaultValue { get; set; }
