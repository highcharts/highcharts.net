...
{
	public partial class PlotOptionsWilliamsrStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWilliamsrStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWilliamsrStatesHoverMarker();
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesHoverHalo Halo { get; set; }
		private PlotOptionsWilliamsrStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesHoverMarker Marker { get; set; }
		private PlotOptionsWilliamsrStatesHoverMarker Marker_DefaultValue { get; set; }
