...
{
	public partial class PlotOptionsWilliamsrStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWilliamsrStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesHoverMarkerStates States { get; set; }
		private PlotOptionsWilliamsrStatesHoverMarkerStates States_DefaultValue { get; set; }
