...
{
	public partial class PlotOptionsWilliamsrStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWilliamsrStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWilliamsrStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesSelectHalo Halo { get; set; }
		private PlotOptionsWilliamsrStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesSelectMarker Marker { get; set; }
		private PlotOptionsWilliamsrStatesSelectMarker Marker_DefaultValue { get; set; }
