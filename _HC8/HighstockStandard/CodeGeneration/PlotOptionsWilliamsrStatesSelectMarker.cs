...
{
	public partial class PlotOptionsWilliamsrStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWilliamsrStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsWilliamsrStatesSelectMarkerStates States { get; set; }
		private PlotOptionsWilliamsrStatesSelectMarkerStates States_DefaultValue { get; set; }
