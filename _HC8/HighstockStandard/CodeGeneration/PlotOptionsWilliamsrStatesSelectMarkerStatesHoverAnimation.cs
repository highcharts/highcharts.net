...
{
	public partial class PlotOptionsWilliamsrStatesSelectMarkerStatesHoverAnimation  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWilliamsrStatesSelectMarkerStatesHoverAnimation()
		{
