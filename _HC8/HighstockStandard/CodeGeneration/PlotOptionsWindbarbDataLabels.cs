...
{
	public partial class PlotOptionsWindbarbDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsWindbarbDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsWindbarbDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsWindbarbDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsWindbarbDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsWindbarbDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsWindbarbDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsAlign Align { get; set; }
		private PlotOptionsWindbarbDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsFilter Filter { get; set; }
		private PlotOptionsWindbarbDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsWindbarbDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsPosition Position { get; set; }
		private PlotOptionsWindbarbDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsWindbarbDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsWindbarbDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
