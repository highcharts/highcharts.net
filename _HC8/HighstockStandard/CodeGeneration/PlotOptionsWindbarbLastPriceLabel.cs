...
{
	public partial class PlotOptionsWindbarbLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsWindbarbLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsWindbarbLastPriceLabelAlign Align { get; set; }
		private PlotOptionsWindbarbLastPriceLabelAlign Align_DefaultValue { get; set; }
