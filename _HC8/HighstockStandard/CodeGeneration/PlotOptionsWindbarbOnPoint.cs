...
{
	public partial class PlotOptionsWindbarbOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWindbarbOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsWindbarbOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsWindbarbOnPointPosition();
		...
		/// </summary>
		public PlotOptionsWindbarbOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsWindbarbOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWindbarbOnPointPosition Position { get; set; }
		private PlotOptionsWindbarbOnPointPosition Position_DefaultValue { get; set; }
