...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWma  : BaseObject
	{
		...
		public PlotOptionsWma()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsWmaDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsWmaPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
