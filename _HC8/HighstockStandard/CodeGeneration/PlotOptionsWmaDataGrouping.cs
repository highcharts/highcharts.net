...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsWmaDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsWmaDataGroupingApproximation.approximation", Approximation); }  
