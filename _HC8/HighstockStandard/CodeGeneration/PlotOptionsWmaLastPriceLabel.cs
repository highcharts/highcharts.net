...
{
	public partial class PlotOptionsWmaLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsWmaLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsWmaLastPriceLabelAlign Align { get; set; }
		private PlotOptionsWmaLastPriceLabelAlign Align_DefaultValue { get; set; }
