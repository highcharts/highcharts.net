...
{
	public partial class PlotOptionsWmaLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsWmaLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsWmaLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsWmaLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
