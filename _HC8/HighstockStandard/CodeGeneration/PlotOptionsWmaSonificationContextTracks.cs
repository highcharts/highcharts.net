...
{
	public partial class PlotOptionsWmaSonificationContextTracks  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationContextTracks()
		{
			ActiveWhen = ActiveWhen_DefaultValue = new PlotOptionsWmaSonificationContextTracksActiveWhen();
			Instrument = Instrument_DefaultValue = null;
			InstrumentString = InstrumentString_DefaultValue = "null";
			Mapping = Mapping_DefaultValue = new PlotOptionsWmaSonificationContextTracksMapping();
			MidiName = MidiName_DefaultValue = "";
			PointGrouping = PointGrouping_DefaultValue = new PlotOptionsWmaSonificationContextTracksPointGrouping();
			...
			Type = Type_DefaultValue = PlotOptionsWmaSonificationContextTracksType.Instrument;
			ValueInterval = ValueInterval_DefaultValue = null;
			ValueMapFunction = ValueMapFunction_DefaultValue = PlotOptionsWmaSonificationContextTracksValueMapFunction.Linear;
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksActiveWhen ActiveWhen { get; set; }
		private PlotOptionsWmaSonificationContextTracksActiveWhen ActiveWhen_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksMapping Mapping { get; set; }
		private PlotOptionsWmaSonificationContextTracksMapping Mapping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksPointGrouping PointGrouping { get; set; }
		private PlotOptionsWmaSonificationContextTracksPointGrouping PointGrouping_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksType Type { get; set; }
		private PlotOptionsWmaSonificationContextTracksType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaSonificationContextTracksValueMapFunction ValueMapFunction { get; set; }
		private PlotOptionsWmaSonificationContextTracksValueMapFunction ValueMapFunction_DefaultValue { get; set; }
