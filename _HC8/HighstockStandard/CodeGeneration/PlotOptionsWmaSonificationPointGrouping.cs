...
{
	public partial class PlotOptionsWmaSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsWmaSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsWmaSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsWmaSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
