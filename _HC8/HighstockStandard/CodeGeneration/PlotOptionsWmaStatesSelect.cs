...
{
	public partial class PlotOptionsWmaStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsWmaStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsWmaStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsWmaStatesSelectHalo Halo { get; set; }
		private PlotOptionsWmaStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsWmaStatesSelectMarker Marker { get; set; }
		private PlotOptionsWmaStatesSelectMarker Marker_DefaultValue { get; set; }
