...
{
	public partial class PlotOptionsWmaStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsWmaStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsWmaStatesSelectMarkerStates();
		...
		/// </summary>
		public PlotOptionsWmaStatesSelectMarkerStates States { get; set; }
		private PlotOptionsWmaStatesSelectMarkerStates States_DefaultValue { get; set; }
