...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsXrangeDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PlotOptionsXrangeDataGroupingApproximation.approximation", Approximation); }  
