...
{
	public partial class PlotOptionsXrangeDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new PlotOptionsXrangeDragDropGuideBox();
		...
		/// </summary>
		public bool? DraggableX1 { get; set; }
		private bool? DraggableX1_DefaultValue { get; set; }
		 

		/// <summary>
		/// Allow x2 value to be dragged individually.
		/// </summary>
		public bool? DraggableX2 { get; set; }
		private bool? DraggableX2_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsXrangeDragDropGuideBox GuideBox { get; set; }
		private PlotOptionsXrangeDragDropGuideBox GuideBox_DefaultValue { get; set; }
