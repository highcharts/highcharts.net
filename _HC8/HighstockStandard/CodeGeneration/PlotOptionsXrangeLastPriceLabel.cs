...
{
	public partial class PlotOptionsXrangeLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsXrangeLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsXrangeLastPriceLabelAlign Align { get; set; }
		private PlotOptionsXrangeLastPriceLabelAlign Align_DefaultValue { get; set; }
