...
{
	public partial class PlotOptionsXrangeLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsXrangeLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsXrangeLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsXrangeLastVisiblePriceLabelAlign Align { get; set; }
		private PlotOptionsXrangeLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
