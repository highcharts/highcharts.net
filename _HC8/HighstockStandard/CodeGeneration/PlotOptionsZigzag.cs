...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzag  : BaseObject
	{
		...
		public PlotOptionsZigzag()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PlotOptionsZigzagDragDrop();
		...
		/// </summary>
		public PlotOptionsZigzagDragDrop DragDrop { get; set; }
		private PlotOptionsZigzagDragDrop DragDrop_DefaultValue { get; set; }
