...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PlotOptionsZigzag  : BaseObject
	{
		...
		public PlotOptionsZigzag()
		{
			...
			DashStyle = DashStyle_DefaultValue = PlotOptionsZigzagDashStyle.Solid;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PlotOptionsZigzagPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
