...
{
	public partial class PlotOptionsZigzagDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagDataLabels()
		{
			Align = Align_DefaultValue = PlotOptionsZigzagDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PlotOptionsZigzagDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PlotOptionsZigzagDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PlotOptionsZigzagDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PlotOptionsZigzagDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PlotOptionsZigzagDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsAlign Align { get; set; }
		private PlotOptionsZigzagDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsFilter Filter { get; set; }
		private PlotOptionsZigzagDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsOverflow Overflow { get; set; }
		private PlotOptionsZigzagDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsPosition Position { get; set; }
		private PlotOptionsZigzagDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsTextPath TextPath { get; set; }
		private PlotOptionsZigzagDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PlotOptionsZigzagDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
