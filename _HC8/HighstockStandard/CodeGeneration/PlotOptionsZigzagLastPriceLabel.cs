...
{
	public partial class PlotOptionsZigzagLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagLastPriceLabel()
		{
			Align = Align_DefaultValue = PlotOptionsZigzagLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PlotOptionsZigzagLastPriceLabelAlign Align { get; set; }
		private PlotOptionsZigzagLastPriceLabelAlign Align_DefaultValue { get; set; }
