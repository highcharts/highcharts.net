...
{
	public partial class PlotOptionsZigzagOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PlotOptionsZigzagOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PlotOptionsZigzagOnPointPosition();
		...
		/// </summary>
		public PlotOptionsZigzagOnPointConnectorOptions ConnectorOptions { get; set; }
		private PlotOptionsZigzagOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagOnPointPosition Position { get; set; }
		private PlotOptionsZigzagOnPointPosition Position_DefaultValue { get; set; }
