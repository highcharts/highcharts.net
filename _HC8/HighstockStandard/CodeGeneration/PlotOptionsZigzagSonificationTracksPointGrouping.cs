...
{
	public partial class PlotOptionsZigzagSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PlotOptionsZigzagSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PlotOptionsZigzagSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private PlotOptionsZigzagSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
