...
{
	public partial class PlotOptionsZigzagStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsZigzagStatesHoverMarkerStates();
		...
		/// </summary>
		public PlotOptionsZigzagStatesHoverMarkerStates States { get; set; }
		private PlotOptionsZigzagStatesHoverMarkerStates States_DefaultValue { get; set; }
