...
{
	public partial class PlotOptionsZigzagStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PlotOptionsZigzagStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PlotOptionsZigzagStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PlotOptionsZigzagStatesSelectMarker();
		...
		/// </summary>
		public PlotOptionsZigzagStatesSelectHalo Halo { get; set; }
		private PlotOptionsZigzagStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsZigzagStatesSelectMarker Marker { get; set; }
		private PlotOptionsZigzagStatesSelectMarker Marker_DefaultValue { get; set; }
