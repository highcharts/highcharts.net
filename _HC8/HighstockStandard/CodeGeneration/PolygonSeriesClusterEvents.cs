...
{
	public partial class PolygonSeriesClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("PolygonSeriesClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
