...
{
	public partial class PolygonSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new PolygonSeriesClusterMarkerStates();
		...
		/// </summary>
		public PolygonSeriesClusterMarkerStates States { get; set; }
		private PolygonSeriesClusterMarkerStates States_DefaultValue { get; set; }
