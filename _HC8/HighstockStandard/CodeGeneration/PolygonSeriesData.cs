...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PolygonSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new PolygonSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new PolygonSeriesDataDragDrop();
			Drilldown = Drilldown_DefaultValue = "";
			Events = Events_DefaultValue = new PolygonSeriesDataEvents();
			Id = Id_DefaultValue = "";
			Labelrank = Labelrank_DefaultValue = null;
			Marker = Marker_DefaultValue = new PolygonSeriesDataMarker();
		...
		private PolygonSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		private PolygonSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
