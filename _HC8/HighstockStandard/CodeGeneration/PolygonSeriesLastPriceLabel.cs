...
{
	public partial class PolygonSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PolygonSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PolygonSeriesLastPriceLabelAlign Align { get; set; }
		private PolygonSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
