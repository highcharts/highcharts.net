...
{
	public partial class PolygonSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PolygonSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PolygonSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PolygonSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PolygonSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
