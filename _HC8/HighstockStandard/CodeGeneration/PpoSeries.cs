...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PpoSeries  : Series
	{
		...
		public PpoSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PpoSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = PpoSeriesType.Ppo;
		...
		/// </summary>
		public PpoSeriesType Type { get; set; }
		private PpoSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PpoSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
