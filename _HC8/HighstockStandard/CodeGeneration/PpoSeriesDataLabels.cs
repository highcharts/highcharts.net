...
{
	public partial class PpoSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesDataLabels()
		{
			Align = Align_DefaultValue = PpoSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PpoSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PpoSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PpoSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PpoSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PpoSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PpoSeriesDataLabelsAlign Align { get; set; }
		private PpoSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDataLabelsFilter Filter { get; set; }
		private PpoSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDataLabelsOverflow Overflow { get; set; }
		private PpoSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDataLabelsPosition Position { get; set; }
		private PpoSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDataLabelsTextPath TextPath { get; set; }
		private PpoSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PpoSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
