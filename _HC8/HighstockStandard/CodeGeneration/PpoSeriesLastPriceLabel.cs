...
{
	public partial class PpoSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PpoSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PpoSeriesLastPriceLabelAlign Align { get; set; }
		private PpoSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
