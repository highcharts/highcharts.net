...
{
	public partial class PpoSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PpoSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PpoSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PpoSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
