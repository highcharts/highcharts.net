...
{
	public partial class PpoSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PpoSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PpoSeriesOnPointPosition();
		...
		/// </summary>
		public PpoSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PpoSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesOnPointPosition Position { get; set; }
		private PpoSeriesOnPointPosition Position_DefaultValue { get; set; }
