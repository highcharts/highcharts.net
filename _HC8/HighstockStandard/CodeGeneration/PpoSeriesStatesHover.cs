...
{
	public partial class PpoSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new PpoSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new PpoSeriesStatesHoverMarker();
		...
		/// </summary>
		public PpoSeriesStatesHoverHalo Halo { get; set; }
		private PpoSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesStatesHoverMarker Marker { get; set; }
		private PpoSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
