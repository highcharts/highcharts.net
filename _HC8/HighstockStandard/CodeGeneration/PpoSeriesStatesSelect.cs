...
{
	public partial class PpoSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PpoSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PpoSeriesStatesSelectMarker();
		...
		/// </summary>
		public PpoSeriesStatesSelectHalo Halo { get; set; }
		private PpoSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PpoSeriesStatesSelectMarker Marker { get; set; }
		private PpoSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
