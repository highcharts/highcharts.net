...
{
	public partial class PpoSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PpoSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PpoSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PpoSeriesStatesSelectMarkerStates States { get; set; }
		private PpoSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
