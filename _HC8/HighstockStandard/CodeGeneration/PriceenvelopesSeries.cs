...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		...
		public PriceenvelopesSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new PriceenvelopesSeriesDragDrop();
		...
		/// </summary>
		public PriceenvelopesSeriesDragDrop DragDrop { get; set; }
		private PriceenvelopesSeriesDragDrop DragDrop_DefaultValue { get; set; }
