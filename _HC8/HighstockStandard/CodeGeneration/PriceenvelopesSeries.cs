...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		...
		public PriceenvelopesSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PriceenvelopesSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = PriceenvelopesSeriesType.Priceenvelopes;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PriceenvelopesSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
