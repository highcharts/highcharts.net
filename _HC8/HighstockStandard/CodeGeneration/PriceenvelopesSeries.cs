...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeries  : Series
	{
		...
		public PriceenvelopesSeries()
		{
			...
			Type = Type_DefaultValue = PriceenvelopesSeriesType.Null;
		...
		/// </summary>
		public PriceenvelopesSeriesType Type { get; set; }
		private PriceenvelopesSeriesType Type_DefaultValue { get; set; }
