...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PriceenvelopesSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("PriceenvelopesSeriesDataGroupingApproximation.approximation", Approximation); }  
