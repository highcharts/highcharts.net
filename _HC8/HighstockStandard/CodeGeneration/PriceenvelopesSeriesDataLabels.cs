...
{
	public partial class PriceenvelopesSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesDataLabels()
		{
			Align = Align_DefaultValue = PriceenvelopesSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PriceenvelopesSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PriceenvelopesSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PriceenvelopesSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PriceenvelopesSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PriceenvelopesSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsAlign Align { get; set; }
		private PriceenvelopesSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsFilter Filter { get; set; }
		private PriceenvelopesSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsOverflow Overflow { get; set; }
		private PriceenvelopesSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsPosition Position { get; set; }
		private PriceenvelopesSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsTextPath TextPath { get; set; }
		private PriceenvelopesSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PriceenvelopesSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
