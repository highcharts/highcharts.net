...
{
	public partial class PriceenvelopesSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PriceenvelopesSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesLastPriceLabelAlign Align { get; set; }
		private PriceenvelopesSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
