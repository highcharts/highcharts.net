...
{
	public partial class PriceenvelopesSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = PriceenvelopesSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PriceenvelopesSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private PriceenvelopesSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
