...
{
	public partial class PriceenvelopesSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesMarker()
		{
			...
			States = States_DefaultValue = new PriceenvelopesSeriesMarkerStates();
		...
		/// </summary>
		public PriceenvelopesSeriesMarkerStates States { get; set; }
		private PriceenvelopesSeriesMarkerStates States_DefaultValue { get; set; }
