...
{
	public partial class PriceenvelopesSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PriceenvelopesSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PriceenvelopesSeriesStatesHoverMarker();
		...
		/// </summary>
		public PriceenvelopesSeriesStatesHoverHalo Halo { get; set; }
		private PriceenvelopesSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesStatesHoverMarker Marker { get; set; }
		private PriceenvelopesSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
