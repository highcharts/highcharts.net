...
{
	public partial class PriceenvelopesSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PriceenvelopesSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new PriceenvelopesSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new PriceenvelopesSeriesStatesSelectMarker();
		...
		/// </summary>
		public PriceenvelopesSeriesStatesSelectHalo Halo { get; set; }
		private PriceenvelopesSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PriceenvelopesSeriesStatesSelectMarker Marker { get; set; }
		private PriceenvelopesSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
