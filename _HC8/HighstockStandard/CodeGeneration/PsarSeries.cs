...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class PsarSeries  : Series
	{
		...
		public PsarSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = PsarSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = PsarSeriesType.Psar;
		...
		/// </summary>
		public PsarSeriesType Type { get; set; }
		private PsarSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("PsarSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
