...
{
	public partial class PsarSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesDataLabels()
		{
			Align = Align_DefaultValue = PsarSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new PsarSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = PsarSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = PsarSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new PsarSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = PsarSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public PsarSeriesDataLabelsAlign Align { get; set; }
		private PsarSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataLabelsFilter Filter { get; set; }
		private PsarSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataLabelsOverflow Overflow { get; set; }
		private PsarSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataLabelsPosition Position { get; set; }
		private PsarSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataLabelsTextPath TextPath { get; set; }
		private PsarSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private PsarSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
