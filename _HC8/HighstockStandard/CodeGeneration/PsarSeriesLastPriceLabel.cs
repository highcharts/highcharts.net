...
{
	public partial class PsarSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = PsarSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public PsarSeriesLastPriceLabelAlign Align { get; set; }
		private PsarSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
