...
{
	public partial class PsarSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new PsarSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new PsarSeriesOnPointPosition();
		...
		/// </summary>
		public PsarSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private PsarSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesOnPointPosition Position { get; set; }
		private PsarSeriesOnPointPosition Position_DefaultValue { get; set; }
