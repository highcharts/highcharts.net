...
{
	public partial class PsarSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = PsarSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public PsarSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private PsarSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
