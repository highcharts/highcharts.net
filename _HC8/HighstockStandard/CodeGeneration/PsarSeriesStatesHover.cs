...
{
	public partial class PsarSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PsarSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PsarSeriesStatesHoverMarker();
		...
		/// </summary>
		public PsarSeriesStatesHoverHalo Halo { get; set; }
		private PsarSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesStatesHoverMarker Marker { get; set; }
		private PsarSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
