...
{
	public partial class PsarSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new PsarSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new PsarSeriesStatesSelectMarker();
		...
		/// </summary>
		public PsarSeriesStatesSelectHalo Halo { get; set; }
		private PsarSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public PsarSeriesStatesSelectMarker Marker { get; set; }
		private PsarSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
