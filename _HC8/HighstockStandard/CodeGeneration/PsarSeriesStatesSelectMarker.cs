...
{
	public partial class PsarSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public PsarSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new PsarSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public PsarSeriesStatesSelectMarkerStates States { get; set; }
		private PsarSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
