...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RocSeries  : Series
	{
		...
		public RocSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = RocSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = RocSeriesType.Roc;
		...
		/// </summary>
		public RocSeriesType Type { get; set; }
		private RocSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("RocSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
