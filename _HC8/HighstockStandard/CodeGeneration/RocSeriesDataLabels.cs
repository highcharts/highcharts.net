...
{
	public partial class RocSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesDataLabels()
		{
			Align = Align_DefaultValue = RocSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new RocSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = RocSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = RocSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new RocSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = RocSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public RocSeriesDataLabelsAlign Align { get; set; }
		private RocSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataLabelsFilter Filter { get; set; }
		private RocSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataLabelsOverflow Overflow { get; set; }
		private RocSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataLabelsPosition Position { get; set; }
		private RocSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataLabelsTextPath TextPath { get; set; }
		private RocSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private RocSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
