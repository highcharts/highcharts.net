...
{
	public partial class RocSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = RocSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public RocSeriesLastPriceLabelAlign Align { get; set; }
		private RocSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
