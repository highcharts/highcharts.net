...
{
	public partial class RocSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new RocSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new RocSeriesOnPointPosition();
		...
		/// </summary>
		public RocSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private RocSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesOnPointPosition Position { get; set; }
		private RocSeriesOnPointPosition Position_DefaultValue { get; set; }
