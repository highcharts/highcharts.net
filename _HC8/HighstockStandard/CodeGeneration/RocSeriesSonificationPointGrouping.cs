...
{
	public partial class RocSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = RocSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public RocSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private RocSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
