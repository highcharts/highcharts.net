...
{
	public partial class RocSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RocSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new RocSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new RocSeriesStatesHoverMarker();
		...
		/// </summary>
		public RocSeriesStatesHoverHalo Halo { get; set; }
		private RocSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public RocSeriesStatesHoverMarker Marker { get; set; }
		private RocSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
