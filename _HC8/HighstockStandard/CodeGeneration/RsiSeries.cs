...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class RsiSeries  : Series
	{
		...
		public RsiSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = RsiSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = RsiSeriesType.Rsi;
		...
		/// </summary>
		public RsiSeriesType Type { get; set; }
		private RsiSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("RsiSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
