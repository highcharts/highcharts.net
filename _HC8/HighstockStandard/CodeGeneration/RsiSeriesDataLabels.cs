...
{
	public partial class RsiSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesDataLabels()
		{
			Align = Align_DefaultValue = RsiSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new RsiSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = RsiSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = RsiSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new RsiSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = RsiSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public RsiSeriesDataLabelsAlign Align { get; set; }
		private RsiSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataLabelsFilter Filter { get; set; }
		private RsiSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataLabelsOverflow Overflow { get; set; }
		private RsiSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataLabelsPosition Position { get; set; }
		private RsiSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataLabelsTextPath TextPath { get; set; }
		private RsiSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private RsiSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
