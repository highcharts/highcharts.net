...
{
	public partial class RsiSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = RsiSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public RsiSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private RsiSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
