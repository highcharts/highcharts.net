...
{
	public partial class RsiSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new RsiSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new RsiSeriesOnPointPosition();
		...
		/// </summary>
		public RsiSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private RsiSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesOnPointPosition Position { get; set; }
		private RsiSeriesOnPointPosition Position_DefaultValue { get; set; }
