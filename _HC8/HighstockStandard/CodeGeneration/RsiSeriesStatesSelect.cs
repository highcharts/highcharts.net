...
{
	public partial class RsiSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public RsiSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new RsiSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new RsiSeriesStatesSelectMarker();
		...
		/// </summary>
		public RsiSeriesStatesSelectHalo Halo { get; set; }
		private RsiSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public RsiSeriesStatesSelectMarker Marker { get; set; }
		private RsiSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
