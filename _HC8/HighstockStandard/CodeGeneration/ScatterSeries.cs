...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ScatterSeries  : Series
	{
		...
		public ScatterSeries()
		{
			...
			Type = Type_DefaultValue = ScatterSeriesType.Scatter;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ScatterSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
