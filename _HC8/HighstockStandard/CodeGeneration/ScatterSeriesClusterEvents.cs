...
{
	public partial class ScatterSeriesClusterEvents  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesClusterEvents()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (DrillToCluster != DrillToCluster_DefaultValue) { h.Add("drillToCluster",DrillToCluster); Highstock.AddFunction("ScatterSeriesClusterEventsDrillToCluster.drillToCluster", DrillToCluster); }  
