...
{
	public partial class ScatterSeriesClusterMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesClusterMarker()
		{
			...
			States = States_DefaultValue = new ScatterSeriesClusterMarkerStates();
		...
		/// </summary>
		public ScatterSeriesClusterMarkerStates States { get; set; }
		private ScatterSeriesClusterMarkerStates States_DefaultValue { get; set; }
