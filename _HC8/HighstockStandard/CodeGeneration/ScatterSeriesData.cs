...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ScatterSeriesData  : BaseObject
	{
		...
		{
			Accessibility = Accessibility_DefaultValue = new ScatterSeriesDataAccessibility();
			...
			DragDrop = DragDrop_DefaultValue = new ScatterSeriesDataDragDrop();
		...
		/// </summary>
		public ScatterSeriesDataAccessibility Accessibility { get; set; }
		private ScatterSeriesDataAccessibility Accessibility_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesDataDragDrop DragDrop { get; set; }
		private ScatterSeriesDataDragDrop DragDrop_DefaultValue { get; set; }
