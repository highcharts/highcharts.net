...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ScatterSeriesDataLabels  : BaseObject
	{
		...
		public ScatterSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = ScatterSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ScatterSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public ScatterSeriesDataLabelsPosition Position { get; set; }
		private ScatterSeriesDataLabelsPosition Position_DefaultValue { get; set; }
