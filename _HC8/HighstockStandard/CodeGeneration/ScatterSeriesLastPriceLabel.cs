...
{
	public partial class ScatterSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ScatterSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ScatterSeriesLastPriceLabelAlign Align { get; set; }
		private ScatterSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
