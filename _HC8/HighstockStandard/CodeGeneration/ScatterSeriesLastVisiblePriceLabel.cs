...
{
	public partial class ScatterSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ScatterSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ScatterSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ScatterSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
