...
{
	public partial class ScatterSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ScatterSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ScatterSeriesOnPointPosition();
		...
		/// </summary>
		public ScatterSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ScatterSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesOnPointPosition Position { get; set; }
		private ScatterSeriesOnPointPosition Position_DefaultValue { get; set; }
