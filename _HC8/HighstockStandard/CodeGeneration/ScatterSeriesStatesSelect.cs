...
{
	public partial class ScatterSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ScatterSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ScatterSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ScatterSeriesStatesSelectMarker();
		...
		/// </summary>
		public ScatterSeriesStatesSelectHalo Halo { get; set; }
		private ScatterSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesStatesSelectMarker Marker { get; set; }
		private ScatterSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
