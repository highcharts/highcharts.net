...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeries  : Series
	{
		...
		public SlowstochasticSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = SlowstochasticSeriesDashStyle.Solid;
            ...
            Type = Type_DefaultValue = SlowstochasticSeriesType.Slowstochastic;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SlowstochasticSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
