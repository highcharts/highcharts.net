...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeries  : Series
	{
		...
		public SlowstochasticSeries()
		{
			...
			Type = Type_DefaultValue = SlowstochasticSeriesType.Null;
		...
		/// </summary>
		public SlowstochasticSeriesType Type { get; set; }
		private SlowstochasticSeriesType Type_DefaultValue { get; set; }
