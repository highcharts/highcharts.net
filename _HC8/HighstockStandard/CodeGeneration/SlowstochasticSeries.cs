...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeries  : Series
	{
		...
		public SlowstochasticSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new SlowstochasticSeriesDragDrop();
		...
		/// </summary>
		public SlowstochasticSeriesDragDrop DragDrop { get; set; }
		private SlowstochasticSeriesDragDrop DragDrop_DefaultValue { get; set; }
