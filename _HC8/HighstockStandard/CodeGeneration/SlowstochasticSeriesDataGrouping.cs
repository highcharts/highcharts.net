...
{
	public partial class SlowstochasticSeriesDataGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesDataGrouping()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("SlowstochasticSeriesDataGroupingApproximation.approximation", Approximation); }  
