...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SlowstochasticSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SlowstochasticSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("SlowstochasticSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
