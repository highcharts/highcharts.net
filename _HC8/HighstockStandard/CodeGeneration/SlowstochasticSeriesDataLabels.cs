...
{
	public partial class SlowstochasticSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesDataLabels()
		{
			Align = Align_DefaultValue = SlowstochasticSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new SlowstochasticSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = SlowstochasticSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = SlowstochasticSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new SlowstochasticSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = SlowstochasticSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsAlign Align { get; set; }
		private SlowstochasticSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsFilter Filter { get; set; }
		private SlowstochasticSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsOverflow Overflow { get; set; }
		private SlowstochasticSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsPosition Position { get; set; }
		private SlowstochasticSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsTextPath TextPath { get; set; }
		private SlowstochasticSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SlowstochasticSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
