...
{
	public partial class SlowstochasticSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesDragDrop()
		{
			...
			GuideBox = GuideBox_DefaultValue = new SlowstochasticSeriesDragDropGuideBox();
		...
		/// </summary>
		public SlowstochasticSeriesDragDropGuideBox GuideBox { get; set; }
		private SlowstochasticSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
