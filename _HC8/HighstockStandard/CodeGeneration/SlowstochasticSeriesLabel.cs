...
{
	public partial class SlowstochasticSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SlowstochasticSeriesLabelFormatter.formatter", Formatter); }  
