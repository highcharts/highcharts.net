...
{
	public partial class SlowstochasticSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = SlowstochasticSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SlowstochasticSeriesLastPriceLabelAlign Align { get; set; }
		private SlowstochasticSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
