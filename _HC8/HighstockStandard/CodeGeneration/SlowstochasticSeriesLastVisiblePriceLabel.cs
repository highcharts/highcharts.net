...
{
	public partial class SlowstochasticSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = SlowstochasticSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SlowstochasticSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private SlowstochasticSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
