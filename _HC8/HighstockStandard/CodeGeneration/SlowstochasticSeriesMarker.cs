...
{
	public partial class SlowstochasticSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesMarker()
		{
			...
			States = States_DefaultValue = new SlowstochasticSeriesMarkerStates();
		...
		/// </summary>
		public SlowstochasticSeriesMarkerStates States { get; set; }
		private SlowstochasticSeriesMarkerStates States_DefaultValue { get; set; }
