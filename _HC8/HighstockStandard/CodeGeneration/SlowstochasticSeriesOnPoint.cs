...
{
	public partial class SlowstochasticSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SlowstochasticSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SlowstochasticSeriesOnPointPosition();
		...
		/// </summary>
		public SlowstochasticSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SlowstochasticSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesOnPointPosition Position { get; set; }
		private SlowstochasticSeriesOnPointPosition Position_DefaultValue { get; set; }
