...
{
	public partial class SlowstochasticSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SlowstochasticSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SlowstochasticSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SlowstochasticSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
