...
{
	public partial class SlowstochasticSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new SlowstochasticSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new SlowstochasticSeriesStatesHoverMarker();
		...
		/// </summary>
		public SlowstochasticSeriesStatesHoverHalo Halo { get; set; }
		private SlowstochasticSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesStatesHoverMarker Marker { get; set; }
		private SlowstochasticSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
