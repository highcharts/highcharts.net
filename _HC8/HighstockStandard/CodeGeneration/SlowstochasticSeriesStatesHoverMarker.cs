...
{
	public partial class SlowstochasticSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new SlowstochasticSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public SlowstochasticSeriesStatesHoverMarkerStates States { get; set; }
		private SlowstochasticSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
