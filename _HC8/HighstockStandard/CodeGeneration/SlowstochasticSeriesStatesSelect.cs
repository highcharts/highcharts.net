...
{
	public partial class SlowstochasticSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new SlowstochasticSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new SlowstochasticSeriesStatesSelectMarker();
		...
		/// </summary>
		public SlowstochasticSeriesStatesSelectHalo Halo { get; set; }
		private SlowstochasticSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SlowstochasticSeriesStatesSelectMarker Marker { get; set; }
		private SlowstochasticSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
