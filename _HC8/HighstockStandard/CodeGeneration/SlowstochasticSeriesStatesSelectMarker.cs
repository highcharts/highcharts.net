...
{
	public partial class SlowstochasticSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new SlowstochasticSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SlowstochasticSeriesStatesSelectMarkerStates States { get; set; }
		private SlowstochasticSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
