...
{
	public partial class SlowstochasticSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SlowstochasticSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = SlowstochasticSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public SlowstochasticSeriesTooltipHeaderShape HeaderShape { get; set; }
		private SlowstochasticSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("SlowstochasticSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SlowstochasticSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
