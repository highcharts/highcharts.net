...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeries  : Series
	{
		...
		public SmaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = SmaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = SmaSeriesType.Sma;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SmaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
