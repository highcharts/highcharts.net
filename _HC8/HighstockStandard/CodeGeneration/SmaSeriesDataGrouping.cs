...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SmaSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("SmaSeriesDataGroupingApproximation.approximation", Approximation); }  
