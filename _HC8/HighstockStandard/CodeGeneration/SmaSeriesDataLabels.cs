...
{
	public partial class SmaSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesDataLabels()
		{
			Align = Align_DefaultValue = SmaSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new SmaSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = SmaSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = SmaSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new SmaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = SmaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public SmaSeriesDataLabelsAlign Align { get; set; }
		private SmaSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataLabelsFilter Filter { get; set; }
		private SmaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataLabelsOverflow Overflow { get; set; }
		private SmaSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataLabelsPosition Position { get; set; }
		private SmaSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataLabelsTextPath TextPath { get; set; }
		private SmaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SmaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
