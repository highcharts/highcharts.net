...
{
	public partial class SmaSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = SmaSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SmaSeriesLastPriceLabelAlign Align { get; set; }
		private SmaSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
