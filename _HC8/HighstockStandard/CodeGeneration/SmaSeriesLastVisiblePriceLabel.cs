...
{
	public partial class SmaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = SmaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SmaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private SmaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
