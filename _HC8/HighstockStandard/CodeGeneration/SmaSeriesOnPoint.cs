...
{
	public partial class SmaSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SmaSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SmaSeriesOnPointPosition();
		...
		/// </summary>
		public SmaSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SmaSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesOnPointPosition Position { get; set; }
		private SmaSeriesOnPointPosition Position_DefaultValue { get; set; }
