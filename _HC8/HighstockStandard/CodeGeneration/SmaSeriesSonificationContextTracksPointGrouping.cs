...
{
	public partial class SmaSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SmaSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
