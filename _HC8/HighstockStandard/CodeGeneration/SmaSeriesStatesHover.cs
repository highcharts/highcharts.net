...
{
	public partial class SmaSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new SmaSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new SmaSeriesStatesHoverMarker();
		...
		/// </summary>
		public SmaSeriesStatesHoverHalo Halo { get; set; }
		private SmaSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesStatesHoverMarker Marker { get; set; }
		private SmaSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
