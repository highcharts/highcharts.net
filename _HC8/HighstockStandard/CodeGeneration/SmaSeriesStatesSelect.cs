...
{
	public partial class SmaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SmaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new SmaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new SmaSeriesStatesSelectMarker();
		...
		/// </summary>
		public SmaSeriesStatesSelectHalo Halo { get; set; }
		private SmaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public SmaSeriesStatesSelectMarker Marker { get; set; }
		private SmaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
