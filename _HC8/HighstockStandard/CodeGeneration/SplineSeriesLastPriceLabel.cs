...
{
	public partial class SplineSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = SplineSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SplineSeriesLastPriceLabelAlign Align { get; set; }
		private SplineSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
