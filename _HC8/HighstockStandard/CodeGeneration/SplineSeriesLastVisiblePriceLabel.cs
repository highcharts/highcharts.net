...
{
	public partial class SplineSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = SplineSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SplineSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private SplineSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
