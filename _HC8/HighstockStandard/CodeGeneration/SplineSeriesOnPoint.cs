...
{
	public partial class SplineSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SplineSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SplineSeriesOnPointPosition();
		...
		/// </summary>
		public SplineSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SplineSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SplineSeriesOnPointPosition Position { get; set; }
		private SplineSeriesOnPointPosition Position_DefaultValue { get; set; }
