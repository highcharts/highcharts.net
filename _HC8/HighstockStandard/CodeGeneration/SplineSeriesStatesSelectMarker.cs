...
{
	public partial class SplineSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SplineSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new SplineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SplineSeriesStatesSelectMarkerStates States { get; set; }
		private SplineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
