...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeries  : Series
	{
		...
		public StochasticSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = StochasticSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = StochasticSeriesType.Stochastic;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("StochasticSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
