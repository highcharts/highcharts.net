...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeries  : Series
	{
		...
		public StochasticSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new StochasticSeriesDragDrop();
		...
		/// </summary>
		public StochasticSeriesDragDrop DragDrop { get; set; }
		private StochasticSeriesDragDrop DragDrop_DefaultValue { get; set; }
