...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StochasticSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("StochasticSeriesDataGroupingApproximation.approximation", Approximation); }  
