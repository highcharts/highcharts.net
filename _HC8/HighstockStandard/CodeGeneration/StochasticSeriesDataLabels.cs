...
{
	public partial class StochasticSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesDataLabels()
		{
			Align = Align_DefaultValue = StochasticSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new StochasticSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = StochasticSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = StochasticSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new StochasticSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = StochasticSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public StochasticSeriesDataLabelsAlign Align { get; set; }
		private StochasticSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabelsFilter Filter { get; set; }
		private StochasticSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabelsOverflow Overflow { get; set; }
		private StochasticSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabelsPosition Position { get; set; }
		private StochasticSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabelsTextPath TextPath { get; set; }
		private StochasticSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private StochasticSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
