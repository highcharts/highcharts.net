...
{
	public partial class StochasticSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = StochasticSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public StochasticSeriesLastPriceLabelAlign Align { get; set; }
		private StochasticSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
