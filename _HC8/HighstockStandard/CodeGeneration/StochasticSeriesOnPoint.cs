...
{
	public partial class StochasticSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new StochasticSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new StochasticSeriesOnPointPosition();
		...
		/// </summary>
		public StochasticSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private StochasticSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesOnPointPosition Position { get; set; }
		private StochasticSeriesOnPointPosition Position_DefaultValue { get; set; }
