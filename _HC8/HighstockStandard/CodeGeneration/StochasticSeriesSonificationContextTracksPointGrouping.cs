...
{
	public partial class StochasticSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = StochasticSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public StochasticSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private StochasticSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
