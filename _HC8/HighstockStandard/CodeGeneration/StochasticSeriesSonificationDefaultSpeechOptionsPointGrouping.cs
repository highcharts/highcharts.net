...
{
	public partial class StochasticSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = StochasticSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public StochasticSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private StochasticSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
