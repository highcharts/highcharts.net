...
{
	public partial class StochasticSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = StochasticSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public StochasticSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private StochasticSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
