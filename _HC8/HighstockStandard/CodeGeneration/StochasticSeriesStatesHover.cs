...
{
	public partial class StochasticSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new StochasticSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new StochasticSeriesStatesHoverMarker();
		...
		/// </summary>
		public StochasticSeriesStatesHoverHalo Halo { get; set; }
		private StochasticSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesStatesHoverMarker Marker { get; set; }
		private StochasticSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
