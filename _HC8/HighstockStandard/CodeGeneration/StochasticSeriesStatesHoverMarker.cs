...
{
	public partial class StochasticSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new StochasticSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public StochasticSeriesStatesHoverMarkerStates States { get; set; }
		private StochasticSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
