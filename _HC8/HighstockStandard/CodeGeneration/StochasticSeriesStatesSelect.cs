...
{
	public partial class StochasticSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new StochasticSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new StochasticSeriesStatesSelectMarker();
		...
		/// </summary>
		public StochasticSeriesStatesSelectHalo Halo { get; set; }
		private StochasticSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public StochasticSeriesStatesSelectMarker Marker { get; set; }
		private StochasticSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
