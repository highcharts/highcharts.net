...
{
	public partial class StochasticSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StochasticSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new StochasticSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public StochasticSeriesStatesSelectMarkerStates States { get; set; }
		private StochasticSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
