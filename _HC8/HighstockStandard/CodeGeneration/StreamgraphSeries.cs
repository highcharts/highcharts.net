...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeries  : Series
	{
		...
		public StreamgraphSeries()
		{
			...
			BoostBlending = BoostBlending_DefaultValue = StreamgraphSeriesBoostBlending.Undefined;
			...
			Step = Step_DefaultValue = StreamgraphSeriesStep.Null;
		...
		/// </summary>
		public StreamgraphSeriesBoostBlending BoostBlending { get; set; }
		private StreamgraphSeriesBoostBlending BoostBlending_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesStep Step { get; set; }
		private StreamgraphSeriesStep Step_DefaultValue { get; set; }
