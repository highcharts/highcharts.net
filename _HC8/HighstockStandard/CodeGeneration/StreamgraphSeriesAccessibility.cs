...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeriesAccessibility  : BaseObject
	{
		...
		public StreamgraphSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new StreamgraphSeriesAccessibilityPoint();
		...
		/// </summary>
		public StreamgraphSeriesAccessibilityPoint Point { get; set; }
		private StreamgraphSeriesAccessibilityPoint Point_DefaultValue { get; set; }
