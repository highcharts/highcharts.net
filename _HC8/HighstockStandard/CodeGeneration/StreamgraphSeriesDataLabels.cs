...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class StreamgraphSeriesDataLabels  : BaseObject
	{
		...
		public StreamgraphSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = StreamgraphSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = StreamgraphSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsOverflow Overflow { get; set; }
		private StreamgraphSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public StreamgraphSeriesDataLabelsPosition Position { get; set; }
		private StreamgraphSeriesDataLabelsPosition Position_DefaultValue { get; set; }
