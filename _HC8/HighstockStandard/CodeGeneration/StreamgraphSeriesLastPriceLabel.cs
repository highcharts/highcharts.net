...
{
	public partial class StreamgraphSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = StreamgraphSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public StreamgraphSeriesLastPriceLabelAlign Align { get; set; }
		private StreamgraphSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
