...
{
	public partial class StreamgraphSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = StreamgraphSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public StreamgraphSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private StreamgraphSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
