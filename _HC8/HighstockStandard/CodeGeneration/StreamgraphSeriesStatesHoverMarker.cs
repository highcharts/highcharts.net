...
{
	public partial class StreamgraphSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new StreamgraphSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesStatesHoverMarkerStates States { get; set; }
		private StreamgraphSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
