...
{
	public partial class StreamgraphSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public StreamgraphSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new StreamgraphSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public StreamgraphSeriesStatesSelectMarkerStates States { get; set; }
		private StreamgraphSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
