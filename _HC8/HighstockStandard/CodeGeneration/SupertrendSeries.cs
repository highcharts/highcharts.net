...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SupertrendSeries  : Series
	{
		...
		public SupertrendSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = SupertrendSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = SupertrendSeriesType.Supertrend;
		...
		/// </summary>
		public SupertrendSeriesType Type { get; set; }
		private SupertrendSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("SupertrendSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
