...
{
	public partial class SupertrendSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesDataLabels()
		{
			Align = Align_DefaultValue = SupertrendSeriesDataLabelsAlign.Center;
			...
			Overflow = Overflow_DefaultValue = SupertrendSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = SupertrendSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new SupertrendSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = SupertrendSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public SupertrendSeriesDataLabelsAlign Align { get; set; }
		private SupertrendSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabelsFilter Filter { get; set; }
		private SupertrendSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabelsOverflow Overflow { get; set; }
		private SupertrendSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabelsPosition Position { get; set; }
		private SupertrendSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabelsTextPath TextPath { get; set; }
		private SupertrendSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private SupertrendSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
