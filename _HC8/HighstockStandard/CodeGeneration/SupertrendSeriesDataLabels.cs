...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class SupertrendSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("SupertrendSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("SupertrendSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
