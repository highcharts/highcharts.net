...
{
	public partial class SupertrendSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = SupertrendSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public SupertrendSeriesLastPriceLabelAlign Align { get; set; }
		private SupertrendSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
