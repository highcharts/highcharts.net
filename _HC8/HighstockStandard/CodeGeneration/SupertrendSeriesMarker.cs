...
{
	public partial class SupertrendSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesMarker()
		{
			...
			States = States_DefaultValue = new SupertrendSeriesMarkerStates();
		...
		/// </summary>
		public SupertrendSeriesMarkerStates States { get; set; }
		private SupertrendSeriesMarkerStates States_DefaultValue { get; set; }
