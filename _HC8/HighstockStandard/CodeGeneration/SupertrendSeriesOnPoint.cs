...
{
	public partial class SupertrendSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new SupertrendSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new SupertrendSeriesOnPointPosition();
		...
		/// </summary>
		public SupertrendSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private SupertrendSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public SupertrendSeriesOnPointPosition Position { get; set; }
		private SupertrendSeriesOnPointPosition Position_DefaultValue { get; set; }
