...
{
	public partial class SupertrendSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SupertrendSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SupertrendSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private SupertrendSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
