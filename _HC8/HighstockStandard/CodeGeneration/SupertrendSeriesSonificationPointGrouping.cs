...
{
	public partial class SupertrendSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = SupertrendSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public SupertrendSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private SupertrendSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
