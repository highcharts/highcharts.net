...
{
	public partial class SupertrendSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new SupertrendSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public SupertrendSeriesStatesSelectMarkerStates States { get; set; }
		private SupertrendSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
