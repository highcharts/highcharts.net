...
{
	public partial class SupertrendSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public SupertrendSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = SupertrendSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public SupertrendSeriesTooltipHeaderShape HeaderShape { get; set; }
		private SupertrendSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("SupertrendSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("SupertrendSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
