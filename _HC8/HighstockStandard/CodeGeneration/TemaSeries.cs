...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeries  : Series
	{
		...
		public TemaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = TemaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = TemaSeriesType.Tema;
		...
		/// </summary>
		public TemaSeriesType Type { get; set; }
		private TemaSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("TemaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
