...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TemaSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("TemaSeriesDataGroupingApproximation.approximation", Approximation); }  
