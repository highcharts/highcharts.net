...
{
	public partial class TemaSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesDataLabels()
		{
			Align = Align_DefaultValue = TemaSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TemaSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = TemaSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = TemaSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new TemaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TemaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TemaSeriesDataLabelsAlign Align { get; set; }
		private TemaSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabelsFilter Filter { get; set; }
		private TemaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabelsOverflow Overflow { get; set; }
		private TemaSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabelsPosition Position { get; set; }
		private TemaSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabelsTextPath TextPath { get; set; }
		private TemaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TemaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
