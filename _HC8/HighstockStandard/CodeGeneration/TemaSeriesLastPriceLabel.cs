...
{
	public partial class TemaSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = TemaSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TemaSeriesLastPriceLabelAlign Align { get; set; }
		private TemaSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
