...
{
	public partial class TemaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = TemaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TemaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private TemaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
