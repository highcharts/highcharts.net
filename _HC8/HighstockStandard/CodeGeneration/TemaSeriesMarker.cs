...
{
	public partial class TemaSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesMarker()
		{
			...
			States = States_DefaultValue = new TemaSeriesMarkerStates();
		...
		/// </summary>
		public TemaSeriesMarkerStates States { get; set; }
		private TemaSeriesMarkerStates States_DefaultValue { get; set; }
