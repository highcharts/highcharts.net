...
{
	public partial class TemaSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new TemaSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new TemaSeriesOnPointPosition();
		...
		/// </summary>
		public TemaSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private TemaSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesOnPointPosition Position { get; set; }
		private TemaSeriesOnPointPosition Position_DefaultValue { get; set; }
