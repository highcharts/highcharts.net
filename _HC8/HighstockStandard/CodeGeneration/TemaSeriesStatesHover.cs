...
{
	public partial class TemaSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TemaSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TemaSeriesStatesHoverMarker();
		...
		/// </summary>
		public TemaSeriesStatesHoverHalo Halo { get; set; }
		private TemaSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesStatesHoverMarker Marker { get; set; }
		private TemaSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
