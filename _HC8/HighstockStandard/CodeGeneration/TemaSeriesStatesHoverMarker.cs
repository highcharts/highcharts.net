...
{
	public partial class TemaSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TemaSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TemaSeriesStatesHoverMarkerStates States { get; set; }
		private TemaSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
