...
{
	public partial class TemaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TemaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TemaSeriesStatesSelectMarker();
		...
		/// </summary>
		public TemaSeriesStatesSelectHalo Halo { get; set; }
		private TemaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TemaSeriesStatesSelectMarker Marker { get; set; }
		private TemaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
