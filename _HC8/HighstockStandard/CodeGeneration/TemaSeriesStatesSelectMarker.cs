...
{
	public partial class TemaSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TemaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TemaSeriesStatesSelectMarkerStates States { get; set; }
		private TemaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
