...
{
	public partial class TemaSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TemaSeriesTooltip()
		{
		...
		/// </summary>
		public TemaSeriesTooltipHeaderShape HeaderShape { get; set; }
		private TemaSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("TemaSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("TemaSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
