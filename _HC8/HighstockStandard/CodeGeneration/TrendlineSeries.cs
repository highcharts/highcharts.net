...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrendlineSeries  : Series
	{
		...
		public TrendlineSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = TrendlineSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = TrendlineSeriesType.Trendline;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("TrendlineSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
