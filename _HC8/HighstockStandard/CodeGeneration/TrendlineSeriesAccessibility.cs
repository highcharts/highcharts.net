...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrendlineSeriesAccessibility  : BaseObject
	{
		...
		public TrendlineSeriesAccessibility()
		{
			...
			Point = Point_DefaultValue = new TrendlineSeriesAccessibilityPoint();
		...
		/// </summary>
		public TrendlineSeriesAccessibilityPoint Point { get; set; }
		private TrendlineSeriesAccessibilityPoint Point_DefaultValue { get; set; }
