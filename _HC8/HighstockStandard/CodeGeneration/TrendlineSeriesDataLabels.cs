...
{
	public partial class TrendlineSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesDataLabels()
		{
			Align = Align_DefaultValue = TrendlineSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TrendlineSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = TrendlineSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = TrendlineSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new TrendlineSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TrendlineSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TrendlineSeriesDataLabelsAlign Align { get; set; }
		private TrendlineSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabelsFilter Filter { get; set; }
		private TrendlineSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabelsOverflow Overflow { get; set; }
		private TrendlineSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabelsPosition Position { get; set; }
		private TrendlineSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabelsTextPath TextPath { get; set; }
		private TrendlineSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TrendlineSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
