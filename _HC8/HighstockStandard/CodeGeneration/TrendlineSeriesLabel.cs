...
{
	public partial class TrendlineSeriesLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesLabel()
		{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("TrendlineSeriesLabelFormatter.formatter", Formatter); }  
