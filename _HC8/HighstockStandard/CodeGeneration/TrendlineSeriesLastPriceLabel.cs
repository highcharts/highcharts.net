...
{
	public partial class TrendlineSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = TrendlineSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TrendlineSeriesLastPriceLabelAlign Align { get; set; }
		private TrendlineSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
