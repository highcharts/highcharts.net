...
{
	public partial class TrendlineSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = TrendlineSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TrendlineSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private TrendlineSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
