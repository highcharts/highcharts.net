...
{
	public partial class TrendlineSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesMarker()
		{
			...
			States = States_DefaultValue = new TrendlineSeriesMarkerStates();
		...
		/// </summary>
		public TrendlineSeriesMarkerStates States { get; set; }
		private TrendlineSeriesMarkerStates States_DefaultValue { get; set; }
