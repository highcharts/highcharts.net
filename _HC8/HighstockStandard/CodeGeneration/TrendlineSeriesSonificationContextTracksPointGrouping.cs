...
{
	public partial class TrendlineSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrendlineSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrendlineSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TrendlineSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
