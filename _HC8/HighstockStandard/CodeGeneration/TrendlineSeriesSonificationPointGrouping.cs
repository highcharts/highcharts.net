...
{
	public partial class TrendlineSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrendlineSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrendlineSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private TrendlineSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
