...
{
	public partial class TrendlineSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new TrendlineSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new TrendlineSeriesStatesHoverMarker();
		...
		/// </summary>
		public TrendlineSeriesStatesHoverHalo Halo { get; set; }
		private TrendlineSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesStatesHoverMarker Marker { get; set; }
		private TrendlineSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
