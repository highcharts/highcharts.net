...
{
	public partial class TrendlineSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TrendlineSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TrendlineSeriesStatesHoverMarkerStates States { get; set; }
		private TrendlineSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
