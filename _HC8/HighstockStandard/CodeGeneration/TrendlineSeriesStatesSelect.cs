...
{
	public partial class TrendlineSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new TrendlineSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new TrendlineSeriesStatesSelectMarker();
		...
		/// </summary>
		public TrendlineSeriesStatesSelectHalo Halo { get; set; }
		private TrendlineSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TrendlineSeriesStatesSelectMarker Marker { get; set; }
		private TrendlineSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
