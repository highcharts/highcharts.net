...
{
	public partial class TrendlineSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TrendlineSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TrendlineSeriesStatesSelectMarkerStates States { get; set; }
		private TrendlineSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
