...
{
	public partial class TrendlineSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrendlineSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = TrendlineSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public TrendlineSeriesTooltipHeaderShape HeaderShape { get; set; }
		private TrendlineSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
