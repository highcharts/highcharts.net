...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrixSeries  : Series
	{
		...
		public TrixSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = TrixSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = TrixSeriesType.Trix;
		...
		/// </summary>
		public TrixSeriesType Type { get; set; }
		private TrixSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("TrixSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
