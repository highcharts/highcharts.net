...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class TrixSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("TrixSeriesDataGroupingApproximation.approximation", Approximation); }  
