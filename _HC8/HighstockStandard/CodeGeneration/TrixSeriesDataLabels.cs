...
{
	public partial class TrixSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesDataLabels()
		{
			Align = Align_DefaultValue = TrixSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new TrixSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = TrixSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = TrixSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new TrixSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = TrixSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public TrixSeriesDataLabelsAlign Align { get; set; }
		private TrixSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabelsFilter Filter { get; set; }
		private TrixSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabelsOverflow Overflow { get; set; }
		private TrixSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabelsPosition Position { get; set; }
		private TrixSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabelsTextPath TextPath { get; set; }
		private TrixSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private TrixSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
