...
{
	public partial class TrixSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = TrixSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TrixSeriesLastPriceLabelAlign Align { get; set; }
		private TrixSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
