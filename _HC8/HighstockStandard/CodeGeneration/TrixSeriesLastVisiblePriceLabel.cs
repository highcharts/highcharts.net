...
{
	public partial class TrixSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = TrixSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public TrixSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private TrixSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
