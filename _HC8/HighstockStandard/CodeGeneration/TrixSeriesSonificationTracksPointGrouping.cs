...
{
	public partial class TrixSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = TrixSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public TrixSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private TrixSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
