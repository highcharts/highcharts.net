...
{
	public partial class TrixSeriesStatesHoverMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesStatesHoverMarker()
		{
			...
			States = States_DefaultValue = new TrixSeriesStatesHoverMarkerStates();
		...
		/// </summary>
		public TrixSeriesStatesHoverMarkerStates States { get; set; }
		private TrixSeriesStatesHoverMarkerStates States_DefaultValue { get; set; }
