...
{
	public partial class TrixSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new TrixSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new TrixSeriesStatesSelectMarker();
		...
		/// </summary>
		public TrixSeriesStatesSelectHalo Halo { get; set; }
		private TrixSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public TrixSeriesStatesSelectMarker Marker { get; set; }
		private TrixSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
