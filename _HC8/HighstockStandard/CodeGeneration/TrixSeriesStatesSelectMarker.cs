...
{
	public partial class TrixSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public TrixSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new TrixSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public TrixSeriesStatesSelectMarkerStates States { get; set; }
		private TrixSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
