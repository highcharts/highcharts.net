...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VbpSeries  : Series
	{
		...
		public VbpSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = VbpSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = VbpSeriesType.Vbp;
		...
		/// </summary>
		public VbpSeriesType Type { get; set; }
		private VbpSeriesType Type_DefaultValue { get; set; }
		...
		/// </summary>
		public List<VbpSeriesZone> Zones { get; set; }
		private List<VbpSeriesZone> Zones_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("VbpSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
