...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VbpSeries  : Series
	{
		...
		internal override Hashtable ToHashtable(ref Highstock highstock)
		{
			...
			if (VolumeDivision.IsDirty(ref highstock)) h.Add("volumeDivision",VolumeDivision.ToHashtable(ref highstock));
			...
			if (ZoneLines.IsDirty(ref highstock)) h.Add("zoneLines",ZoneLines.ToHashtable(ref highstock));
