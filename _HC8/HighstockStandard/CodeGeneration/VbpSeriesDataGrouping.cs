...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VbpSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("VbpSeriesDataGroupingApproximation.approximation", Approximation); }  
