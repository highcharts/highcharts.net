...
{
	public partial class VbpSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = VbpSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VbpSeriesLastPriceLabelAlign Align { get; set; }
		private VbpSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
