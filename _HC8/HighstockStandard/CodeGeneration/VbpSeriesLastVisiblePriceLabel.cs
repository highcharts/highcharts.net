...
{
	public partial class VbpSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = VbpSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VbpSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private VbpSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
