...
{
	public partial class VbpSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VbpSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VbpSeriesOnPointPosition();
		...
		/// </summary>
		public VbpSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VbpSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesOnPointPosition Position { get; set; }
		private VbpSeriesOnPointPosition Position_DefaultValue { get; set; }
