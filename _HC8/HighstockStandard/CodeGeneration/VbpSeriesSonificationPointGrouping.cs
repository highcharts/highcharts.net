...
{
	public partial class VbpSeriesSonificationPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VbpSeriesSonificationPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VbpSeriesSonificationPointGroupingAlgorithm Algorithm { get; set; }
		private VbpSeriesSonificationPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
