...
{
	public partial class VbpSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VbpSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VbpSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VbpSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
