...
{
	public partial class VbpSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VbpSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			AnimationBool = AnimationBool_DefaultValue = null;
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new VbpSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VbpSeriesStatesHoverMarker();
		...
		/// </summary>
		public VbpSeriesStatesHoverHalo Halo { get; set; }
		private VbpSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VbpSeriesStatesHoverMarker Marker { get; set; }
		private VbpSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
