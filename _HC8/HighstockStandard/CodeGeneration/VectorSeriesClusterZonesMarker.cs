...
{
	public partial class VectorSeriesClusterZonesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesClusterZonesMarker()
		{
			...
			States = States_DefaultValue = new VectorSeriesClusterZonesMarkerStates();
		...
		/// </summary>
		public VectorSeriesClusterZonesMarkerStates States { get; set; }
		private VectorSeriesClusterZonesMarkerStates States_DefaultValue { get; set; }
