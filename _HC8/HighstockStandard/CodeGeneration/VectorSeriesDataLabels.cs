...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeriesDataLabels  : BaseObject
	{
		...
		public VectorSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = VectorSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = VectorSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public VectorSeriesDataLabelsOverflow Overflow { get; set; }
		private VectorSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesDataLabelsPosition Position { get; set; }
		private VectorSeriesDataLabelsPosition Position_DefaultValue { get; set; }
