...
{
	public partial class VectorSeriesDataMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new VectorSeriesDataMarkerStates();
		...
		/// </summary>
		public VectorSeriesDataMarkerStates States { get; set; }
		private VectorSeriesDataMarkerStates States_DefaultValue { get; set; }
