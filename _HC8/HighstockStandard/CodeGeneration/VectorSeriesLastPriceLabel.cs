...
{
	public partial class VectorSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = VectorSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VectorSeriesLastPriceLabelAlign Align { get; set; }
		private VectorSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
