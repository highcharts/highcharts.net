...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VectorSeriesLastVisiblePriceLabel  : BaseObject
	{
		...
		{
			Align = Align_DefaultValue = VectorSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VectorSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private VectorSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
