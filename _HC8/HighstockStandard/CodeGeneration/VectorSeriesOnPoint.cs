...
{
	public partial class VectorSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VectorSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VectorSeriesOnPointPosition();
		...
		/// </summary>
		public VectorSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VectorSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesOnPointPosition Position { get; set; }
		private VectorSeriesOnPointPosition Position_DefaultValue { get; set; }
