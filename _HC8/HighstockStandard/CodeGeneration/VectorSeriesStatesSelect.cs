...
{
	public partial class VectorSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VectorSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new VectorSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VectorSeriesStatesSelectMarker();
		...
		/// </summary>
		public VectorSeriesStatesSelectHalo Halo { get; set; }
		private VectorSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VectorSeriesStatesSelectMarker Marker { get; set; }
		private VectorSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
