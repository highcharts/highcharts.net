...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class VwapSeries  : Series
	{
		...
		public VwapSeries()
		{
			...
			DragDrop = DragDrop_DefaultValue = new VwapSeriesDragDrop();
		...
		/// </summary>
		public VwapSeriesDragDrop DragDrop { get; set; }
		private VwapSeriesDragDrop DragDrop_DefaultValue { get; set; }
