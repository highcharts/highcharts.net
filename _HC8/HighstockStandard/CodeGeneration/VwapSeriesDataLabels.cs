...
{
	public partial class VwapSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesDataLabels()
		{
			Align = Align_DefaultValue = VwapSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new VwapSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = VwapSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = VwapSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new VwapSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = VwapSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public VwapSeriesDataLabelsAlign Align { get; set; }
		private VwapSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataLabelsFilter Filter { get; set; }
		private VwapSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataLabelsOverflow Overflow { get; set; }
		private VwapSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataLabelsPosition Position { get; set; }
		private VwapSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataLabelsTextPath TextPath { get; set; }
		private VwapSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private VwapSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
