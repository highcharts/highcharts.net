...
{
	public partial class VwapSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = VwapSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VwapSeriesLastPriceLabelAlign Align { get; set; }
		private VwapSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
