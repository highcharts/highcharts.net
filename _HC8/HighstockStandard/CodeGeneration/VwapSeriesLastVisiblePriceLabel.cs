...
{
	public partial class VwapSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = VwapSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public VwapSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private VwapSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
