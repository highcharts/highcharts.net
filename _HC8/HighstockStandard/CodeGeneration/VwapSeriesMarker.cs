...
{
	public partial class VwapSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesMarker()
		{
			...
			States = States_DefaultValue = new VwapSeriesMarkerStates();
		...
		/// </summary>
		public VwapSeriesMarkerStates States { get; set; }
		private VwapSeriesMarkerStates States_DefaultValue { get; set; }
