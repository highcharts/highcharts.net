...
{
	public partial class VwapSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new VwapSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new VwapSeriesOnPointPosition();
		...
		/// </summary>
		public VwapSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private VwapSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesOnPointPosition Position { get; set; }
		private VwapSeriesOnPointPosition Position_DefaultValue { get; set; }
