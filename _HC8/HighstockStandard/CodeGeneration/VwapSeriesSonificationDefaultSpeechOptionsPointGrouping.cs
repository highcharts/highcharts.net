...
{
	public partial class VwapSeriesSonificationDefaultSpeechOptionsPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationDefaultSpeechOptionsPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VwapSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VwapSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm { get; set; }
		private VwapSeriesSonificationDefaultSpeechOptionsPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
