...
{
	public partial class VwapSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = VwapSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public VwapSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private VwapSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
