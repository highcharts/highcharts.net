...
{
	public partial class VwapSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new VwapSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new VwapSeriesStatesSelectMarker();
		...
		/// </summary>
		public VwapSeriesStatesSelectHalo Halo { get; set; }
		private VwapSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public VwapSeriesStatesSelectMarker Marker { get; set; }
		private VwapSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
