...
{
	public partial class VwapSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new VwapSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public VwapSeriesStatesSelectMarkerStates States { get; set; }
		private VwapSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
