...
{
	public partial class VwapSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public VwapSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = VwapSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public VwapSeriesTooltipHeaderShape HeaderShape { get; set; }
		private VwapSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("VwapSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("VwapSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
