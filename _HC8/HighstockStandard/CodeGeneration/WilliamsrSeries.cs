...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeries  : Series
	{
		...
		public WilliamsrSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = WilliamsrSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = WilliamsrSeriesType.Williamsr;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WilliamsrSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
