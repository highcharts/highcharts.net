...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("WilliamsrSeriesDataGroupingApproximation.approximation", Approximation); }  
