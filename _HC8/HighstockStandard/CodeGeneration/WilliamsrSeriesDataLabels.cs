...
{
	public partial class WilliamsrSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesDataLabels()
		{
			Align = Align_DefaultValue = WilliamsrSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new WilliamsrSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = WilliamsrSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = WilliamsrSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new WilliamsrSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = WilliamsrSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsAlign Align { get; set; }
		private WilliamsrSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsFilter Filter { get; set; }
		private WilliamsrSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsOverflow Overflow { get; set; }
		private WilliamsrSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsPosition Position { get; set; }
		private WilliamsrSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsTextPath TextPath { get; set; }
		private WilliamsrSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WilliamsrSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
