...
{
	public partial class WilliamsrSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = WilliamsrSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public WilliamsrSeriesLastPriceLabelAlign Align { get; set; }
		private WilliamsrSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
