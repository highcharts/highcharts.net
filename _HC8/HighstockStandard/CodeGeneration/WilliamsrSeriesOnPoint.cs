...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WilliamsrSeriesOnPoint  : BaseObject
	{
		...
		public WilliamsrSeriesOnPoint()
		{
			...
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new WilliamsrSeriesOnPointPosition();
		...
		/// </summary>
		public WilliamsrSeriesOnPointPosition Position { get; set; }
		private WilliamsrSeriesOnPointPosition Position_DefaultValue { get; set; }
