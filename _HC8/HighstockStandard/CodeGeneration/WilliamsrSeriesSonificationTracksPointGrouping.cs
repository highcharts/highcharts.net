...
{
	public partial class WilliamsrSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = WilliamsrSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public WilliamsrSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private WilliamsrSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
