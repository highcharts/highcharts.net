...
{
	public partial class WilliamsrSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new WilliamsrSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new WilliamsrSeriesStatesSelectMarker();
		...
		/// </summary>
		public WilliamsrSeriesStatesSelectHalo Halo { get; set; }
		private WilliamsrSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WilliamsrSeriesStatesSelectMarker Marker { get; set; }
		private WilliamsrSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
