...
{
	public partial class WilliamsrSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new WilliamsrSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public WilliamsrSeriesStatesSelectMarkerStates States { get; set; }
		private WilliamsrSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
