...
{
	public partial class WilliamsrSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WilliamsrSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = WilliamsrSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public WilliamsrSeriesTooltipHeaderShape HeaderShape { get; set; }
		private WilliamsrSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("WilliamsrSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("WilliamsrSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
