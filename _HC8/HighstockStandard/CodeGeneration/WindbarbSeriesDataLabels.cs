...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WindbarbSeriesDataLabels  : BaseObject
	{
		...
		public WindbarbSeriesDataLabels()
		{
			...
			Overflow = Overflow_DefaultValue = WindbarbSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = WindbarbSeriesDataLabelsPosition.Center;
		...
		/// </summary>
		public WindbarbSeriesDataLabelsOverflow Overflow { get; set; }
		private WindbarbSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDataLabelsPosition Position { get; set; }
		private WindbarbSeriesDataLabelsPosition Position_DefaultValue { get; set; }
