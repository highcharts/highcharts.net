...
{
	public partial class WindbarbSeriesDragDrop  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesDragDrop()
		{
			DraggableX = DraggableX_DefaultValue = null;
			DraggableY = DraggableY_DefaultValue = null;
			DragHandle = DragHandle_DefaultValue = new WindbarbSeriesDragDropDragHandle();
			...
			GuideBox = GuideBox_DefaultValue = new WindbarbSeriesDragDropGuideBox();
		...
		/// </summary>
		public WindbarbSeriesDragDropDragHandle DragHandle { get; set; }
		private WindbarbSeriesDragDropDragHandle DragHandle_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesDragDropGuideBox GuideBox { get; set; }
		private WindbarbSeriesDragDropGuideBox GuideBox_DefaultValue { get; set; }
