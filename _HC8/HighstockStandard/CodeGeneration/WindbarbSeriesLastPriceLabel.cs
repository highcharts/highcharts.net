...
{
	public partial class WindbarbSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = WindbarbSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public WindbarbSeriesLastPriceLabelAlign Align { get; set; }
		private WindbarbSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
