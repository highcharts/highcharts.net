...
{
	public partial class WindbarbSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = WindbarbSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public WindbarbSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private WindbarbSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
