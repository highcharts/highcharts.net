...
{
	public partial class WindbarbSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WindbarbSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new WindbarbSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new WindbarbSeriesOnPointPosition();
		...
		/// </summary>
		public WindbarbSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private WindbarbSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public WindbarbSeriesOnPointPosition Position { get; set; }
		private WindbarbSeriesOnPointPosition Position_DefaultValue { get; set; }
