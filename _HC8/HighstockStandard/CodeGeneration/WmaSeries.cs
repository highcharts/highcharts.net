...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class WmaSeries  : Series
	{
		...
		public WmaSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = WmaSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = WmaSeriesType.Wma;
		...
		/// </summary>
		public WmaSeriesType Type { get; set; }
		private WmaSeriesType Type_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("WmaSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
