...
{
	public partial class WmaSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesDataLabels()
		{
			Align = Align_DefaultValue = WmaSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new WmaSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = WmaSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = WmaSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new WmaSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = WmaSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public WmaSeriesDataLabelsAlign Align { get; set; }
		private WmaSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataLabelsFilter Filter { get; set; }
		private WmaSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataLabelsOverflow Overflow { get; set; }
		private WmaSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataLabelsPosition Position { get; set; }
		private WmaSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataLabelsTextPath TextPath { get; set; }
		private WmaSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private WmaSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
