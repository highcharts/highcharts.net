...
{
	public partial class WmaSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = WmaSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public WmaSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private WmaSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
