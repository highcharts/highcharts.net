...
{
	public partial class WmaSeriesSonificationContextTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationContextTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = WmaSeriesSonificationContextTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public WmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm { get; set; }
		private WmaSeriesSonificationContextTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
