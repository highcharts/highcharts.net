...
{
	public partial class WmaSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = WmaSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public WmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private WmaSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
