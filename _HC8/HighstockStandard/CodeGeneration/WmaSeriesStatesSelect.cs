...
{
	public partial class WmaSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new WmaSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new WmaSeriesStatesSelectMarker();
		...
		/// </summary>
		public WmaSeriesStatesSelectHalo Halo { get; set; }
		private WmaSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public WmaSeriesStatesSelectMarker Marker { get; set; }
		private WmaSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
