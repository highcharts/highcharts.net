...
{
	public partial class WmaSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public WmaSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new WmaSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public WmaSeriesStatesSelectMarkerStates States { get; set; }
		private WmaSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
