...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class XrangeSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("XrangeSeriesDataGroupingApproximation.approximation", Approximation); }  
