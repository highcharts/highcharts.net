...
{
	public partial class XrangeSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = XrangeSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public XrangeSeriesLastPriceLabelAlign Align { get; set; }
		private XrangeSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
