...
{
	public partial class XrangeSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = XrangeSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public XrangeSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private XrangeSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
