...
{
	public partial class XrangeSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public XrangeSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new XrangeSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public XrangeSeriesStatesSelectMarkerStates States { get; set; }
		private XrangeSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
