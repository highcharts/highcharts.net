...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeries  : Series
	{
		...
		public ZigzagSeries()
		{
			...
			DashStyle = DashStyle_DefaultValue = ZigzagSeriesDashStyle.Solid;
			...
			Type = Type_DefaultValue = ZigzagSeriesType.Zigzag;
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (PointDescriptionFormatter != PointDescriptionFormatter_DefaultValue) { h.Add("pointDescriptionFormatter",PointDescriptionFormatter); Highstock.AddFunction("ZigzagSeriesPointDescriptionFormatter.pointDescriptionFormatter", PointDescriptionFormatter); }  
