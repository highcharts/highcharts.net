...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesDataGrouping  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Approximation != Approximation_DefaultValue) { h.Add("approximation",Approximation); Highstock.AddFunction("ZigzagSeriesDataGroupingApproximation.approximation", Approximation); }  
