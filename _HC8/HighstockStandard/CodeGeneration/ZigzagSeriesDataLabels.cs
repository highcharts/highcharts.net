...
{
	public partial class ZigzagSeriesDataLabels  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesDataLabels()
		{
			Align = Align_DefaultValue = ZigzagSeriesDataLabelsAlign.Center;
			...
			Filter = Filter_DefaultValue = new ZigzagSeriesDataLabelsFilter();
			...
			Overflow = Overflow_DefaultValue = ZigzagSeriesDataLabelsOverflow.Justify;
			Padding = Padding_DefaultValue = 5;
			Position = Position_DefaultValue = ZigzagSeriesDataLabelsPosition.Center;
			...
			TextPath = TextPath_DefaultValue = new ZigzagSeriesDataLabelsTextPath();
			UseHTML = UseHTML_DefaultValue = false;
			VerticalAlign = VerticalAlign_DefaultValue = ZigzagSeriesDataLabelsVerticalAlign.Bottom;
			X = X_DefaultValue = 0;
			Y = Y_DefaultValue = 0;
			Z = Z_DefaultValue = 6;
		...
		/// </summary>
		public ZigzagSeriesDataLabelsAlign Align { get; set; }
		private ZigzagSeriesDataLabelsAlign Align_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataLabelsFilter Filter { get; set; }
		private ZigzagSeriesDataLabelsFilter Filter_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataLabelsOverflow Overflow { get; set; }
		private ZigzagSeriesDataLabelsOverflow Overflow_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataLabelsPosition Position { get; set; }
		private ZigzagSeriesDataLabelsPosition Position_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataLabelsTextPath TextPath { get; set; }
		private ZigzagSeriesDataLabelsTextPath TextPath_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesDataLabelsVerticalAlign VerticalAlign { get; set; }
		private ZigzagSeriesDataLabelsVerticalAlign VerticalAlign_DefaultValue { get; set; }
