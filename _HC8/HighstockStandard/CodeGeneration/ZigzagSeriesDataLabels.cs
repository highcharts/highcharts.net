...
namespace Highsoft.Web.Mvc.Stocks
{
	public partial class ZigzagSeriesDataLabels  : BaseObject
	{
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (Formatter != Formatter_DefaultValue) { h.Add("formatter",Formatter); Highstock.AddFunction("ZigzagSeriesDataLabelsFormatter.formatter", Formatter); }  
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ZigzagSeriesDataLabelsNullFormatter.nullFormatter", NullFormatter); }  
