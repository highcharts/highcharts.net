...
{
	public partial class ZigzagSeriesLastPriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesLastPriceLabel()
		{
			Align = Align_DefaultValue = ZigzagSeriesLastPriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ZigzagSeriesLastPriceLabelAlign Align { get; set; }
		private ZigzagSeriesLastPriceLabelAlign Align_DefaultValue { get; set; }
