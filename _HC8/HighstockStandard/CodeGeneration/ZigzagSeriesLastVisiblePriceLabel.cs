...
{
	public partial class ZigzagSeriesLastVisiblePriceLabel  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesLastVisiblePriceLabel()
		{
			Align = Align_DefaultValue = ZigzagSeriesLastVisiblePriceLabelAlign.Null;
		...
		/// 
		/// </summary>
		public ZigzagSeriesLastVisiblePriceLabelAlign Align { get; set; }
		private ZigzagSeriesLastVisiblePriceLabelAlign Align_DefaultValue { get; set; }
