...
{
	public partial class ZigzagSeriesMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesMarker()
		{
			...
			States = States_DefaultValue = new ZigzagSeriesMarkerStates();
		...
		/// </summary>
		public ZigzagSeriesMarkerStates States { get; set; }
		private ZigzagSeriesMarkerStates States_DefaultValue { get; set; }
