...
{
	public partial class ZigzagSeriesOnPoint  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesOnPoint()
		{
			ConnectorOptions = ConnectorOptions_DefaultValue = new ZigzagSeriesOnPointConnectorOptions();
			Id = Id_DefaultValue = "";
			Position = Position_DefaultValue = new ZigzagSeriesOnPointPosition();
		...
		/// </summary>
		public ZigzagSeriesOnPointConnectorOptions ConnectorOptions { get; set; }
		private ZigzagSeriesOnPointConnectorOptions ConnectorOptions_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesOnPointPosition Position { get; set; }
		private ZigzagSeriesOnPointPosition Position_DefaultValue { get; set; }
