...
{
	public partial class ZigzagSeriesSonificationDefaultInstrumentOptionsActiveWhen  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationDefaultInstrumentOptionsActiveWhen()
		{
