...
{
	public partial class ZigzagSeriesSonificationTracksPointGrouping  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesSonificationTracksPointGrouping()
		{
			Algorithm = Algorithm_DefaultValue = ZigzagSeriesSonificationTracksPointGroupingAlgorithm.Minimax;
		...
		/// </summary>
		public ZigzagSeriesSonificationTracksPointGroupingAlgorithm Algorithm { get; set; }
		private ZigzagSeriesSonificationTracksPointGroupingAlgorithm Algorithm_DefaultValue { get; set; }
