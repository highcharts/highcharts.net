...
{
	public partial class ZigzagSeriesStatesHover  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesStatesHover()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = new Hashtable();
			Halo = Halo_DefaultValue = new ZigzagSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = new Hashtable();
			LineWidthPlus = LineWidthPlus_DefaultValue = new Hashtable();
			Marker = Marker_DefaultValue = new ZigzagSeriesStatesHoverMarker();
		...
		/// </summary>
		public ZigzagSeriesStatesHoverHalo Halo { get; set; }
		private ZigzagSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesStatesHoverMarker Marker { get; set; }
		private ZigzagSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
