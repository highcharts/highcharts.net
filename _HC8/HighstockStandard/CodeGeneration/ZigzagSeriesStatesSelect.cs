...
{
	public partial class ZigzagSeriesStatesSelect  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesStatesSelect()
		{
			Animation = Animation_DefaultValue = new Animation() { Enabled = true };
			Enabled = Enabled_DefaultValue = null;
			Halo = Halo_DefaultValue = new ZigzagSeriesStatesSelectHalo();
			LineWidth = LineWidth_DefaultValue = null;
			LineWidthPlus = LineWidthPlus_DefaultValue = null;
			Marker = Marker_DefaultValue = new ZigzagSeriesStatesSelectMarker();
		...
		/// </summary>
		public ZigzagSeriesStatesSelectHalo Halo { get; set; }
		private ZigzagSeriesStatesSelectHalo Halo_DefaultValue { get; set; }
		...
		/// </summary>
		public ZigzagSeriesStatesSelectMarker Marker { get; set; }
		private ZigzagSeriesStatesSelectMarker Marker_DefaultValue { get; set; }
