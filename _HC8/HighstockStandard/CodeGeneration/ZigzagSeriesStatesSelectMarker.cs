...
{
	public partial class ZigzagSeriesStatesSelectMarker  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesStatesSelectMarker()
		{
			...
			States = States_DefaultValue = new ZigzagSeriesStatesSelectMarkerStates();
		...
		/// </summary>
		public ZigzagSeriesStatesSelectMarkerStates States { get; set; }
		private ZigzagSeriesStatesSelectMarkerStates States_DefaultValue { get; set; }
