...
{
	public partial class ZigzagSeriesTooltip  : BaseObject
	{
		Hashtable h = new Hashtable();

		public ZigzagSeriesTooltip()
		{
			...
			HeaderShape = HeaderShape_DefaultValue = ZigzagSeriesTooltipHeaderShape.Callout;
		...
		/// </summary>
		public ZigzagSeriesTooltipHeaderShape HeaderShape { get; set; }
		private ZigzagSeriesTooltipHeaderShape HeaderShape_DefaultValue { get; set; }
		...
		internal override Hashtable ToHashtable()
		{
			...
			if (NullFormatter != NullFormatter_DefaultValue) { h.Add("nullFormatter",NullFormatter); Highstock.AddFunction("ZigzagSeriesTooltipNullFormatter.nullFormatter", NullFormatter); }  
			if (Outside != Outside_DefaultValue) h.Add("outside",Outside);
			if (Padding != Padding_DefaultValue) h.Add("padding",Padding);
			if (PointFormat != PointFormat_DefaultValue) h.Add("pointFormat",PointFormat);
			if (PointFormatter != PointFormatter_DefaultValue) { h.Add("pointFormatter",PointFormatter); Highstock.AddFunction("ZigzagSeriesTooltipPointFormatter.pointFormatter", PointFormatter); }  
