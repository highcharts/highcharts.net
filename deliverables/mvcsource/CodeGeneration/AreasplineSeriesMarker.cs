...
{
	public partial class AreasplineSeriesMarker  : BaseObject
	{
		public AreasplineSeriesMarker()
		{
			...
			Symbol = Symbol_DefaultValue = AreasplineSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public AreasplineSeriesMarkerStates States { get; set; }
		private AreasplineSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public AreasplineSeriesMarkerSymbol Symbol { get; set; }
		private AreasplineSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
