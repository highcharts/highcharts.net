...
{
	public partial class LineSeriesDataMarker  : BaseObject
	{
		public LineSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new LineSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = LineSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public LineSeriesDataMarkerStates States { get; set; }
		private LineSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public LineSeriesDataMarkerSymbol Symbol { get; set; }
		private LineSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
