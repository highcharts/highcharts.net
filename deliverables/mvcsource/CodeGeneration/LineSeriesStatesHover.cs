...
{
	public partial class LineSeriesStatesHover  : BaseObject
	{
		public LineSeriesStatesHover()
		{
			Enabled = Enabled_DefaultValue = true;
			Halo = Halo_DefaultValue = new LineSeriesStatesHoverHalo();
			LineWidth = LineWidth_DefaultValue = 2;
			LineWidthPlus = LineWidthPlus_DefaultValue = 1;
			Marker = Marker_DefaultValue = new LineSeriesStatesHoverMarker();
		...
		/// </summary>
		public LineSeriesStatesHoverHalo Halo { get; set; }
		private LineSeriesStatesHoverHalo Halo_DefaultValue { get; set; }
		...
		/// 
		/// </summary>
		public LineSeriesStatesHoverMarker Marker { get; set; }
		private LineSeriesStatesHoverMarker Marker_DefaultValue { get; set; }
