...
{
	public partial class PlotOptionsAreaMarker  : BaseObject
	{
		public PlotOptionsAreaMarker()
		{
			...
			Symbol = Symbol_DefaultValue = PlotOptionsAreaMarkerSymbol.Null;
		...
		private PlotOptionsAreaMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PlotOptionsAreaMarkerSymbol Symbol { get; set; }
		private PlotOptionsAreaMarkerSymbol Symbol_DefaultValue { get; set; }
