...
{
	public partial class PlotOptionsSplineMarker  : BaseObject
	{
		public PlotOptionsSplineMarker()
		{
			...
			States = States_DefaultValue = new PlotOptionsSplineMarkerStates();
			Symbol = Symbol_DefaultValue = PlotOptionsSplineMarkerSymbol.Null;
		...
		/// </summary>
		public PlotOptionsSplineMarkerSymbol Symbol { get; set; }
		private PlotOptionsSplineMarkerSymbol Symbol_DefaultValue { get; set; }
