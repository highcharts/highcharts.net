...
{
	public partial class PolygonSeriesDataMarker  : BaseObject
	{
		public PolygonSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new PolygonSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = PolygonSeriesDataMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public PolygonSeriesDataMarkerStates States { get; set; }
		private PolygonSeriesDataMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public PolygonSeriesDataMarkerSymbol Symbol { get; set; }
		private PolygonSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
