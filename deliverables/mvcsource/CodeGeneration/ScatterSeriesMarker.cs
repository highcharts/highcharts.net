...
{
	public partial class ScatterSeriesMarker  : BaseObject
	{
		public ScatterSeriesMarker()
		{
			...
			States = States_DefaultValue = new ScatterSeriesMarkerStates();
			Symbol = Symbol_DefaultValue = ScatterSeriesMarkerSymbol.Null;
		...
		/// 
		/// </summary>
		public ScatterSeriesMarkerStates States { get; set; }
		private ScatterSeriesMarkerStates States_DefaultValue { get; set; }
		...
		/// </summary>
		public ScatterSeriesMarkerSymbol Symbol { get; set; }
		private ScatterSeriesMarkerSymbol Symbol_DefaultValue { get; set; }
