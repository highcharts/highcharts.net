...
{
	public partial class SplineSeriesDataMarker  : BaseObject
	{
		public SplineSeriesDataMarker()
		{
			...
			States = States_DefaultValue = new SplineSeriesDataMarkerStates();
			Symbol = Symbol_DefaultValue = SplineSeriesDataMarkerSymbol.Null;
		...
		/// </summary>
		public SplineSeriesDataMarkerSymbol Symbol { get; set; }
		private SplineSeriesDataMarkerSymbol Symbol_DefaultValue { get; set; }
